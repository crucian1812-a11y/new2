...
export class Game {
  ...
  draw(dt) {
    ...
    // Wide and soft rather than hot and tight. At the old intensity the hero
    // stood in the middle of a light strong enough to clip him: the surcoat
    // and the shield came out as one white mass with the cross, the plate
    // seams and the blood all burned off them. Spreading the same amount of
    // light over a wider circle lights the ground he is walking on just as
    // well and leaves him with a figure.
    R.addLight(p.x, p.y - 20, 720, heroLight, 0.6 + Math.sin(R.time * 7) * 0.03);
