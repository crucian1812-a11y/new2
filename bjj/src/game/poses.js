...
export const POSES = {
  ...
  MOUNT_WORK2: P('MOUNT_WORK2', {
    ...
    variantOf: 'MOUNT',
    A: {
      root: { p: [-0.024, 0.546, 0.108], r: [0, 0, 0] },
      j: {
        hips: [29.1, 28.5, 3.5], spine: [8.7, 31.6, -34.6], chest: [44.5, -14.1, -24.5],
        neck: [12, -1.5, 0], head: [-4, 0, 0], clavL: [4.7, -23, -26.9],
        armL: [-100.8, 13.1, -26.7], foreL: [-96, 4.8, 0.1], clavR: [10.1, 3.3, 42],
