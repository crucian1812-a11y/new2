...
export const POSES = {
  ...
  SIDE_CONTROL: P('SIDE_CONTROL', {
    ...
    A: {
      root: { p: [0.289, 0.281, 0.28], r: [8, 100, 0] },
      j: {
        hips: [-61.4, -20.1, -19.5], spine: [43.9, -10.4, 11], chest: [38.4, -6.8, 15], neck: [25.3, 4.7, 39.9], head: [6.1, 15.9, 6.9],
        clavL: [-11.7, -29.9, -28.6], armL: [-88.4, 41.3, -50.1], foreL: [-122.5, 28, 11.5],
        clavR: [28, -23.8, -7.4], armR: [-32.6, -5.9, 57.5], foreR: [-119, 9.2, -11.7],
        thighL: [-51.7, 0.6, 1.5], shinL: [112.2, -15.6, 23.4], footL: [8.5, -9.7, -3.7],
        thighR: [-7.2, -22.5, -24.2], shinR: [86.3, 1.5, -1.5], footR: [17, 12.8, 0.8],
      },
    },
    B: {
      root: { p: [-0.154, 0.255, -0.03], r: [-90, 180, 0] },
      j: {
        hips: [16, -7.5, 6], spine: [-2.6, -17.2, 6], chest: [10.3, -3.7, 12], neck: [-8.1, 54.9, 5.3], head: [-0.4, 22.2, 11.6],
        clavL: [-17.8, -11.9, 22.3], armL: [-129.2, 22.5, -38.4], foreL: [-105.6, 14.4, 3.8],
        clavR: [-13.9, -23.8, 38.3], armR: [-92.2, -57.8, -7], foreR: [-58.5, 1.8, 1],
        thighL: [-25.7, 12.1, 12.1], shinL: [40.8, -3, -1.5], footL: [-15.2, 2.3, 2.3],
        thighR: [-18.2, -1.5, -9.1], shinR: [35.6, 7.6, 0.9], footR: [-14.4, 4.7, 1.7],
      },
    },
    hold: [
      { of: 'A.chest', above: 'B.chest', by: 0.16 },
  ...
  MOUNT: P('MOUNT', {
    ...
    A: {
      ...
      j: {
        hips: [47.5, 29.4, -4.5], spine: [3.1, 28.8, -38], chest: [43.8, -22.2, -20.6], neck: [22.6, 2.3, 0.1], head: [-10.6, 5.4, 1.6],
        clavL: [14.5, -14.6, -20], armL: [-96.8, 14.6, -24.4], foreL: [-82.5, 4.9, 0.9],
        clavR: [23.7, 7.9, 39.2], armR: [-82.1, -2.9, 39.8], foreR: [-111, 12.9, 10.8],
        thighL: [-45.1, 11.6, 80.1], shinL: [56.8, 51.1, -24], footL: [18, 1.5, 0],
        thighR: [-18.7, -36.8, -3.2], shinR: [74, -23.2, 0.8], footR: [17.3, 0, 0.8],
      },
    },
    B: {
      root: { p: [0.013, 0.266, 0.248], r: [-90, 180, 0] },
      j: {
        hips: [23.1, -25.9, -21], spine: [8.4, -9.5, -10.3], chest: [21.5, 9.1, 20.5], neck: [-2, 2.3, -3], head: [11.8, 1.6, 3.1],
        clavL: [0.7, -43.4, 11.1], armL: [-156.4, 47.9, 11.6], foreL: [-123.4, 22.9, 12.3],
        clavR: [2.5, 13.1, -16.6], armR: [-174.3, 18.6, 26.3], foreR: [-74.6, -11.8, -5.1],
        thighL: [-29, -7.2, -7], shinL: [36.5, 0.8, 0], footL: [-7.9, 0.8, -5.9],
        thighR: [-24.5, -9.6, -3.1], shinR: [37.1, 0.8, 0.9], footR: [-13.9, 0.8, 2.3],
      },
    },
    hold: [
  ...
  BACK: P('BACK', {
    ...
    points: 4, top: 'A', ground: true,
    A: {
      root: { p: [0.008, 0.293, -0.462], r: [-22, 8, 6] },
      j: {
        hips: [0.1, -3, -24.6], spine: [10, -18, -3], chest: [14, 0, 11.3], neck: [25.1, 0.8, 3.8], head: [-11.2, 8.8, 0.8],
        clavL: [3, -4.4, 12.7], armL: [-144.9, 24, -50], foreL: [-95.6, -1.3, 6.8],
        clavR: [12.1, 22.7, -2.6], armR: [-92.5, -25.2, 8.4], foreR: [-113, -53.1, -50.1],
    ...
    B: {
      ...
      j: {
        hips: [-26, -31.3, -4.5], spine: [5.3, -5.9, -5.2], chest: [-9.4, -6.6, -47.9], neck: [5.4, -18.7, -8.1], head: [19.5, -8.2, 3.8],
        clavL: [-24.5, -2.7, 26.9], armL: [-133, 11.7, -34.8], foreL: [-64.3, 1.5, -11],
        clavR: [10.6, 13.5, -33], armR: [-94.7, -27, 30.6], foreR: [-84.7, 4.7, 8.4],
  ...
  TURTLE: P('TURTLE', {
    ...
    A: {
      ...
      j: {
        ...
        clavL: [30, -26.1, 15.7], armL: [11.1, 1.7, -66.5], foreL: [-54.2, 55.1, 24.9],
        clavR: [-14.9, 19.5, -40.8], armR: [-116.7, -7.1, 53.6], foreR: [6.7, 8.6, -32.2],
        thighL: [-40, 4, 14], shinL: [104, 0, 0], footL: [8, 0, 0],
        thighR: [-7.2, -5.2, -1.5], shinR: [91, 3, 1.5], footR: [20, 4.5, 6],
      },
    },
    B: {
      root: { p: [-0.176, 0.304, 0.12], r: [64, 176, 0] },
      j: {
        hips: [-0.7, 21.8, 12.9], spine: [-33, 19.9, 26.7], chest: [-32.8, 37.7, -25.6], neck: [-12.4, 12, 21.8], head: [25.5, 3.8, 3],
        clavL: [2.4, 14.5, -42.1], armL: [-64.7, 23.6, -25.7], foreL: [-116, -4.5, -0.7],
        clavR: [27.5, -34.3, 0.2], armR: [-24.8, -4, 27.3], foreR: [-105.5, 2.3, 6.8],
        thighL: [56.8, 53.4, 65.3], shinL: [149.7, -6.5, 10.6], footL: [15.1, 2.3, 2.3],
  ...
  TRIANGLE: P('TRIANGLE', {
    ...
    A: {
      ...
      j: {
        ...
        thighL: [-7.1, 72.7, -15.4], shinL: [81.1, 0, 6.8], footL: [17, 2.3, -2.9],
        thighR: [-16.7, 20.7, -0.9], shinR: [69.8, 0.1, -0.7], footR: [11.8, -5.2, 0.8],
      },
    },
    B: {
      ...
      j: {
        ...
        thighR: [-52.3, -10.3, -15.1], shinR: [150.6, -10.4, 14.6], footR: [-10, 0, -1.5],
      },
    },
    hold: [
  ...
  CLINCH_WORK: P('CLINCH_WORK', {
    ...
    variantOf: 'CLINCH',
    A: {
      root: { p: [0.03, 0.921, -0.249], r: [0, 6, 0] },
      j: {
    ...
    B: {
      root: { p: [-0.141, 0.911, 0.281], r: [0, 186, 0] },
      j: {
  ...
  KIMURA_WORK: P('KIMURA_WORK', {
    ...
    variantOf: 'KIMURA',
    A: {
      root: { p: [0.371, 0.392, 0.253], r: [12, 116, 0] },
      j: {
  ...
  RNC_WORK2: P('RNC_WORK2', {
    ...
    variantOf: 'RNC',
    A: {
      root: { p: [-0.029, 0.367, -0.403], r: [-26, 8, 8] },
      j: {
    ...
    B: {
      root: { p: [-0.011, 0.283, -0.064], r: [-10, 4, 4] },
      j: {
