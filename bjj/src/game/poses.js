...
export const POSES = {
  ...
  CLOSED_GUARD: P('CLOSED_GUARD', {
    ...
    A: {
      root: { p: [-0.036, 0.473, -0.321], r: [0, 0, 0] },
      j: {
        hips: [13.8, -23.1, 24.2], spine: [42.3, 17.4, 7.6], chest: [6.9, -14.1, 10.8], neck: [6.4, -0.7, 0.8], head: [-12.4, -0.7, 3],
        clavL: [34.8, -5.7, -27.8], armL: [4.6, -13.3, 149.5], foreL: [-105.4, -2.2, 0],
        clavR: [-19.6, 36.8, 12.4], armR: [58.4, 46.2, -89.9], foreR: [-78.3, -2.3, -0.7],
        thighL: [32.9, 19.6, 5], shinL: [92.8, 3, -3], footL: [24, 0, 0],
        thighR: [31.5, -11.1, -37.2], shinR: [88.3, 4.6, -2.2], footR: [27.1, 1.6, 0.9],
      },
    },
    B: {
      root: { p: [-0.053, 0.242, -0.044], r: [-90, 180, 0] },
      j: {
        hips: [8.9, 24.9, 9.3], spine: [16.2, 26.4, 34], chest: [1.8, 8.4, -35.7], neck: [-17.8, 1.6, -0.7], head: [17.5, -2.2, -0.7],
        clavL: [0.8, 3.9, 6.3], armL: [-6.8, 21.3, -12.6], foreL: [-82.9, 0, 0],
        clavR: [-32.6, 23.4, -21.4], armR: [24.1, -5.2, 16.5], foreR: [-72.8, 1.5, -0.7],
        thighL: [-49.8, 14, 16.1], shinL: [144.4, -3.6, -12.9], footL: [-10, 2.3, 1.6],
        thighR: [-117.5, 6.8, 5.3], shinR: [149.8, -5.7, 16.2], footR: [-10, -0.7, 0],
      },
    },
    hold: [
  ...
  OPEN_GUARD: P('OPEN_GUARD', {
    ...
    A: {
      ...
      j: {
        hips: [17.8, -6.7, -18.6], spine: [9.9, -27.7, -6.7], chest: [20.1, -2.2, 1.5], neck: [6.5, 0, 0],
        clavL: [6.9, -8.2, 29.8], armL: [67.2, 10, 115.6], foreL: [-91.5, 1.5, 1.5],
        clavR: [-17.9, 38.4, -21.1], armR: [47.1, 56.9, -85], foreR: [-66.5, 8.2, 0],
        thighL: [-12.7, 6.6, 12.4], shinL: [100.3, -2.2, 2.3], footL: [19.8, 0, 0.8],
        thighR: [-31.4, -7.1, -13.2], shinR: [71.5, 6.8, -6], footR: [-20, -1.4, -0.7],
      },
    },
    B: {
      root: { p: [0.023, 0.273, 0.07], r: [-78, 180, 0] },
      j: {
        hips: [12.9, -6.7, 15.9], spine: [15.9, -8.8, -24.4], chest: [-0.2, 6.1, 2.4], neck: [-24.2, -0.6, 0], head: [18.1, -0.7, 0.1],
        clavL: [-20.8, -24.6, 10.7], armL: [5.5, 98.9, -62.3], foreL: [-50.2, 0.7, 0],
        clavR: [-15.6, 11.4, -4.5], armR: [-24.7, -44.1, 29.1], foreR: [-44.7, 0, 0],
        thighL: [-104.6, 18.3, 15], shinL: [34.7, -1.2, 13.6], footL: [-20.1, -0.7, -0.7],
        thighR: [-118.7, -8.3, -9.6], shinR: [21.2, 1.7, -1.5], footR: [-18.4, 0, 0.8],
      },
    },
    hold: [
  ...
  HALF_GUARD: P('HALF_GUARD', {
    ...
    points: 0, top: 'A', ground: true, guardOf: 'B',
    A: {
      root: { p: [0.21, 0.54, -0.079], r: [0, 24, 0] },
      j: {
        hips: [16.9, -23.2, 32.3], spine: [13.6, -9.6, 15.8], chest: [-9.2, -20.9, 19.7], neck: [11, 0, -0.7], head: [-7, 0, 0],
        clavL: [-20, 9, 19.3], armL: [-20.7, -14.6, -69.3], foreL: [-71.7, -1.5, 0.7],
        clavR: [35.5, -20.8, -0.5], armR: [-35.3, 1.3, -15.7], foreR: [-65.5, 39.2, 31.2],
        thighL: [-29, 18.3, 22.4], shinL: [104.8, 0, 0], footL: [10, 3, 0],
        thighR: [12.2, 33.8, -1.6], shinR: [97.1, 4.8, 5.5], footR: [12.8, -2.9, 0],
      },
    },
    B: {
      root: { p: [-0.111, 0.26, 0.049], r: [-72, 156, -22] },
      j: {
        hips: [3.4, -8.1, -11.9], spine: [3.7, 27.9, 40], chest: [10.7, 1.7, -19.4], neck: [-14.7, 7.5, 0.8], head: [13.3, 0.8, 6.1],
        clavL: [15.4, 15.2, -23.6], armL: [-85.5, 45.2, -15.1], foreL: [-110.6, -5.6, -4.3],
        clavR: [11.7, 11.6, -33.7], armR: [-17.2, 39.5, 6.6], foreR: [-41.2, 35.5, 19],
        thighL: [-82.8, 15.6, 22.6], shinL: [91, 0, 0.8], footL: [-14, 0, 0.8],
        thighR: [-58.2, -36.6, -21.6], shinR: [77.3, -6.6, 9.8], footR: [-14, 0.8, 0],
      },
    },
    hold: [
  ...
  SIDE_CONTROL: P('SIDE_CONTROL', {
    ...
    A: {
      root: { p: [0.297, 0.349, 0.336], r: [8, 100, 0] },
      j: {
        hips: [-68.7, -23.7, -31.5], spine: [19.2, -6.5, 4.4], chest: [31, 2.3, 20.5], neck: [-12.1, 17.7, 19], head: [6.1, 15.9, 6.9],
        clavL: [-13.8, -28.3, -28.5], armL: [-85.2, 39.3, -47.8], foreL: [-120.1, 31.8, 13.8],
        clavR: [34.9, -26.8, 4.8], armR: [-28.8, -10.4, 57], foreR: [-112.2, 6.2, -12.4],
        thighL: [-35.7, -9.1, -13.3], shinL: [112.2, -17.8, 25.7], footL: [8.5, -9.7, -3.7],
        thighR: [-24.9, -5.2, -24.9], shinR: [82, 15.1, -13.5], footR: [17, 12.8, 0.1],
      },
    },
    B: {
      root: { p: [-0.169, 0.232, -0.022], r: [-90, 180, 0] },
      j: {
        hips: [10.8, 5.3, 6], spine: [6.5, -14.9, 3.8], chest: [19.5, -3.7, 20.3], neck: [-6.4, 58.1, -8.1], head: [4.3, 26, 11],
        clavL: [-11.8, -22.4, 39.7], armL: [145.2, 113.1, -65.9], foreL: [-73.8, -2.2, 0],
        clavR: [-12.1, -15.4, 42.3], armR: [-95.8, -65.2, -10], foreR: [-89, 33.7, 2],
        thighL: [-27.1, 7.7, 10.6], shinL: [40.8, -5.2, -1.5], footL: [-15.2, 0.1, 2.3],
        thighR: [-19.6, 3.2, -10.6], shinR: [35.6, 9.9, 0.9], footR: [-9.8, 4.7, 3.3],
      },
    },
    hold: [
      { of: 'A.chest', above: 'B.chest', by: 0.16 },
  ...
  KNEE_ON_BELLY: P('KNEE_ON_BELLY', {
    ...
    A: {
      root: { p: [0.105, 0.576, 0.105], r: [-6, 100, 0] },
      j: {
        hips: [-38.4, -35.2, 10.5], spine: [7.3, 1.7, 17.4], chest: [-38.6, -23.9, 30.8], neck: [3.8, -38.9, 10.6], head: [-16.7, -14.2, 0],
        clavL: [-10.8, 30.1, 29.9], armL: [-52.5, 20.9, -31.4], foreL: [-65.8, 0.8, -2.1],
        clavR: [12.4, -35.1, 22.2], armR: [-49.4, -69.3, -44], foreR: [-72.1, -6.7, -0.8],
        thighL: [-137.4, -8, -18.4], shinL: [59.6, 3.8, 0], footL: [8, -0.7, 0],
        thighR: [-32.9, -25.2, -49.9], shinR: [36, 25, -23], footR: [-17.5, 2, 16.2],
      },
    },
    B: {
      root: { p: [-0.192, 0.243, 0.009], r: [-90, 180, 0] },
      j: {
        hips: [9.3, 72.1, -3.7], spine: [-19.8, -21.5, 14.3], chest: [17.3, 3.9, 30.1], neck: [-14.5, -0.7, -0.7], head: [12, -24.7, -0.7],
        clavL: [-4, 23.5, 37.6], armL: [-113, 46.2, -29.5], foreL: [-80, -6.7, -2.9],
        clavR: [-15.9, -10.9, -39.3], armR: [175.3, 23.2, -12], foreR: [-69.7, 1.5, 0],
        thighL: [-39.1, 9.1, 12.1], shinL: [52.1, 6, -3], footL: [-16, 0, 0.8],
  ...
  MOUNT: P('MOUNT', {
    ...
    A: {
      root: { p: [0.005, 0.476, 0.089], r: [0, 0, 0] },
      j: {
        hips: [42.3, 22.7, -10.5], spine: [-14.9, 19.9, -36.5], chest: [35.6, -36.4, -2.5], neck: [22.6, 2.3, 0.1], head: [-10.6, 5.4, 1.6],
        clavL: [29.7, -6.2, -32.5], armL: [-21, -71.3, 65.4], foreL: [-82, 0, 0],
        clavR: [22.3, 5.8, 40], armR: [-80.6, -2.1, 40.6], foreR: [-114.7, 14.5, 11.7],
        thighL: [-45, -0.4, 80.1], shinL: [53.1, 39.1, -12], footL: [17.3, 1.5, 0],
        thighR: [-13.3, -44.9, 0.7], shinR: [75.5, -22.4, 0], footR: [17.3, 0, 0.8],
      },
    },
    B: {
      root: { p: [0.073, 0.258, 0.248], r: [-90, 180, 0] },
      j: {
        hips: [17.1, -24.4, -14.9], spine: [11.5, -2, -26.8], chest: [20.8, 3.9, 15.3], neck: [-2, 2.3, -3], head: [11.8, 1.6, 3.1],
        clavL: [-18.7, -34.3, 14.9], armL: [40.2, 22.5, 17.6], foreL: [-132.6, -6, 0],
        clavR: [-0.4, 10.2, -17.3], armR: [-172.7, 20.2, 30.9], foreR: [-73, -12.5, -5.1],
        thighL: [-28.2, -27.3, -10.7], shinL: [35.1, -0.7, 5.3], footL: [-4.1, 2.3, -7.4],
        thighR: [-21.5, -20.1, 3.7], shinR: [33.4, -4.4, 8.4], footR: [-13.9, 0.8, 2.3],
      },
    },
    hold: [
  ...
  BACK: P('BACK', {
    ...
    points: 4, top: 'A', ground: true,
    A: {
      root: { p: [-0.052, 0.292, -0.507], r: [-22, 8, 6] },
      j: {
        hips: [-14.1, 3.8, -9.5], spine: [28, -14.1, -14.2], chest: [22.3, 0, 38.4], neck: [25.1, 0.8, 3.8], head: [-11.2, 8.8, 0.8],
        clavL: [6.1, -4.3, 12.7], armL: [4.8, 32.9, -91.9], foreL: [-82.9, 0, 0.8],
        clavR: [10.6, 13, -2.6], armR: [21.4, 56.3, -113], foreR: [-78.2, 3, 0.7],
        thighL: [-92.3, 23.3, 17.7], shinL: [83.6, 9.9, -9.6], footL: [-16.1, 0, 0.1],
        thighR: [-67.5, -14.8, -38.2], shinR: [69.5, 3, -2.9], footR: [-10.9, 6.2, -4.3],
      },
    },
    B: {
      root: { p: [0.023, 0.296, -0.12], r: [-16, 4, 4] },
      j: {
        hips: [-32, -39.5, 1.5], spine: [21.1, -23, -5.2], chest: [-10.1, 7.7, -48.6], neck: [5.4, -20.9, -8.8], head: [19.5, -8.2, 3.8],
        clavL: [-11.7, 16.1, 38.9], armL: [132.1, 105, 6.6], foreL: [-116.7, -6, 5.3],
        clavR: [-7.3, 15.1, -42.7], armR: [-18.1, 3.2, 141.6], foreR: [-89.7, 1.5, 0.8],
  ...
  TURTLE: P('TURTLE', {
    ...
    A: {
      root: { p: [-0.009, 0.536, -0.474], r: [10, 14, 0] },
      j: {
        hips: [-12, 6.8, 38.4], spine: [29.8, 23.5, 12.8], chest: [28.6, -3.2, -11.7], neck: [21.4, -4.5, 5.3], head: [-14.1, 0, 2.3],
        clavL: [30.8, -23.1, 9], armL: [-9.3, 14.2, -92.8], foreL: [-69.2, 2.2, -0.7],
        clavR: [-19.3, 29.3, -33.3], armR: [119.7, 31.5, -24.5], foreR: [-97.1, 0, -0.7],
        thighL: [-40, 4, 14], shinL: [104, 0, 0], footL: [8, 0, 0],
        thighR: [-7.1, -3.6, -3], shinR: [91.8, -0.7, 2.3], footR: [21.6, 5.3, 6.1],
      },
    },
    B: {
      root: { p: [-0.176, 0.334, 0.132], r: [64, 176, 0] },
      j: {
        hips: [-23.1, 21.8, 7.7], spine: [-3, 11.7, 20], chest: [-32, 34, -16.5], neck: [-12.4, 12, 21.8], head: [25.5, 3.8, 3],
        clavL: [8.5, 19, -36.8], armL: [-178.1, -81.7, -56.1], foreL: [-71.8, 0, 0],
        clavR: [28.3, -35, 0.2], armR: [-24.8, -4, 27.3], foreR: [-105.5, 2.3, 6.8],
        thighL: [77.9, 53.4, 63.9], shinL: [158.7, -8, 16.6], footL: [15.1, 2.3, 2.3],
  ...
  RNC: P('RNC', {
    ...
    A: {
      root: { p: [0.055, 0.291, -0.418], r: [-26, 8, 8] },
      j: {
        hips: [-8.2, 2.4, -17.9], spine: [26.3, -22.9, 3.1], chest: [-13.8, -3.6, 23.5], neck: [18, 0, 0], head: [-14.7, 10, 0],
        clavL: [12.2, 0.9, 38.2], armL: [39.2, -57.9, 83.5], foreL: [-102.7, -0.7, -6],
        clavR: [10.7, -22.7, -27.5], armR: [35.6, 43.4, 134.7], foreR: [-92.2, -0.7, -1.5],
        thighL: [-84.4, 13.8, 27.1], shinL: [60.2, -2.8, 6.3], footL: [-13.1, -3.7, 3.8],
        thighR: [-84.3, -27.4, -35.1], shinR: [74.5, 8.5, -3.6], footR: [-14, 4.8, -9.6],
      },
    },
    B: {
      root: { p: [-0.075, 0.277, -0.052], r: [-10, 4, 4] },
      j: {
        hips: [-32.9, 3.1, -49.4], spine: [19.3, 1.7, 19.6], chest: [5.4, 17.4, 5.4], neck: [-22.1, -14.8, -35.4], head: [-20.6, 24.5, 0.3],
        clavL: [-19.2, 25, 23.7], armL: [-148.3, 42.1, -40.9], foreL: [-118.7, -25.9, -0.7],
        clavR: [6.3, -9.4, 3], armR: [-129.5, -40.3, 40.5], foreR: [-117.2, -6.6, -1.5],
        thighL: [-43.6, 17.1, 10.3], shinL: [92.2, 23.4, -19.5], footL: [-12.9, 9.9, 39.1],
  ...
  ARMBAR: P('ARMBAR', {
    ...
    A: {
      ...
      j: {
        hips: [4.1, -5.2, 3.1], spine: [32.8, 24.5, 29.4], chest: [22.4, 1.7, 13.6], neck: [-3.9, 0.8, -0.7], head: [21.3, 0.8, 2.3],
        clavL: [-22.9, -12.4, 36.6], armL: [7, 8.8, -144.3], foreL: [-121.3, -1.5, 0],
    ...
    B: {
      ...
      j: {
        hips: [6.9, 25.1, 0], spine: [14.6, 4, 0], chest: [6.1, 5.4, 13.6], neck: [-10.2, 3, 1.5], head: [13, 0, 3],
        ...
        clavL: [13.6, -3.5, 36.6], armL: [-91.5, 53.2, -14.1], foreL: [-37, 22, 4.8],
  ...
  TRIANGLE: P('TRIANGLE', {
    ...
    A: {
      root: { p: [0.046, 0.56, -0.32], r: [30, 0, 0] },
      j: {
        hips: [6.6, 13.5, 0.8], spine: [5, 10.5, 6.1], chest: [7.1, 16.5, 25.7], neck: [20.6, 8.4, -7.3], head: [-20.1, -2.1, 0],
        clavL: [-6, -12, 43.2], armL: [-146.9, 6.1, -43], foreL: [-63, -5.1, -20.2],
        clavR: [-6.9, 35.4, -8.2], armR: [30.6, -79.6, 58], foreR: [-71, -2.3, 0],
        thighL: [-3.3, 63.8, -16.9], shinL: [77.4, 0, 12.8], footL: [14.8, 2.3, -3.6],
        thighR: [-16.7, 26, -1.7], shinR: [69.8, -2.9, -0.7], footR: [-1.4, -19.2, 0.8],
      },
    },
    B: {
      root: { p: [-0.003, 0.292, 0.123], r: [-64, 180, 0] },
      j: {
        hips: [14.1, 5.3, -6], spine: [-1.7, -35.2, -30.7], chest: [-14.2, 15.2, 9.3], neck: [-31.5, 0, 0.8], head: [20, 0.8, 0.8],
        clavL: [18.1, -10.2, 37.9], armL: [39.9, -61.5, 78.3], foreL: [-84.5, 0, 0],
        clavR: [0.8, 15.1, -15.1], armR: [-92.7, -24, 34], foreR: [-84, 0, 3],
        thighL: [-144, 9.5, 5.4], shinL: [128.4, -16.4, 15.1], footL: [-10, 0.8, -0.7],
        thighR: [-50.8, -10.2, -16.6], shinR: [152.1, -10.4, 14.6], footR: [-10, 0, -1.5],
      },
    },
    hold: [
  ...
  KIMURA: P('KIMURA', {
    ...
    A: {
      ...
      j: {
        hips: [-47.5, -17, -22.4], spine: [46.2, -8.7, 11.3], chest: [43, -12.3, 1.5], neck: [43.6, -5.9, 5.3], head: [-21.2, -6, 0],
        clavL: [-1.3, 0.9, -44.7], armL: [52.8, 108.4, 20.1], foreL: [-62.2, -0.8, 1.5],
        clavR: [-23.3, 13.9, -11.9], armR: [25.6, -111.8, -56.9], foreR: [-107, 3, 3],
        thighL: [-76.9, -1, 5], shinL: [101.3, -1.4, 1.6], footL: [9.7, -0.7, 7.9],
    ...
    B: {
      ...
      j: {
        ...
        clavL: [26.2, 18.9, 35.2], armL: [-149.5, 65.9, -70.3], foreL: [-83.3, 1.7, 0.8],
  ...
  GUILLOTINE: P('GUILLOTINE', {
    ...
    A: {
      ...
      j: {
        hips: [-7.1, -8.9, -6], spine: [32.6, -5.2, -6], chest: [-4.7, -0.6, 9.1], neck: [-21, -11.1, -13.2], head: [-25.7, 4.1, -15.4],
        clavL: [-31.4, -20.7, -5.7], armL: [-6.4, -56.8, 94.6], foreL: [-80.7, 0, 0],
        clavR: [38.6, 23.5, 1.8], armR: [-42, -67.3, -33.5], foreR: [-26.1, 1.2, -22.1],
        thighL: [17.9, 17.2, 22.7], shinL: [98.1, 0, 0], footL: [19.3, 0.8, 0],
        thighR: [9, -9.5, -13.5], shinR: [102.6, 0, -0.7], footR: [19.3, 0, -2.9],
      },
    },
    B: {
      root: { p: [-0.026, 0.299, 0.235], r: [-56, 180, 0] },
      j: {
        hips: [9.4, 27.1, 12.9], spine: [21.4, -31.2, -15.3], chest: [21.7, -4.4, -18.6], neck: [-15.1, -0.7, -0.7], head: [17.6, 0.8, 0.8],
        clavL: [23, 22.6, 21.2], armL: [61.3, -12, -137.6], foreL: [-80.6, 3.8, 1.5],
        clavR: [-21.9, -3.5, -32.2], armR: [27.5, -2.4, 86.1], foreR: [-73.4, 0.7, 0],
        thighL: [-132.1, -21.5, -8.6], shinL: [92.3, -9.6, 14.5], footL: [-8.5, 0, 0],
  ...
  ACROSS: P('ACROSS', {
    ...
    A: {
      ...
      j: {
        hips: [-29.2, 1.6, 17.1], spine: [35.5, -3, -5.1], chest: [15.7, -27.5, 7.4],
        neck: [35.6, 5.3, -5.2], head: [-24, 0, -0.7], clavL: [-18.3, -29.4, -24.3],
        armL: [-81.6, 41.6, -48.2], foreL: [-98.7, 8, 6], clavR: [25.7, -36.7, -12.6],
        armR: [-42.2, -30.1, 22.3], foreR: [-118.6, -0.5, -4.7], thighL: [-63.9, 13.3, 17.3],
        shinL: [96.8, -4.4, 5.3], footL: [11.1, 0.8, -0.7], thighR: [10.5, -49, 18.7],
    ...
    B: {
      ...
      j: {
        hips: [16, 5.5, 9.8], spine: [4, -8.9, 4.5], chest: [11.9, -15.1, 22.6],
        neck: [17.9, 60.3, 30.4], head: [31, 25, -0.7], clavL: [-12.1, 12.9, 20.8],
        armL: [-128.6, 28.8, -40.2], foreL: [-112.3, 7.5, 2.5], clavR: [7.3, -20.2, 20.6],
  ...
  MOUNT_ENTRY: P('MOUNT_ENTRY', {
    ...
    A: {
      ...
      j: {
        hips: [15.4, 16.3, 3], spine: [33.8, -16.9, -5.7], chest: [39.3, -16.2, -3.9],
        neck: [15.6, 0, 0], head: [-14, 0, 0], clavL: [1.3, -24.4, -37.9],
        armL: [-77.6, 5, -40], foreL: [-98.2, 3.2, 2.6], clavR: [4, 10, 27.5],
    ...
    B: {
      ...
      j: {
        hips: [11.8, -5, -28.4], spine: [31.5, -7.4, 6.9], chest: [20.6, 27.1, 12.9],
  ...
  BACK_WORK: P('BACK_WORK', {
    ...
    A: {
      ...
      j: {
        hips: [0.8, 3.8, -19.3], spine: [25.5, -9.7, 7.5], chest: [12.3, 6.3, 16.6],
        neck: [16.3, 0.8, 3.8], head: [-11.2, 11.8, -6], clavL: [14.3, 2.4, 42.7],
        armL: [13.1, 26.3, -113.4], foreL: [-126.9, 15.8, -1.5], clavR: [23.5, 16.2, -31.7],
        armR: [177.5, -141.6, 9.2], foreR: [-97.2, -0.7, -0.7], thighL: [-86.6, 19, 22.9],
        shinL: [49, -17.8, 2.4], footL: [-18.4, -2.9, 3.1], thighR: [-91.1, -24, -29.4],
        shinR: [79.5, 3, -2.9], footR: [-13.2, 0, -0.7],
      },
    },
    B: {
      root: { p: [0.012, 0.311, 0.003], r: [-16, 4, 4] },
      j: {
        hips: [-29.7, -48.6, -11.9], spine: [21.7, -18.6, -12.7], chest: [1.1, -20.2, -45.6],
        neck: [17, -11.9, 0.1], head: [16, -2, 6], clavL: [-21.4, 2.6, 26.3],
        armL: [-28.9, -75.7, -35.3], foreL: [-114.3, 0, 1.5], clavR: [7.4, 15.2, -31.9],
        armR: [42.2, 3.1, 34.9], foreR: [-132.2, -2.2, 0], thighL: [-73.1, -2.5, 11.8],
  ...
  RNC_WORK: P('RNC_WORK', {
    ...
    variantOf: 'RNC',
    A: {
      root: { p: [-0.039, 0.385, -0.432], r: [-26, 8, 8] },
      j: {
        hips: [-6, -11.2, -12], spine: [29.3, 2.3, 18.2], chest: [-7.8, -6.7, -3.4],
        neck: [25, 0, 0], head: [-21, 10, 0], clavL: [-12.7, -0.7, 14.3],
        armL: [22.9, -19.9, 127.3], foreL: [-97.3, -7.5, -9], clavR: [4.7, 4.1, -44.7],
        armR: [-6.8, 15.9, 97.2], foreR: [-89.9, 0.8, 0.7], thighL: [-82, 23.6, 30.9],
        shinL: [69.3, -22.2, 24.9], footL: [-18.4, -2.1, 0.1], thighR: [-78.4, -20.8, -33],
        shinR: [69.2, 27.1, -21.7], footR: [-16.2, -0.7, -2.9],
      },
    },
    B: {
      root: { p: [-0.086, 0.403, -0.102], r: [-10, 4, 4] },
      j: {
        hips: [-12.5, 17.3, -30.7], spine: [7, -4.3, 8.3], chest: [15.3, 22, -2.2],
        neck: [-7, -24.7, -37.2], head: [8, 31.1, 23.4], clavL: [-9.5, 22.1, 13.9],
        armL: [-154, 37.8, -55.7], foreL: [-125.4, -23.3, -1.5], clavR: [-5.6, -10.9, 2.3],
        armR: [-138.5, -41, 36], foreR: [-121.7, 3.2, 0], thighL: [-66.2, 2.8, -4],
  ...
  HALF_GUARD_WORK: P('HALF_GUARD_WORK', {
    ...
    A: {
      root: { p: [0.153, 0.475, -0.118], r: [0, 24, 0] },
      j: {
        hips: [18.5, -0.5, 18.8], spine: [6.8, -13.3, 18.3], chest: [-6.2, -18.4, 12.2],
        neck: [12.5, 0, 2.3], head: [-10, 0, 0], clavL: [-16.6, -7.9, 37],
        armL: [-6.5, -5.8, -74.8], foreL: [-76.2, 0, 0], clavR: [30.2, -31, -20.3],
        armR: [-20.6, 41.1, -83.1], foreR: [-119.1, 5.3, -0.7], thighL: [-11.1, 4.8, 31.4],
        shinL: [107, 0, 0], footL: [10, 0, 0.8], thighR: [-38.6, 61.9, -34.7],
        shinR: [117.2, 10.8, -0.6], footR: [-1.2, -26, 1],
      },
    },
    B: {
      root: { p: [-0.05, 0.291, 0.106], r: [-72, 156, -22] },
      j: {
        hips: [13.1, 6.2, -2.9], spine: [2, 7.1, 27.3], chest: [11.5, 2.8, -6.7],
        neck: [-24.5, 0, 0.8], head: [14, 3, 6.8], clavL: [10.3, 25.9, -31.4],
        armL: [21.3, -74.8, 98.2], foreL: [-102.6, 0, 0], clavR: [2.3, 21.5, -39.2],
        armR: [2.6, 25.1, -61.3], foreR: [-124.7, -3, 0.8], thighL: [-86.4, 15.6, 24.8],
  ...
  MOUNT_WORK: P('MOUNT_WORK', {
    ...
    A: {
      ...
      j: {
        hips: [54.9, 9, -13.5], spine: [-28.4, 24.6, -28.6], chest: [49.3, -4.8, -5.5],
        neck: [19.1, 5.7, -27.4], head: [-6.2, 0, -14.9], clavL: [10, -16.9, -16.3],
        armL: [-80.3, 4.1, -31.9], foreL: [-87, 16.3, 3.4], clavR: [24.5, -6.7, 30.7],
        armR: [-82, -7.4, 33.8], foreR: [-118.2, 19.9, 7.8], thighL: [-43.5, 15.3, 85.9],
        shinL: [81.5, 40.5, -33], footL: [25.9, 0.8, 1.6], thighR: [-14.9, -32.1, 2.3],
        shinR: [73.8, -20.2, 22.5], footR: [18, 0, 0],
      },
    },
    B: {
      root: { p: [0.038, 0.247, 0.227], r: [-90, 180, 0] },
      j: {
        hips: [15.1, -22.1, -6], spine: [1.3, 4.6, -13.4], chest: [19.8, 10, 24.8],
        neck: [1.8, 0, 7.3], head: [25.6, -1.5, 8], clavL: [-0.3, -41.2, 17.6],
        armL: [-156.4, 62.2, 1.1], foreL: [-113.1, 9.2, 6.1], clavR: [10, 12.2, -26.4],
        armR: [-212, 13.3, 20.1], foreR: [-83, 19.6, 5.3], thighL: [-32.6, -13.1, -16.9],
        shinL: [31.1, -1.4, 2.5], footL: [-5.6, 6.2, -8.8], thighR: [-29.4, -8.2, -2.3],
        shinR: [30.4, -0.7, -6], footR: [-14, -6, -1.5],
      },
    },
  }),
  ...
  SIDE_CONTROL_WORK: P('SIDE_CONTROL_WORK', {
    ...
    A: {
      ...
      j: {
        hips: [-60, -26, -23.8], spine: [29.9, -0.8, 10.1], chest: [36.7, -18.9, 14.8],
        neck: [-7.6, 13.8, 39.5], head: [-39, -12.7, -24.7], clavL: [-17.7, -26, -27.7],
        armL: [-5, -42.8, -0.8], foreL: [-72.7, 0.8, 0], clavR: [16, -41.9, -11.8],
        armR: [52.9, 13.2, -25.2], foreR: [-138.6, -2.2, 0], thighL: [-62.2, -12.9, -5.2],
    ...
    B: {
      ...
      j: {
        ...
        neck: [20.4, 73.2, 5.3], head: [22.2, 31.3, 7.8], clavL: [-9.3, -11.1, -7.7],
        armL: [33.6, 15.2, -147.5], foreL: [-69.9, -1.5, 0], clavR: [12.4, -28.2, 5.3],
        armR: [-72.9, -44.4, 2.6], foreR: [-61.3, 1.9, -2.6], thighL: [-40.7, 6.8, 12.8],
        shinL: [52, -1.5, 0], footL: [-16, 0, 0], thighR: [-15.1, 0.1, -14.5],
        shinR: [32.7, 0.8, -6.7], footR: [-7.6, 0.8, 0],
      },
    },
  }),
  ...
  CLOSED_GUARD_WORK: P('CLOSED_GUARD_WORK', {
    ...
    A: {
      root: { p: [-0.041, 0.525, -0.337], r: [0, 0, 0] },
      j: {
        hips: [29.3, -24.7, 41.5], spine: [27.6, 19.7, 13.7], chest: [14, -8.8, 22.1],
        neck: [0.3, 0, 0], head: [-1.9, 0, 0.8], clavL: [29.6, -11.8, -4],
        armL: [21, -9.5, 156.9], foreL: [-92.6, 0.8, 0], clavR: [-17.5, 36.7, 2.8],
        armR: [22.5, -74.1, 78.6], foreR: [-83.2, 1.5, 3], thighL: [16.4, 9.2, 15.7],
        shinL: [92, 1.5, 1.6], footL: [24.8, 0.8, 0.8], thighR: [36.7, -20.8, -21.3],
        shinR: [92.8, 0, 1.5], footR: [24.8, 1.5, 0.8],
      },
    },
    B: {
      root: { p: [-0.034, 0.244, -0.039], r: [-84, 168, 0] },
      j: {
        hips: [6.3, 25.6, -1.4], spine: [20, 23.7, 20.6], chest: [8, 9.1, -19.8],
        neck: [-17.2, -0.7, 0], head: [10, 0.8, 0], clavL: [1.5, 2.4, -7.2],
        armL: [19, -41.5, 45.3], foreL: [-70.8, -0.7, 1.5], clavR: [-34.2, 29.4, -19.3],
        armR: [14.7, 20, -4.8], foreR: [-73.7, 0.8, -0.7], thighL: [-29.9, 9.4, 5.5],
        shinL: [160.5, 7.7, -20.4], footL: [-10, 0.8, 0], thighR: [-112.3, 15, 2.3],
        shinR: [152.5, -1.9, 11.7], footR: [-9.2, 0.8, 0.8],
      },
    },
  }),
  ...
  OPEN_GUARD_WORK: P('OPEN_GUARD_WORK', {
    ...
    A: {
      root: { p: [-0.064, 0.581, -0.524], r: [0, 0, 0] },
      j: {
        hips: [0.6, 5.4, -20.2], spine: [29.6, -8.2, -0.7], chest: [22, 1.5, 3.8],
        neck: [19.3, 0, 1.5], clavL: [0.8, -4.5, 17.7], armL: [-96.3, 35.9, -20.9],
        foreL: [-27.2, -7.4, 7.7], clavR: [-11.9, 35.3, -14.5], armR: [59.7, 3.3, -103],
        foreR: [-120.2, 21.8, 1.5], thighL: [-25.8, 26.3, 5.7], shinL: [95.2, 20.4, -14.9],
        footL: [20.9, -6.6, 1.7], thighR: [-8.7, -21.4, -17], shinR: [77.8, 1.5, -4.5],
        footR: [-20, 0, 0],
      },
    },
    B: {
      root: { p: [0.038, 0.294, 0.081], r: [-78, 180, 0] },
      j: {
        hips: [32.8, -6, 0.8], spine: [15.8, -2.9, -23.9], chest: [6.8, 10.5, 5.4],
        neck: [-18.5, 0, 1.5], head: [13.5, 0, 0], clavL: [0.1, -20.1, 3.1],
        armL: [30.8, -29.1, 95.4], foreL: [-72, -1.5, -0.7], clavR: [-8.8, 18.8, -5.2],
        armR: [-21.6, -56, 34.8], foreR: [-73.1, 0, 0], thighL: [-89.7, 12.1, 14.3],
        shinL: [10.6, -20.1, -8.9], footL: [-24, 0, 0], thighR: [-101.5, -6.2, -10.4],
  ...
  KNEE_ON_BELLY_WORK: P('KNEE_ON_BELLY_WORK', {
    ...
    A: {
      root: { p: [0.096, 0.581, 0.077], r: [-6, 100, 0] },
      j: {
        hips: [-48.5, -32.2, 18.3], spine: [9.4, -19, 12.1], chest: [-29.9, -10.4, 34.8],
        neck: [-0.4, -35.2, 6.1], head: [-20.5, -13.5, 0], clavL: [-3.3, 16.9, 41.3],
        armL: [-156.1, 116.9, 59.2], foreL: [-68, -2.2, 0], clavR: [3.9, -19.9, 31.3],
        armR: [-47.6, -84.4, -35], foreR: [-72.6, -1.5, 0], thighL: [-128.9, -31.2, -1.2],
        shinL: [45.8, 0, 0.8], footL: [8, 0, 0], thighR: [-40.8, -19.9, -54.1],
        shinR: [24.2, 22.9, -18.5], footR: [-18.6, 1.6, 6.2],
      },
    },
    B: {
      root: { p: [-0.187, 0.247, 0.027], r: [-90, 180, 0] },
      j: {
        hips: [2.4, 68.5, 0.8], spine: [-19.9, -30.3, 15], chest: [15.1, 24, 36.9],
        neck: [-19.7, -0.7, 0.8], head: [19.3, -23.2, -0.7], clavL: [3.9, 31, 32.1],
        armL: [162, -14.4, 16.4], foreL: [-69.2, -2.2, 0], clavR: [-18.4, -3.4, -39.9],
        armR: [-61.9, -22.1, 21.1], foreR: [-89.9, 0, -0.7], thighL: [-44.5, 6.1, 16.6],
        shinL: [68, 2.3, -2.1], footL: [-17.4, -1.3, -8.9], thighR: [-20, -6.7, -10],
  ...
  TURTLE_WORK: P('TURTLE_WORK', {
    ...
    variantOf: 'TURTLE',
    A: {
      root: { p: [0.039, 0.554, -0.519], r: [10, 26, 0] },
      j: {
        hips: [5.4, 38, 26.6], spine: [46.5, 8.8, 2.3], chest: [37.7, -18.6, 9.9],
        neck: [29.8, 7.5, -16.3], head: [-14.8, -5.1, -6.6], clavL: [25.5, -20.2, 27.3],
        armL: [-37, 27.2, -39.4], foreL: [-61, 39.2, 30.9], clavR: [-6.3, 36.2, -18],
        armR: [-8.6, -70.7, -76.7], foreR: [-98.8, 3, -0.7], thighL: [-23.6, 1.2, 18.6],
        shinL: [97.6, 4.6, 3.1], footL: [12.6, 0.1, 3.8], thighR: [-49.9, -20.3, -3.1],
        shinR: [93.8, -6.6, 1.5], footR: [-8.3, -20.8, -5],
      },
    },
    B: {
      root: { p: [0.021, 0.296, 0.153], r: [64, 176, 0] },
      j: {
        hips: [10.6, -2.1, 28.7], spine: [-4, 9.8, 20.6], chest: [-29.6, 33.1, -15.2],
        neck: [-35.4, 0, 0.9], head: [31.3, -0.7, 4.6], clavL: [-3.4, 43.1, 0.7],
        armL: [-96.9, 31.4, -9.7], foreL: [-125.2, -0.7, 4.6], clavR: [35.3, -25, 7.4],
        armR: [-18.3, -2.3, 27.4], foreR: [-110.9, 5.4, 6.9], thighL: [77, 49.8, 58],
        shinL: [155.6, -4.9, 10.9], footL: [33.2, 0.1, 0.1], thighR: [38.6, 2.7, -77.6],
  ...
  ARMBAR_WORK: P('ARMBAR_WORK', {
    ...
    variantOf: 'ARMBAR',
    A: {
      root: { p: [-0.415, 0.182, 0.409], r: [-90, 90, 0] },
      j: {
        hips: [-3.6, -6, 9.2], spine: [12.3, 24.5, 24.5], chest: [35.1, 1.2, 11.8],
        neck: [-3.9, 0.8, -0.7], head: [23.5, -1.5, 0.1], clavL: [-9.6, -14.8, 39.7],
        armL: [-58, -69.2, 55.9], foreL: [-78.9, 0, 0], clavR: [0.7, 4.2, -27.2],
        armR: [-107.9, -17.3, 37.2], foreR: [-115.1, -4.2, 5.6], thighL: [-40.7, 1.5, 51.3],
        shinL: [-0.3, -1.3, 0.1], footL: [-12.7, 0.1, -1.5], thighR: [-5.5, 8.5, -24.4],
        shinR: [35.8, 3.2, -2.9], footR: [-2.5, 3.9, -2.9],
      },
    },
    B: {
      root: { p: [-0.025, 0.297, -0.07], r: [-90, 180, 0] },
      j: {
        hips: [1.6, 10.9, 3.9], spine: [24.6, 24.9, 2.4], chest: [6.8, 12.1, 10],
        neck: [-5.5, 4.6, -2.1], head: [4.1, 0.8, -2.2], clavL: [11.2, 9.2, 37.7],
        armL: [-79, 50.6, -10.4], foreL: [-49.5, -17.7, 16.4], clavR: [23.6, 19.7, -23.1],
        armR: [-61.8, -19.9, 26.6], foreR: [-74, 8.5, 4.7], thighL: [-15.3, 34.9, -0.1],
        shinL: [60.7, 12.8, -8.9], footL: [-11.2, 0.8, 0.8], thighR: [-5.4, -4.3, -6.3],
        shinR: [35.9, -0.6, -2.9], footR: [-17.7, -0.7, 0.8],
      },
    },
  }),
  ...
  TRIANGLE_WORK: P('TRIANGLE_WORK', {
    ...
    variantOf: 'TRIANGLE',
    A: {
      root: { p: [-0.066, 0.333, -0.274], r: [30, 0, 0] },
      j: {
        hips: [-7, 30, -11.9], spine: [-15.2, 13.6, 6.8], chest: [6, 8.4, 19.6],
        neck: [11.8, 0.8, -14.2], head: [-11.5, -3.7, 0], clavL: [-1.9, -0.9, 30.8],
        armL: [-150.4, 15.9, -52.2], foreL: [-51.7, 9.2, -1.4], clavR: [-3.3, 38.5, -8],
        armR: [10.9, -81.3, 63.8], foreR: [-90.7, -3.7, -3], thighL: [-45.2, 89.9, 21.4],
        shinL: [94.5, -6, 10.5], footL: [11.1, -5.9, -8.2], thighR: [-38.5, -51.1, -44.2],
        shinR: [102.1, -9, 12.1], footR: [17.3, 0.1, 5.4],
      },
    },
    B: {
      root: { p: [0.064, 0.289, 0.115], r: [-58, 190, 0] },
      j: {
        hips: [22.8, 22.8, -12.2], spine: [-0.9, -34.2, -27.4], chest: [4.3, 8.4, -3.6],
        neck: [-14.5, 0, 0], head: [14, 2.3, 0], clavL: [8.5, 3.3, 23.6],
        armL: [-21.4, -24, 52.1], foreL: [-69, 3, 13.6], clavR: [5.3, 25.6, -33.8],
        armR: [-46.2, -9.1, 56.9], foreR: [-106.8, 0, 0], thighL: [-138, 18.4, -5.3],
        shinL: [124.8, -20.1, 14.3], footL: [-8.5, 0.8, -1.5], thighR: [-45.7, -3.3, -20.4],
        shinR: [150.8, 3.1, 9.3], footR: [-10, 0, 0],
      },
    },
  }),
  ...
  KIMURA_WORK: P('KIMURA_WORK', {
    ...
    variantOf: 'KIMURA',
    A: {
      root: { p: [0.356, 0.414, 0.279], r: [12, 116, 0] },
      j: {
        hips: [-43.1, -6.6, -16.4], spine: [43, -13.3, 9.9], chest: [48.4, 5.3, 4.8],
        neck: [46.6, -2.2, 0], head: [-28, 0, 0], clavL: [9.4, 11.4, -41.2],
        armL: [63, 115.6, 21.3], foreL: [-71.2, 0.7, -0.7], clavR: [-14.1, 11.6, -3],
        armR: [26.5, -98.9, -38.2], foreR: [-113, -6, 0], thighL: [-80.2, 8.8, 11.1],
        shinL: [109.2, 5.3, 0.1], footL: [6.6, -3.7, 3.1], thighR: [-18.5, 14.1, -22.7],
        shinR: [106.3, 6.8, -6.7], footR: [19.6, 0, 0.8],
      },
    },
    B: {
      root: { p: [-0.12, 0.301, -0.007], r: [-90, 180, 8] },
      j: {
        hips: [5, -2.3, 6.8], spine: [2.6, 7, 0.8], chest: [11.4, 1.4, 6],
        neck: [-26.7, -0.7, 0.8], head: [-6.5, -26, 7.5], clavL: [29.2, 16, 29.2],
        armL: [-130.6, 54, -56.4], foreL: [-88.4, -14.1, -3.6], clavR: [-21.8, -37.3, -1.3],
  ...
  GUILLOTINE_WORK: P('GUILLOTINE_WORK', {
    ...
    A: {
      ...
      j: {
        hips: [13.9, 6.1, -6], spine: [17.7, -13.3, -6], chest: [-9.2, 18.3, -3],
        neck: [-50.1, -21.3, -7.9], head: [-26, 1.1, -12.7], clavL: [0.6, -3.4, 18.9],
        armL: [44.2, -86.3, 134.5], foreL: [-70.8, 2.2, 2.3], clavR: [34.3, -2.2, 24.8],
        armR: [-168.7, -31.2, -6], foreR: [-66.8, 3.8, 0], thighL: [13.8, 26.8, 28.6],
    ...
    B: {
      ...
      j: {
        hips: [-6.8, 36.9, 12.8], spine: [28.3, 5.4, 20.5], chest: [19.5, -30.6, -38.7],
        neck: [-28.6, 0.8, 0.8], head: [27.3, 1.5, -0.7], clavL: [39.2, -8, -11],
        armL: [91, 26.9, -103.9], foreL: [-47.5, 27.7, -2.2], clavR: [-17, -9.4, -17.7],
        armR: [-7.6, 11.6, 64.2], foreR: [-47.2, 6.8, 0], thighL: [-138.4, -28.9, -2.5],
  ...
  BACK_WORK2: P('BACK_WORK2', {
    ...
    variantOf: 'BACK',
    A: {
      root: { p: [-0.029, 0.406, -0.38], r: [-22, 8, 6] },
      j: {
        hips: [-7.4, 7.5, -1.5], spine: [36.8, 13.5, 9], chest: [16.8, 13.5, 28.6],
        neck: [23.4, 0.1, 0], head: [-19.2, 13.3, 0], clavL: [27.9, -28.4, 15.8],
        armL: [29.9, -20.2, 143], foreL: [-114.2, -9, -0.7], clavR: [13.7, 24.3, -25.8],
        armR: [18.4, 57.3, -96.9], foreR: [-90.4, 6, 6], thighL: [-70.1, 18.1, 25.1],
        shinL: [86.3, 3.8, -10.4], footL: [-17.7, -10.5, -16.3], thighR: [-76.7, -38.8, -66.7],
        shinR: [85.1, 19.8, -16.9], footR: [-13, 3.1, 3.2],
      },
    },
    B: {
      root: { p: [0.064, 0.286, 0.083], r: [-16, 4, 4] },
      j: {
        hips: [-19.5, -38.2, 15], spine: [-6.3, 29.2, -12.7], chest: [1, -3.2, -31.2],
        neck: [17.9, -1.9, -14.9], head: [26.8, -24.4, -0.7], clavL: [-11.3, -10.1, 30],
        armL: [136.6, 122.2, 25.6], foreL: [-92.2, 2.3, 0.8], clavR: [-4.1, 12.4, -43.8],
        armR: [-30.4, -46.5, 122.5], foreR: [-70.4, 0, 0], thighL: [-59.4, 7.4, 23.1],
        shinL: [79.3, -13.4, 7.6], footL: [-9.9, -1.5, 0.1], thighR: [-88.6, 9.4, -1.7],
        shinR: [110.4, -1.1, 4.8], footR: [9.8, -9.4, -16.9],
      },
    },
  }),
  ...
  RNC_WORK2: P('RNC_WORK2', {
    ...
    variantOf: 'RNC',
    A: {
      root: { p: [-0.115, 0.385, -0.354], r: [-26, 8, 8] },
      j: {
        hips: [-10.4, 5.3, -6], spine: [43.7, -20.9, -15.7], chest: [14.4, -13.5, 5.5],
        neck: [37.6, 3, -0.7], head: [-17.3, 10, -0.7], clavL: [8.2, 0.1, 29.9],
        armL: [25.8, 9, 157.9], foreL: [-121.3, -6, 7.5], clavR: [-5.7, -34.9, -26.6],
        armR: [-20.4, 27.9, 105.4], foreR: [-84, 0, 0], thighL: [-69.4, 26.5, 31.8],
        shinL: [62.5, -2.9, -6.6], footL: [-13, -6.5, 7.1], thighR: [-69.5, -7.2, -35.2],
        shinR: [73.9, 4, 14.4], footR: [-8.5, 18.3, -28.3],
      },
    },
    B: {
      root: { p: [-0.011, 0.293, -0.042], r: [-10, 4, 4] },
      j: {
        hips: [-22, -18.9, -21.6], spine: [30.3, 0.3, 13.7], chest: [10.6, 36.1, 1],
        neck: [-3, -17.3, -28.6], head: [12.1, 30.3, 20.7], clavL: [-4.2, 26.5, 26.7],
        armL: [-152.8, 40.6, -38.9], foreL: [-142, -1.5, 0], clavR: [-4.8, -5.6, 4],
        armR: [-126.2, -37.2, 38.5], foreR: [-102.9, -5.9, 0], thighL: [-85.2, 2.1, 5.9],
        shinL: [77.1, 5.3, -8.2], footL: [-10, -5.1, 5.3], thighR: [-78.3, 3.5, -8.6],
  ...
  HALF_GUARD_WORK2: P('HALF_GUARD_WORK2', {
    ...
    variantOf: 'HALF_GUARD',
    A: {
      root: { p: [0.151, 0.547, -0.118], r: [0, 24, 0] },
      j: {
        hips: [1.5, -33, -6], spine: [13.6, -15.6, 13.8], chest: [-16.8, -14.8, 26.9],
        neck: [13.6, 0, -0.7], head: [-17.4, 0, 0.8], clavL: [-21.5, 6, 35],
        armL: [25.9, -26.9, -85.9], foreL: [-72.3, -3, 0], clavR: [31.3, -4.8, -3.4],
        armR: [-28.2, -32.3, 47.6], foreR: [-104.9, 0.8, 0], thighL: [-35.2, 16.3, 39],
        shinL: [123.3, -10.5, 9.1], footL: [10, 0, 0], thighR: [-10.8, 48, -5.9],
        shinR: [108.7, 11.4, -6.5], footR: [0.8, -8.2, 6.8],
      },
    },
    B: {
      root: { p: [-0.059, 0.406, 0.105], r: [-72, 156, -22] },
      j: {
        hips: [26.1, 18.5, 11.1], spine: [17.8, 20.5, 43], chest: [-9.5, -11.1, -46.7],
        neck: [-7.1, 0, -0.7], head: [8, 0, 5.3], clavL: [7.8, 16.8, -27.8],
        armL: [2.1, -84.3, 74], foreL: [-104.2, 0, 0], clavR: [8.9, 9.3, -22.8],
        armR: [28.3, -4.2, -47.8], foreR: [-144.9, 3.8, -1.5], thighL: [-101.6, 12.7, 23.4],
        shinL: [95.1, 1.5, 0], footL: [-14, 0, 0], thighR: [-49.5, -37, -37.9],
        shinR: [69.6, 2.6, -8.8], footR: [-16, -4.4, -5.2],
      },
    },
  }),
  ...
  SIDE_CONTROL_WORK2: P('SIDE_CONTROL_WORK2', {
    ...
    A: {
      ...
      j: {
        hips: [-54.4, -52.7, -38.2], spine: [11.5, 0.6, 23.1], chest: [48.1, 0.8, 8.6],
        neck: [13.7, -2.7, 8], head: [-25.5, 0, 6], clavL: [1, -38, -23.9],
        armL: [-10.9, -34.4, 7], foreL: [-72, 0.8, 0], clavR: [25.7, -36.5, 1.2],
        armR: [47.8, 13.6, -32.6], foreR: [-123.5, -1.5, 0], thighL: [-56.3, -18.7, -8.1],
        shinL: [119.6, -16.3, 12.8], footL: [22.8, 4.5, 3.8], thighR: [-31.8, -18.1, -18],
    ...
    B: {
      ...
      j: {
        hips: [20, -15.7, 12], spine: [0, -13.2, 3.8], chest: [14.5, -1.9, 9.1],
        neck: [30.9, 63.6, -8.6], head: [-6.1, 44.1, -1.9], clavL: [10, -14.1, 30.1],
        armL: [34.1, -36.3, 131.1], foreL: [-62.1, -10.5, 0.7], clavR: [8.8, -32.2, 27.1],
        armR: [-40.4, 67.5, -106.8], foreR: [-93.7, 0, 0], thighL: [-41.2, 6.8, 6.8],
