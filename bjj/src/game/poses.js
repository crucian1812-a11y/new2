...
export const POSES = {
  ...
  CLINCH: P('CLINCH', {
    ...
    A: {
      ...
      j: {
        hips: [-12.2, -10.5, 1.6], spine: [31.3, -6, 9.8], chest: [17.5, 14.3, -2.8], neck: [-13, -1.2, -1.5], head: [-2.5, 0.8, 0],
        clavL: [29.6, -4.1, 27.7], armL: [-107.4, 52.1, 14.8], foreL: [-144.2, 14.8, 25.3],
    ...
    B: {
      ...
      j: {
        ...
        thighR: [0.4, -3.2, -17.1], shinR: [26.5, -5, 6.1], footR: [6.7, 19.1, 20.4],
      },
    },
    grips: [
  ...
  CLOSED_GUARD: P('CLOSED_GUARD', {
    ...
    A: {
      ...
      j: {
        hips: [16, -23.1, 29.4], spine: [42.3, 17.4, 13.6], chest: [12.9, -14.1, 12.3], neck: [7.9, -0.7, -2.2], head: [-11.7, -0.7, 1.5],
    ...
    B: {
      ...
      j: {
        hips: [8.1, 22.6, 8.5], spine: [14.7, 21.9, 30.2], chest: [7.1, 9.9, -32.7], neck: [-20.1, 1.6, -0.7], head: [16, -2.2, -0.7],
        clavL: [3.1, 3.1, -1.2], armL: [-87.8, 27.6, -29.7], foreL: [-59.2, 0.8, 0.8],
        clavR: [-31.1, 25.6, -19.2], armR: [-107.3, -37.6, 7.5], foreR: [-83.2, 16.8, 19.8],
        thighL: [-50.6, 12.5, 15.3], shinL: [145.1, -2.9, -9.9], footL: [-10, 1.5, 0.8],
        thighR: [-116.8, 15, 5.3], shinR: [153.5, -6.5, 16.2], footR: [-10, -0.7, 0],
      },
    },
    hold: [
  ...
  OPEN_GUARD: P('OPEN_GUARD', {
    ...
    A: {
      ...
      j: {
        hips: [17.8, -0.7, -18.6], spine: [9.9, -21.7, -0.7], chest: [14.1, 2.3, 1.5], neck: [6.5, 0, 0],
  ...
  HALF_GUARD: P('HALF_GUARD', {
    ...
    points: 0, top: 'A', ground: true, guardOf: 'B',
    A: {
      root: { p: [0.199, 0.54, -0.101], r: [0, 24, 0] },
      j: {
        hips: [16.9, -18.7, 30.8], spine: [11.3, -9.6, 15.8], chest: [-7.7, -20.9, 20.4], neck: [11, 0, -0.7], head: [-7, 0, 0],
        clavL: [-18.5, 10.5, 26], armL: [-121.3, 80.8, 10.5], foreL: [-75, -5, -4.2],
        clavR: [37, -11.1, 3.3], armR: [-33.8, 4.3, -12.7], foreR: [-65.5, 40.7, 30.4],
    ...
    B: {
      ...
      j: {
        hips: [2.6, -14.1, -16.4], spine: [11.2, 24.9, 39.2], chest: [16.7, 2.4, -2.2], neck: [-14.7, 7.5, 0.8], head: [13.3, 0.8, 6.1],
  ...
  SIDE_CONTROL: P('SIDE_CONTROL', {
    ...
    A: {
      ...
      j: {
        hips: [-71.7, -29.7, -31.5], spine: [16.2, -8, 8.9], chest: [26.5, 6.8, 23.5], neck: [2.9, 22.9, 36.3], head: [6.1, 15.9, 6.9],
        clavL: [-11.6, -26.8, -29.3], armL: [-84.5, 41.5, -45.6], foreL: [-120.1, 31.8, 13],
        clavR: [34.1, -26.8, 7], armR: [-27.3, -8.9, 57.7], foreR: [-112.2, 9.2, -12.4],
        thighL: [-35.7, -9.1, -13.3], shinL: [112.2, -17.8, 25.7], footL: [8.5, -9.7, -3.7],
        thighR: [-25.7, -5.2, -24.9], shinR: [82, 15.1, -13.5], footR: [17, 12.8, 0.8],
      },
    },
    B: {
      root: { p: [-0.169, 0.232, -0.03], r: [-90, 180, 0] },
      j: {
        hips: [10.8, 5.3, 6], spine: [6.5, -14.9, 3.8], chest: [19.5, -3.7, 14.3], neck: [-6.4, 55.8, 0.9], head: [3.5, 23, 9.5],
        clavL: [-17.8, -16.4, 33.7], armL: [-126.8, 30.8, -39.1], foreL: [-110.7, 18.2, 3.8],
        clavR: [-15.1, -15.4, 38.5], armR: [-95.1, -65.2, -10], foreR: [-88.3, 32.9, 1.2],
        thighL: [-27.1, 8.4, 10.6], shinL: [40.8, -4.5, -1.5], footL: [-15.2, 0.1, 2.3],
        thighR: [-19.6, 3.2, -9.1], shinR: [35.6, 9.9, 0.9], footR: [-9.8, 4.7, 3.3],
      },
    },
    hold: [
      { of: 'A.chest', above: 'B.chest', by: 0.16 },
  ...
  KNEE_ON_BELLY: P('KNEE_ON_BELLY', {
    ...
    A: {
      root: { p: [0.105, 0.58, 0.105], r: [-6, 100, 0] },
      j: {
        hips: [-44.4, -35.2, 10.5], spine: [7.3, 1.7, 17.4], chest: [-38.6, -23.9, 30.8], neck: [3.8, -38.9, 10.6], head: [-16.7, -14.2, 0],
        clavL: [-9.3, 30.1, 29.9], armL: [-46.5, 19.4, -26.9], foreL: [-68.1, 0.8, -2.1],
        clavR: [6.4, -27.6, 16.9], armR: [-32.2, 12.4, 38.6], foreR: [-32.3, 39.4, 30.4],
        thighL: [-134.4, -14, -24.4], shinL: [59.6, 0, 0], footL: [8, -0.7, 0],
        thighR: [-32.9, -25.2, -49.9], shinR: [14.2, 23.5, -23], footR: [-24.3, -6.3, 7.9],
      },
    },
    B: {
      root: { p: [-0.192, 0.25, 0.005], r: [-90, 180, 0] },
      j: {
        hips: [9.3, 72.8, -3.7], spine: [-19.8, -23, 14.3], chest: [17.3, 5.4, 30.1], neck: [-14.5, -0.7, -0.7], head: [12, -24.7, -0.7],
        clavL: [-4, 23.5, 36.8], armL: [-116.8, 46.2, -29.5], foreL: [-81.5, -5.2, -2.2],
        clavR: [-18.2, -1.9, -33.3], armR: [-70.2, -30.4, 27.1], foreR: [-74.8, 0.8, 0],
        thighL: [-39.1, 9.8, 12.1], shinL: [52.1, 6, -3], footL: [-16, 0, 0.8],
  ...
  MOUNT: P('MOUNT', {
    ...
    A: {
      root: { p: [0.016, 0.536, 0.089], r: [0, 0, 0] },
      j: {
        hips: [48.3, 32.4, -4.5], spine: [-7.4, 15.4, -33.5], chest: [37.1, -35.7, -5.5], neck: [22.6, 2.3, 0.1], head: [-10.6, 5.4, 1.6],
        clavL: [25.9, -7, -30.3], armL: [-94.4, 14.7, -23.6], foreL: [-71.2, 4.3, 0.2],
        clavR: [23, 5.8, 39.2], armR: [-83.6, -2.1, 40.6], foreR: [-114.7, 16.7, 13.9],
        thighL: [-47.3, 11.6, 80.1], shinL: [56.8, 51.1, -24], footL: [17.3, 1.5, 0],
        thighR: [-15.6, -47.2, -5.3], shinR: [74, -23.2, 0.8], footR: [17.3, 0, 0.8],
      },
    },
    B: {
      root: { p: [0.013, 0.258, 0.248], r: [-90, 180, 0] },
      j: {
        hips: [17.1, -19.9, -18.7], spine: [15.2, -9.5, -16.3], chest: [23, 10.6, 21.3], neck: [-2, 2.3, -3], head: [11.8, 1.6, 3.1],
        clavL: [-3.7, -38.1, 14.9], armL: [-145.8, 41.2, 12.4], foreL: [-118, 23.7, 13.9],
        clavR: [-0.4, 10.2, -17.3], armR: [-172.7, 20.2, 30.9], foreR: [-73, -12.5, -5.1],
        thighL: [-34.2, -13.8, -10.7], shinL: [35.8, 0, 1.5], footL: [-4.9, 0.8, -5.9],
  ...
  BACK: P('BACK', {
    ...
    A: {
      ...
      j: {
        hips: [-14.1, 9.8, -19.3], spine: [22, -14.1, -17.2], chest: [20.8, -6, 23.4], neck: [25.1, 0.8, 3.8], head: [-11.2, 8.8, 0.8],
        clavL: [3.8, -5.1, 12.7], armL: [-144.9, 19.5, -50.7], foreL: [-92.6, -1.3, 6.8],
        clavR: [9.9, 25, -2.6], armR: [-92.5, -25.2, 8.4], foreR: [-113, -53.1, -50.1],
        thighL: [-92.3, 23.3, 17.7], shinL: [83.6, 9.9, -9.6], footL: [-16.1, 0, 0.1],
        thighR: [-68.3, -16.3, -39], shinR: [70.2, 0, 0.8], footR: [-10.9, 5.4, -2.8],
      },
    },
    B: {
      root: { p: [0.038, 0.292, -0.09], r: [-16, 4, 4] },
      j: {
        hips: [-38, -33.5, 1.5], spine: [21.1, -17, -5.2], chest: [-5.6, 1.7, -46.4], neck: [5.4, -20.9, -8.8], head: [19.5, -8.2, 3.8],
        clavL: [-23.7, -1.9, 26.9], armL: [-130, 11.7, -34.8], foreL: [-62.7, 3.1, -10.2],
        clavR: [11.4, 18.8, -33.7], armR: [-93.9, -27, 30.6], foreR: [-84.7, 4.7, 8.4],
  ...
  TURTLE: P('TURTLE', {
    ...
    A: {
      root: { p: [0.002, 0.536, -0.463], r: [10, 14, 0] },
      j: {
        hips: [-6, 12.8, 38.4], spine: [40.3, 28.7, 18], chest: [30.1, -2.4, -13.2], neck: [21.4, -4.5, 5.3], head: [-14.1, 0, 2.3],
        clavL: [30, -26.1, 15.7], armL: [9.6, 1.7, -66.5], foreL: [-54.2, 55.9, 24.9],
        clavR: [-14.1, 31.5, -33.3], armR: [-116.7, -7.1, 54.4], foreR: [-14.9, -1.1, -29.2],
        thighL: [-40, 4, 14], shinL: [104, 0, 0], footL: [8, 0, 0],
        thighR: [-7.9, -2.9, -1.5], shinR: [91, 0, 1.5], footR: [21.6, 4.5, 6.8],
      },
    },
    B: {
      root: { p: [-0.183, 0.304, 0.128], r: [64, 176, 0] },
      j: {
        hips: [-11.9, 21.8, 7.7], spine: [-15, 20.7, 23], chest: [-35.8, 35.5, -18.8], neck: [-12.4, 12, 21.8], head: [25.5, 3.8, 3],
        clavL: [4, 14.5, -42.1], armL: [-67.7, 22.2, -28.6], foreL: [-116, -4.5, -0.7],
        clavR: [28.3, -35, 0.2], armR: [-24.8, -4, 27.3], foreR: [-105.5, 2.3, 6.8],
        thighL: [67.4, 68.4, 51.9], shinL: [149.7, -6.5, 10.6], footL: [15.1, 2.3, 2.3],
        thighR: [51.5, 3.4, -63.3], shinR: [152, 34.6, -6.6], footR: [14.3, 2.3, 0.8],
      },
    },
    hold: [
      { of: 'A.chest', above: 'B.chest', by: 0.16 },
  ...
  RNC: P('RNC', {
    ...
    A: {
      root: { p: [0.055, 0.302, -0.452], r: [-26, 8, 8] },
      j: {
        hips: [-8.2, -3.6, -17.9], spine: [32.3, -22.9, -2.9], chest: [-13.8, -9.6, 17.5], neck: [18, 0, 0], head: [-14.7, 10, 0],
        clavL: [12.2, -2.1, 32.2], armL: [-165.6, 38.4, -49.3], foreL: [-144.2, 2.3, 2.3],
        clavR: [5.4, -17.5, -32], armR: [-122.6, -27.2, 57.1], foreR: [-128.5, 2.3, -0.7],
    ...
    B: {
      ...
      j: {
        hips: [-32.9, 3.8, -49.4], spine: [16.3, -6.6, 19.6], chest: [5.4, 17.4, 5.4], neck: [-14.6, -9.6, -27.2], head: [-11.6, 26.7, 2.5],
        clavL: [-17.7, 25.7, 28.2], armL: [-148.3, 40.6, -42.4], foreL: [-118.7, -25.9, -0.7],
        clavR: [6.3, -8.7, 1.5], armR: [-129.5, -40.3, 40.5], foreR: [-117.2, -5.9, -1.5],
        thighL: [-49.6, 29.1, 10.3], shinL: [89.2, 20.4, -19.5], footL: [-12.9, 6.9, 37.6],
  ...
  ARMBAR: P('ARMBAR', {
    ...
    A: {
      ...
      j: {
        hips: [4.1, -1.5, -2.9], spine: [34.3, 14.7, 29.4], chest: [23.8, 0.1, 13.6], neck: [-3.9, 0.8, -0.7], head: [21.3, 0.8, 2.3],
        clavL: [-22.2, -12.4, 39.6], armL: [-118.3, 22.8, -36.9], foreL: [-70.2, -9.7, -2.9],
        clavR: [0.8, 18.8, -27.3], armR: [-113.8, -26.5, 33.3], foreR: [-110, -2.1, 3.2],
    ...
    B: {
      ...
      j: {
        ...
        clavL: [13.6, -1.3, 42.6], armL: [-97.5, 47.2, -14.1], foreL: [-35.5, 20.5, 4.7],
  ...
  TRIANGLE: P('TRIANGLE', {
    ...
    A: {
      ...
      j: {
        hips: [12.6, 13.5, -5.2], spine: [-1, 10.5, 5.3], chest: [1.8, 16.5, 24.9], neck: [20.6, 7.6, -6.6], head: [-19.4, -2.1, 0],
        clavL: [0, -3.8, 43.9], armL: [-164.9, 0.8, -55], foreL: [-49.5, -11.1, -26.2],
        clavR: [-7.7, 19.6, -23.2], armR: [-91.9, -36.2, 33.8], foreR: [-56.3, 10.7, 12.1],
        thighL: [-7.8, 69.8, -15.4], shinL: [81.1, 0, 6.8], footL: [14.8, 2.3, -3.6],
        thighR: [-16.7, 26, -0.9], shinR: [69.8, -2.9, -0.7], footR: [-1.4, -17.7, 0.8],
      },
    },
    B: {
  ...
  KIMURA: P('KIMURA', {
    ...
    A: {
      ...
      j: {
        hips: [-47.5, -29, -22.4], spine: [40.2, -14.7, 2.3], chest: [37.7, -18.3, -4.5], neck: [37.6, -5.9, 5.3], head: [-21.2, -6, 0],
        clavL: [0.2, 3.2, -44.7], armL: [-68.5, 32.8, -49.6], foreL: [-111.4, 1, 0.8],
        clavR: [-37.6, -4.1, -11.9], armR: [-77.7, -52.9, 33.4], foreR: [-117.6, -0.7, 0],
    ...
    B: {
      ...
      j: {
        hips: [17.6, 9.1, 6], spine: [-10.9, -1.5, 12], chest: [5.4, 3.1, 4.7], neck: [-34.6, -0.7, 0.1], head: [1.5, -27.5, 5.3],
        clavL: [5.2, 18.9, 41.2], armL: [-160, 71.9, -55.3], foreL: [-93.8, -10.3, -5.2],
  ...
  GUILLOTINE: P('GUILLOTINE', {
    ...
    points: 0, top: 'B', ground: true, submission: 'choke', from: 'CLOSED_GUARD', invert: true,
    A: {
      root: { p: [0.041, 0.315, -0.348], r: [50, 0, 0] },
      j: {
        hips: [-7.1, -8.9, -6], spine: [26.6, 0.8, -6], chest: [-0.2, -6.6, 3.8], neck: [-32.3, -8.1, -10.2], head: [-25.7, 4.1, -15.4],
        clavL: [-31.4, -14.7, -6.5], armL: [-120.5, 100.4, 43.9], foreL: [-69.6, 24.4, 49.6],
        clavR: [36.3, 18.2, 1.1], armR: [-43.5, -59.8, -26], foreR: [-25.4, 1.9, -22.9],
        thighL: [22.4, 17.2, 22.7], shinL: [98.1, 0, 0], footL: [19.3, 0.8, 0],
        thighR: [13.5, -9.5, -13.5], shinR: [102.6, 0, -0.7], footR: [19.3, 0, -2.9],
      },
    },
    B: {
      root: { p: [0, 0.299, 0.201], r: [-56, 180, 0] },
      j: {
        hips: [16.9, 28.6, 20.4], spine: [7.1, -22.2, -13.1], chest: [17.2, -14.2, -17.1], neck: [-15.1, -0.7, -0.7], head: [17.6, 0.8, 0.8],
        clavL: [20, 11.3, 30.9], armL: [-145.4, 63.5, -15.8], foreL: [-122.9, 13.7, 55.1],
        clavR: [-16.7, -0.5, -35.2], armR: [-144.6, 8.7, 54.2], foreR: [-77, -14, -17.8],
        thighL: [-141.9, -15.5, -8.6], shinL: [92.3, -15.6, 14.5], footL: [-8.5, 0, 0],
  ...
  ACROSS: P('ACROSS', {
    ...
    A: {
      root: { p: [0.183, 0.497, 0.173], r: [16, 62, 0] },
      j: {
        hips: [-30.7, 7.6, 17.1], spine: [36.2, -3, -5.1], chest: [15.7, -27.5, 7.4],
        neck: [34.8, 5.3, -5.2], head: [-24, 0, -0.7], clavL: [-18.3, -29.4, -24.3],
        armL: [-81.6, 41.6, -48.2], foreL: [-98.7, 8, 6], clavR: [25.7, -36.7, -12.6],
        armR: [-42.2, -28.6, 28.3], foreR: [-117.9, 1.7, -2.5], thighL: [-63.9, 13.3, 17.3],
    ...
    B: {
      ...
      j: {
        hips: [16, 4, 9.8], spine: [4, -10.4, 9], chest: [11.9, -16.6, 24.8],
        neck: [19.4, 61.8, 25.1], head: [31.7, 25.7, 0.8], clavL: [-15.1, 9.9, 20.8],
  ...
  MOUNT_ENTRY: P('MOUNT_ENTRY', {
    ...
    A: {
      ...
      j: {
        ...
        armL: [-77.6, 5, -35.5], foreL: [-95.2, 4.7, 2.6], clavR: [4, 10, 27.5],
    ...
    B: {
      ...
      j: {
        hips: [12.5, -2, -29.2], spine: [30, -5.9, 6.9], chest: [20.6, 27.1, 12.9],
        neck: [-20, 0, 0], head: [14, 0, -0.7], clavL: [-6.8, -41.2, 7.9],
        armL: [-151.3, 44.1, 11.6], foreL: [-122.1, 9.2, 7.6], clavR: [17.4, 23.3, -16.7],
        armR: [-186.6, 4.1, 24.6], foreR: [-92.9, 2.4, 0.1], thighL: [-17.1, -9.5, -11.5],
  ...
  SIDE_ENTRY: P('SIDE_ENTRY', {
    ...
    A: {
      ...
      j: {
        ...
        armL: [-89.4, 39.8, -53], foreL: [-125.6, 10.4, 2.3], clavR: [23.3, -31.7, -11.2],
  ...
  BACK_WORK: P('BACK_WORK', {
    ...
    variantOf: 'BACK',
    A: {
      root: { p: [0.016, 0.295, -0.355], r: [-22, 8, 6] },
      j: {
        hips: [-5.2, -6.7, -30.6], spine: [27, -17.2, -6.7], chest: [28, -5, -3],
        neck: [25.3, 1.5, 3.8], head: [-11.2, 11.8, -6], clavL: [-2.2, -3.6, 27.7],
        armL: [-127.6, 32.3, -50], foreL: [-115.3, -2.8, -9.7], clavR: [24.9, 9.4, -19.8],
        armR: [-87.1, -17.7, 5.5], foreR: [-116, -59.1, -55.2], thighL: [-94.2, 18.2, 21.4],
        shinL: [38.5, -17.8, 2.4], footL: [-18.4, -2.9, 3.1], thighR: [-91.1, -21, -27.2],
        shinR: [79.5, 1.5, -2.2], footR: [-13.2, 0, 0],
      },
    },
    B: {
      root: { p: [0.019, 0.318, 0.018], r: [-16, 4, 4] },
      j: {
        hips: [-26, -40.4, -11.2], spine: [20.9, -12.7, -7.5], chest: [18.3, -10.5, -46.4],
        neck: [17, -11.9, 0.1], head: [16, -2, 6], clavL: [-25.2, 0.3, 37.5],
        armL: [-151.4, 8.7, -37.9], foreL: [-59, 0.8, -13.3], clavR: [3.6, 12.2, -28.2],
        armR: [-91, -30, 36.7], foreR: [-81.6, 8.6, 15.2], thighL: [-73.1, -2.5, 11.8],
  ...
  RNC_WORK: P('RNC_WORK', {
    ...
    variantOf: 'RNC',
    A: {
      root: { p: [-0.017, 0.385, -0.428], r: [-26, 8, 8] },
      j: {
        hips: [-6, -5.2, -12], spine: [29.3, 2.3, 12.2], chest: [-8.6, -8.2, -3.4],
        neck: [25, 0, 0], head: [-21, 10, 0], clavL: [-4.5, -0.7, 12.8],
        armL: [-157.5, 39.8, -25.5], foreL: [-137.4, 1.5, 1.5], clavR: [3.9, -15.4, -33.5],
    ...
    B: {
      root: { p: [-0.026, 0.403, -0.057], r: [-10, 4, 4] },
      j: {
        hips: [-12.5, 17.3, -30.7], spine: [7, -4.3, 8.3], chest: [9.3, 22, -2.2],
        neck: [-24.3, -21.7, -29], head: [-13, 29.6, 1.6], clavL: [-17, 25.8, 21.4],
        armL: [-149.5, 41.5, -41.5], foreL: [-124.7, -18.8, -0.7], clavR: [7.1, -10.9, 2.3],
        armR: [-130.3, -41, 36], foreR: [-123.2, -5.1, -1.5], thighL: [-66.2, 2.8, -4],
  ...
  HALF_GUARD_WORK: P('HALF_GUARD_WORK', {
    ...
    A: {
      root: { p: [0.153, 0.505, -0.103], r: [0, 24, 0] },
      j: {
        hips: [8.7, 6.2, 18.8], spine: [12.8, -13.3, 20.5], chest: [-3.2, -18.4, 3.2],
        neck: [12.5, 0, 2.3], head: [-10, 0, 0], clavL: [-16.6, -6.4, 40.7],
        armL: [-122.6, 57.4, 2.9], foreL: [-89.1, 1.7, -5.7], clavR: [33.2, -22, -21.8],
        armR: [-37.4, -3.1, 3.8], foreR: [-64.8, 42.7, 24.8], thighL: [-11.1, 4.8, 31.4],
        shinL: [107, 0, 0], footL: [10, 0, 0.8], thighR: [-19.1, 79.9, -33.2],
        shinR: [112.7, 18.3, -17.9], footR: [-1.2, -26, 1],
      },
    },
    B: {
      root: { p: [-0.05, 0.291, 0.106], r: [-72, 156, -22] },
      j: {
        hips: [13.1, 8.4, 7.6], spine: [-1, 4.8, 30.3], chest: [26.5, 2.8, -3.7],
        neck: [-24.5, 0, 0.8], head: [14, 3, 6.8], clavL: [10.3, 25.9, -31.4],
        armL: [-85.6, 48.2, -16.7], foreL: [-103.9, 9.8, 10.1], clavR: [3, 9.5, -39.2],
        armR: [-24.1, 27.4, -5.1], foreR: [-29.9, 43, 20.6], thighL: [-81.2, 9.6, 18],
        shinL: [88, 0, 0], footL: [-14, 0, 0], thighR: [-76.1, -47.8, -30.7],
  ...
  SIDE_CONTROL_WORK: P('SIDE_CONTROL_WORK', {
    ...
    A: {
      root: { p: [0.309, 0.303, 0.3], r: [8, 100, 0] },
      j: {
        hips: [-54, -34.3, -20.8], spine: [18.6, 2.9, 10.8], chest: [39.6, -19.7, 16.3],
        neck: [26.8, 15.3, 43.9], head: [-37.5, -1.5, -6.7], clavL: [-22.2, -24.5, -24],
        armL: [-98, 49.5, -48], foreL: [-122.6, 13.6, 13.6], clavR: [38.4, -25.4, -8.1],
        armR: [-44.7, -4.4, 41], foreR: [-143.7, -6.5, -17.7], thighL: [-66.7, -12.9, -5.2],
    ...
    B: {
      ...
      j: {
        hips: [10, 4.5, 12], spine: [-2, -28.4, 0], chest: [7.3, -0.7, 15],
        neck: [19.6, 72.4, 4.5], head: [21.4, 26.8, 6.2], clavL: [-8.6, -8.9, -10],
        armL: [-113.9, 19.5, -38.4], foreL: [-119.7, 9.2, 5.4], clavR: [14.6, -36.5, 3.8],
        armR: [-69.2, -43.7, 2.6], foreR: [-63.6, 3.3, -4.2], thighL: [-40.7, 6.8, 12.8],
        shinL: [52, -1.5, 0], footL: [-16, 0, 0], thighR: [-14.4, -0.7, -14.5],
        shinR: [32.7, 0.8, -6.7], footR: [-8.4, 0.8, 0],
      },
    },
  }),
  ...
  CLOSED_GUARD_WORK: P('CLOSED_GUARD_WORK', {
    ...
    A: {
      root: { p: [-0.041, 0.525, -0.345], r: [0, 0, 0] },
      j: {
        hips: [24.8, -24.7, 35.5], spine: [30.6, 14.4, 13.7], chest: [11, -14.8, 22.1],
        neck: [0.3, 0, 0], head: [-1.9, 0, 0.8], clavL: [29.6, -7.3, -20.5],
        armL: [-26.1, 16.5, 32.5], foreL: [-56.8, -13.2, -36.8], clavR: [-17.5, 38.2, 8.8],
        armR: [-80, -27.1, 33], foreR: [-35.4, 8.6, 17.5], thighL: [17.1, 9.9, 14.9],
    ...
    B: {
      ...
      j: {
        hips: [6.3, 19.6, -1.4], spine: [14, 23.7, 20.6], chest: [8, 9.1, -18.3],
        neck: [-17.2, -0.7, 0], head: [10, 0.8, 0], clavL: [1.5, 2.4, -7.2],
        armL: [-99, 32.6, -30.4], foreL: [-76.9, 1.6, 1.6], clavR: [-34.2, 29.4, -17.8],
        armR: [-118.7, -34.7, 8.9], foreR: [-82.7, 21.4, 17.6], thighL: [-50.9, 18.4, 11.5],
        shinL: [147, -4.3, -8.4], footL: [-10, 0.8, 0], thighR: [-112.3, 20.2, 6.1],
        shinR: [150.2, -1.2, 11.7], footR: [-9.2, 0.8, 0.8],
      },
    },
  }),
  ...
  OPEN_GUARD_WORK: P('OPEN_GUARD_WORK', {
    ...
    A: {
      root: { p: [-0.064, 0.581, -0.531], r: [0, 0, 0] },
      j: {
        ...
        foreR: [-40, -8.2, -3.6], thighL: [-27.3, 26.3, 5.7], shinL: [95.2, 20.4, -14.9],
        footL: [20.9, -8.1, 1.7], thighR: [-8.7, -21.4, -17], shinR: [77.8, 1.5, -4.5],
        footR: [-20, 0, 0],
      },
    },
    B: {
      ...
      j: {
        hips: [32.8, -6, 0.8], spine: [6.8, -2.9, -17.9], chest: [6.8, 4.5, 5.4],
  ...
  KNEE_ON_BELLY_WORK: P('KNEE_ON_BELLY_WORK', {
    ...
    A: {
      root: { p: [0.092, 0.581, 0.069], r: [-6, 100, 0] },
      j: {
        hips: [-48.5, -32.2, 18.3], spine: [6.4, -15.3, 14.3], chest: [-27.7, -8.2, 31],
        neck: [-0.4, -35.2, 6.1], head: [-20.5, -13.5, 0], clavL: [-2.6, 17.6, 41.3],
        armL: [-54.8, 19, -28.2], foreL: [-59.5, 8.9, -2.7], clavR: [9.1, -12.4, 29],
        armR: [-25.6, -11.9, 26.7], foreR: [-68.9, 7.9, 25], thighL: [-128.9, -31.2, -1.2],
        shinL: [45.8, 0, 0.8], footL: [8, 0, 0], thighR: [-40.8, -19.9, -48.1],
        shinR: [24.2, 25.1, -15.5], footR: [-18.6, 1.6, 6.2],
      },
    },
    B: {
      root: { p: [-0.183, 0.251, 0.031], r: [-90, 180, 0] },
      j: {
        hips: [2.4, 65.5, 0.8], spine: [-19.9, -27.3, 15], chest: [12.1, 28.5, 36.9],
        neck: [-19.7, -0.7, 0.8], head: [19.3, -23.2, -0.7], clavL: [-2.1, 28, 31.3],
        armL: [-107.5, 33.5, -28.2], foreL: [-94.1, -5.2, -5.1], clavR: [-22.2, -9.4, -31.7],
        armR: [-61.2, -24.4, 19.6], foreR: [-89.9, 0, -0.7], thighL: [-43, 9.8, 16.6],
  ...
  TURTLE_WORK: P('TURTLE_WORK', {
    ...
    variantOf: 'TURTLE',
    A: {
      root: { p: [0.039, 0.554, -0.504], r: [10, 26, 0] },
      j: {
        hips: [9.1, 38, 20.6], spine: [43.5, 8.8, 2.3], chest: [42.9, -18.6, 9.9],
        neck: [29, 1.5, -9.6], head: [-10.3, -1.4, -2.1], clavL: [30, -21, 21.3],
        armL: [-33.3, 28.7, -41.7], foreL: [-67, 42.2, 33.1], clavR: [-3.3, 30.2, -27],
        armR: [-101.2, -12.2, 78.3], foreR: [-40.3, -21.2, -17.7], thighL: [-23.6, 1.2, 18.6],
        shinL: [97.6, 4.6, 3.1], footL: [12.6, 0.1, 3.8], thighR: [-49.9, -19.6, -2.4],
        shinR: [93.8, -7.4, 2.3], footR: [-6.1, -17.8, -4.3],
      },
    },
    B: {
      root: { p: [0.021, 0.266, 0.153], r: [64, 176, 0] },
      j: {
        hips: [7.6, -5.1, 28.7], spine: [-4, 9.8, 20.6], chest: [-29.6, 30.1, -12.2],
        neck: [-32.4, -0.7, 1.6], head: [31.3, -1.5, 5.3], clavL: [-10.2, 41.6, 11.2],
        armL: [-103.7, 34.4, -6.7], foreL: [-125.2, -0.7, 4.6], clavR: [35.3, -25, 7.4],
        armR: [-18.3, -2.3, 27.4], foreR: [-110.9, 5.4, 6.9], thighL: [76.2, 56.5, 41.5],
        shinL: [155.6, 1.8, 11.6], footL: [33.2, 0.1, 0.1], thighR: [37.8, 2.7, -76.1],
  ...
  ARMBAR_WORK: P('ARMBAR_WORK', {
    ...
    variantOf: 'ARMBAR',
    A: {
      root: { p: [-0.415, 0.216, 0.379], r: [-90, 90, 0] },
      j: {
        hips: [-2.9, -6, 8.4], spine: [18.3, 28.2, 26], chest: [28.3, 1.9, 19.3],
        neck: [-3.9, 0.8, -0.7], head: [23.5, -1.5, 0.1], clavL: [-14.9, -17.8, 34.4],
        armL: [-116.2, 15.3, -38.4], foreL: [-86.9, -6, -0.7], clavR: [2.9, 5.6, -26.5],
        armR: [-106.4, -15.1, 39.4], foreR: [-115.1, -4.2, 5.6], thighL: [-37.8, 2.3, 51.3],
        shinL: [-0.3, -1.3, 0.1], footL: [-12.7, 0.1, -1.5], thighR: [-6.3, 8.5, -24.4],
        shinR: [35, 3.2, -2.9], footR: [-3.3, 3.9, -2.9],
      },
    },
    B: {
      root: { p: [-0.025, 0.293, -0.063], r: [-90, 180, 0] },
      j: {
        hips: [0.8, 10.1, 3.9], spine: [25.3, 24.9, 2.4], chest: [6, 12.1, 9.2],
        neck: [-5.5, 4.6, -2.1], head: [4.1, 0.8, -2.2], clavL: [11.2, 9.2, 43.7],
        armL: [-85, 49.1, -10.4], foreL: [-49.5, -17.7, 16.4], clavR: [23.6, 19.7, -23.1],
        armR: [-61.8, -19.9, 26.6], foreR: [-74, 8.5, 4.7], thighL: [-14.6, 34.9, -0.1],
        shinL: [60.7, 12.8, -8.9], footL: [-11.2, 0.8, 0.8], thighR: [-5.4, -4.3, -5.6],
        shinR: [36.6, -0.7, -2.9], footR: [-17, -0.7, 0.8],
      },
    },
  }),
  ...
  TRIANGLE_WORK: P('TRIANGLE_WORK', {
    ...
    variantOf: 'TRIANGLE',
    A: {
      root: { p: [-0.074, 0.412, -0.304], r: [30, 0, 0] },
      j: {
        hips: [2, 18, -21.7], spine: [-1, 19.6, 18.8], chest: [6, 14.4, 19.6],
        neck: [11.8, 0.8, -14.2], head: [-11.5, -3.7, 0], clavL: [-1.9, -0.9, 42.8],
        armL: [-168.4, -2.1, -70.2], foreL: [-50.2, -1.3, -13.4], clavR: [-15.3, 30.9, -25.3],
        armR: [-78.1, -36.9, 28.6], foreR: [-48, 10.6, 12.2], thighL: [-19.8, 107.9, 33.4],
        shinL: [106.5, 0, 0], footL: [20, 0.8, 0.8], thighR: [-21.3, -29.4, -24.7],
        shinR: [94.6, -1.5, 0.8], footR: [18, 0.1, 4.6],
      },
    },
    B: {
      root: { p: [0.064, 0.289, 0.115], r: [-58, 190, 0] },
      j: {
        hips: [22.8, 16, -18.2], spine: [-3.9, -39.5, -27.4], chest: [-2.5, 13.6, 2.4],
        neck: [-14.5, 0, 0], head: [14, 2.3, 0], clavL: [16.7, -5, 34.1],
        armL: [-113.3, 34.1, -30.8], foreL: [-111.7, 10.7, 3.9], clavR: [8.3, 19.6, -21.1],
        armR: [-110.7, -24, 28], foreR: [-104, 6, 6], thighL: [-142.5, 16.9, -0.8],
        shinL: [131.5, -16.4, 5.3], footL: [-10, 0, 0], thighR: [-46.5, -1.1, -18.9],
  ...
  KIMURA_WORK: P('KIMURA_WORK', {
    ...
    variantOf: 'KIMURA',
    A: {
      root: { p: [0.371, 0.407, 0.249], r: [12, 116, 0] },
      j: {
        hips: [-45.4, -18.6, -23.2], spine: [43, -14.1, 2.4], chest: [45.4, -11.2, 5.5],
        neck: [44.3, -0.7, 0], head: [-28, 0, 0], clavL: [5.6, 6.9, -43.5],
        armL: [-84.5, 36.9, -48.4], foreL: [-129.1, 0.1, -3], clavR: [-34.4, 3.3, -4.5],
        armR: [-90, -55.1, 31.9], foreR: [-124.2, -9, -4.5], thighL: [-80.2, 8.8, 11.1],
        shinL: [109.9, 5.3, 0.1], footL: [7.3, -3.7, 2.3], thighR: [-18.5, 14.1, -22.7],
    ...
    B: {
      ...
      j: {
        ...
        neck: [-26.7, -0.7, 0.8], head: [-6.5, -26, 7.5], clavL: [2.9, 16.7, 41.2],
        armL: [-137.4, 61.5, -44.4], foreL: [-87.7, -14.1, -3.6], clavR: [-21.8, -33.6, -13.3],
  ...
  GUILLOTINE_WORK: P('GUILLOTINE_WORK', {
    ...
    A: {
      ...
      j: {
        hips: [14.6, -0.7, -6], spine: [10.9, -7.3, -6], chest: [-8.4, -3.5, -3],
        neck: [-47.9, -26.6, -23.7], head: [-26, 1.1, -12.7], clavL: [-30.2, -25.1, -2.9],
        armL: [-123.3, 90.6, 47.1], foreL: [-83.3, 20.7, 48.2], clavR: [33.5, 19.5, 30],
        armR: [-54.2, -70.3, -28.3], foreR: [-10.7, -3.4, -14.7], thighL: [13.8, 26.8, 28.6],
    ...
    B: {
      ...
      j: {
        hips: [12.6, 20.3, 23.3], spine: [6.5, -21.6, -6.6], chest: [-6.1, -11.9, -26.8],
        neck: [-28.6, 0.8, 0.8], head: [27.3, 1.5, -0.7], clavL: [25.7, -5.8, 15.9],
        armL: [-135.1, 84.6, -8.3], foreL: [-122.9, 13.1, 57], clavR: [-8.8, -22.1, -34.3],
        armR: [-155.4, -10.9, 37.9], foreR: [-84.3, -7.3, -6.6], thighL: [-142.2, -27.4, -2.5],
  ...
  BACK_WORK2: P('BACK_WORK2', {
    ...
    variantOf: 'BACK',
    A: {
      root: { p: [0.001, 0.402, -0.406], r: [-22, 8, 6] },
      j: {
        hips: [-1.4, 3, -12.8], spine: [30.8, 1.5, 19.5], chest: [7.8, 0, 24.8],
        neck: [26.4, 0.1, 0], head: [-20, 13.3, 0], clavL: [12.9, -8.9, -9.7],
        armL: [-156.5, 27.3, -54.4], foreL: [-103.3, -1.3, 0.8], clavR: [16.7, 28.7, -21.3],
        armR: [-101.4, -45.3, 3.3], foreR: [-104.2, -55.3, -40.3], thighL: [-78.4, 24.1, 21.3],
        shinL: [100.5, 18.8, -12.7], footL: [-18.5, -9, -19.3], thighR: [-70, -42.6, -69],
        shinR: [86.6, 24.2, -20.7], footR: [-13, 3.1, 0.1],
      },
    },
    B: {
      root: { p: [0.03, 0.286, 0.079], r: [-16, 4, 4] },
      j: {
        hips: [-18, -26.2, 15], spine: [-10.1, 23.2, -18.7], chest: [-2.8, -1.7, -43.2],
        neck: [28.4, -1.2, -5.2], head: [26, -19.2, 0], clavL: [-19.6, -5.6, 33.7],
        armL: [-126.9, 11, -37.1], foreL: [-53, -5.8, -12.5], clavR: [7.2, 27.4, -33.3],
        armR: [-84.6, -28.5, 32.1], foreR: [-70.3, -0.6, 6.9], thighL: [-59.4, 7.4, 23.1],
        shinL: [79.3, -13.4, 7.6], footL: [-9.9, -1.5, 0.1], thighR: [-88.6, 9.4, -1.7],
        shinR: [108.8, -2.7, 5.5], footR: [8.2, -8.7, -15.5],
      },
    },
  }),
  ...
  RNC_WORK2: P('RNC_WORK2', {
    ...
    A: {
      ...
      j: {
        hips: [-10.4, 5.3, 0], spine: [43.7, -20.9, -15.7], chest: [14.4, -13.5, 5.5],
        neck: [36.8, 3, -0.7], head: [-17.3, 10, -0.7], clavL: [2.2, 0.1, 23.1],
        armL: [-156.9, 47.9, -20.9], foreL: [-120.1, 6.1, 6], clavR: [0.3, -22.9, -25.1],
        armR: [-134.8, -28.6, 57], foreR: [-122.9, 0.8, 1.6], thighL: [-69.4, 26.5, 28.8],
        shinL: [63.2, 1.6, -10.4], footL: [-13.8, -5, 4.8], thighR: [-70.3, -12.5, -35.2],
        shinR: [67.9, 3.2, 14.4], footR: [-7.8, 17.5, -28.3],
      },
    },
    B: {
      root: { p: [-0.007, 0.293, -0.042], r: [-10, 4, 4] },
      j: {
        hips: [-22, -18.9, -21.6], spine: [30.3, 0.3, 13.7], chest: [9.1, 36.1, 1],
        neck: [-13.5, -15.1, -26.4], head: [-8.9, 33.3, 7.9], clavL: [-14.7, 29.5, 27.4],
        armL: [-136.1, 39.1, -41.4], foreL: [-101.9, -18.5, -1.4], clavR: [8.7, -5.6, 4],
        armR: [-118.7, -37.2, 38.5], foreR: [-105.9, -6.6, -0.7], thighL: [-85.2, 2.1, 5.9],
  ...
  HALF_GUARD_WORK2: P('HALF_GUARD_WORK2', {
    ...
    A: {
      ...
      j: {
        ...
        shinR: [102.7, 11.4, -6.5], footR: [0.8, -8.2, 6.8],
      },
    },
    B: {
      root: { p: [-0.089, 0.406, 0.105], r: [-72, 156, -22] },
      j: {
        hips: [24.6, 24.5, 11.1], spine: [25.3, 20.5, 43], chest: [5.5, -11.1, -37.7],
        neck: [-7.1, 0, -0.7], head: [8, 0, 5.3], clavL: [7.8, 16.8, -27.8],
        armL: [-99, 57.5, -14.5], foreL: [-101.8, -4.8, -4.3], clavR: [5.1, 7.8, -24.3],
        armR: [-12.6, 45.5, 17.3], foreR: [-32.3, 32.5, 16.8], thighL: [-97.9, 9.7, 20.4],
  ...
  SIDE_CONTROL_WORK2: P('SIDE_CONTROL_WORK2', {
    ...
    variantOf: 'SIDE_CONTROL',
    A: {
      root: { p: [0.337, 0.36, 0.283], r: [10, 128, 0] },
      j: {
        hips: [-52.2, -49.7, -42.7], spine: [16.7, -5.4, 20.1], chest: [49.6, 3.8, 8.6],
        neck: [27.2, -17.7, 9.5], head: [-25.5, 0, 6], clavL: [-2, -38.8, -22.4],
        armL: [-82.4, 42.8, -48.6], foreL: [-127, 0.3, -2], clavR: [26.4, -36.5, 1.2],
        armR: [-9, -43.2, 25.4], foreR: [-104, 5.6, -6.3], thighL: [-57.8, -18.7, -8.1],
        shinL: [118.8, -16.3, 12.8], footL: [22.8, 4.5, 3.8], thighR: [-31.8, -18.1, -18],
        shinR: [109.2, 9.1, 1.6], footR: [19.4, -0.7, 3.8],
      },
    },
    B: {
      root: { p: [-0.105, 0.245, -0.038], r: [-90, 180, 0] },
      j: {
        hips: [20, -15.7, 12], spine: [0, -13.2, 3.8], chest: [14.5, 2.6, 13.6],
        neck: [27.1, 60.6, -10.1], head: [-11.3, 39.6, -3.4], clavL: [-2, -14.1, 30.1],
        armL: [-111.7, 32.3, -30.6], foreL: [-67, 33.3, 24.2], clavR: [8, -32.2, 28.6],
        armR: [-59.2, -27.9, 20.6], foreR: [-71.9, 11.8, -39.7], thighL: [-41.2, 6.8, 6.8],
        shinL: [59.3, 0, 0], footL: [-16, 0, 0], thighR: [-32.7, 4.5, -4],
        shinR: [42.5, 12.2, -5.1], footR: [-10.5, 7.6, 0.2],
      },
    },
  }),
