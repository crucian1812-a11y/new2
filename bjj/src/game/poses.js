...
export const POSES = {
  ...
  BACK_WORK: P('BACK_WORK', {
    ...
    B: {
      ...
      j: {
        ...
        neck: [14.7, -11.2, 0.8], head: [16, -2, 6], clavL: [-23.7, 1.1, 37.4],
  ...
  HALF_GUARD_WORK: P('HALF_GUARD_WORK', {
    ...
    A: {
      root: { p: [0.202, 0.535, -0.115], r: [0, 24, 0] },
      j: {
        hips: [1.9, 13.6, 24], spine: [18, -26.8, 31.6], chest: [-7.1, -26, 8.4],
        neck: [12.5, 0, 2.3], head: [-10, 0, 0], clavL: [-16.7, -4.9, 39.9],
        armL: [-119.6, 57.4, 2.9], foreL: [-83.9, 1.7, -5.7], clavR: [33.9, -23.6, -20.4],
        armR: [-31.4, 0.6, 4.5], foreR: [-66.4, 45.6, 25.5], thighL: [-14.9, 10.8, 28.3],
        shinL: [107, 0, 0], footL: [10, 0, 0.8], thighR: [-14, 64.8, -36.2],
        shinR: [111.1, 14.5, -14.9], footR: [-1.2, -26, 1],
      },
    },
    B: {
      root: { p: [-0.054, 0.297, 0.113], r: [-72, 156, -22] },
      j: {
        hips: [13.8, 8.4, 7.6], spine: [-4.7, 6.3, 38.5], chest: [25.7, 3.5, 0.8],
        neck: [-24.5, 0, 0.8], head: [14, 3, 6.8], clavL: [14.8, 22.8, -25.4],
        armL: [-89.4, 46.7, -17.5], foreL: [-106.2, -1.5, -3.5], clavR: [3, 9.5, -40.7],
        armR: [-24.1, 28.1, -5.1], foreR: [-29.2, 43, 21.3], thighL: [-79, 8.8, 18],
  ...
  MOUNT_WORK: P('MOUNT_WORK', {
    ...
    B: {
      ...
      j: {
        ...
        neck: [-4.9, 0, 3.3], head: [21.6, -1.5, 4.8], clavL: [-3.3, -38.2, 16.8],
        armL: [-155.7, 66.7, 1.1], foreL: [-113.1, 9.2, 6.1], clavR: [10, 12.9, -26.4],
        armR: [-212.8, 13.3, 20.1], foreR: [-83, 19.6, 5.3], thighL: [-32.6, -12.4, -16.9],
        shinL: [32.6, 0.1, 2.5], footL: [-6.4, 6.2, -8.8], thighR: [-31.1, -8.2, -2.3],
        shinR: [33.9, -0.7, -6], footR: [-14, -6, -1.5],
      },
    },
  }),
  ...
  CLINCH_WORK: P('CLINCH_WORK', {
    ...
    A: {
      ...
      j: {
        ...
        neck: [-23.4, 6.3, 8.1], head: [3.6, -0.7, 0.8], clavL: [17.5, -17.7, 23.8],
    ...
    B: {
      ...
      j: {
        ...
        neck: [7.1, -2, -6.3], head: [-10.6, 0.8, 0.9], clavL: [30.7, -8.9, 27.3],
        armL: [-85.9, 37, 8.5], foreL: [-106.7, -28.1, -35], clavR: [8.9, -8, 10.4],
  ...
  CLOSED_GUARD_WORK: P('CLOSED_GUARD_WORK', {
    ...
    A: {
      ...
      j: {
        ...
        armL: [-26.1, 16.5, 32.5], foreL: [-56.8, -13.2, -36.1], clavR: [-17.5, 38.2, 8.8],
        armR: [-80, -26.4, 33], foreR: [-35.4, 8.6, 17.5], thighL: [17.1, 9.9, 14.9],
    ...
    B: {
      ...
      j: {
        hips: [6.3, 19.6, 0.8], spine: [14.7, 28.2, 18.3], chest: [8, 14.3, -23.6],
        neck: [-17.2, -0.7, 0], head: [10, 0.8, 0], clavL: [1.5, 1.6, -7.2],
        armL: [-99, 32.6, -30.4], foreL: [-76.9, 1.6, 1.6], clavR: [-34.2, 29.4, -17.8],
        armR: [-118.7, -34.7, 8.9], foreR: [-82.7, 21.4, 17.6], thighL: [-52.5, 18.4, 10.7],
  ...
  KNEE_ON_BELLY_WORK: P('KNEE_ON_BELLY_WORK', {
    ...
    A: {
      ...
      j: {
        ...
        armL: [-63.9, 22.6, -26], foreL: [-63.5, 8.1, -2.7], clavR: [0.8, -10.2, 20],
        armR: [-33.9, -14.2, 26.7], foreR: [-66.8, 11.4, 25], thighL: [-128.9, -31.2, -1.2],
  ...
  ARMBAR_WORK: P('ARMBAR_WORK', {
    ...
    A: {
      ...
      j: {
        ...
        armL: [-116.2, 15.3, -38.4], foreL: [-89.3, -6, -0.7], clavR: [-0.2, 4.7, -25.8],
        armR: [-110.2, -14.5, 40], foreR: [-115.9, -5, 4.8], thighL: [-41.6, 2.3, 45.9],
        shinL: [1.7, -1.3, -0.7], footL: [-12.7, 0.1, -1.5], thighR: [-19.1, 7.7, -24.4],
  ...
  BACK_WORK2: P('BACK_WORK2', {
    ...
    A: {
      ...
      j: {
        ...
        shinL: [103.5, 18.8, -12.7], footL: [-18.5, -9, -15.7], thighR: [-67.8, -30.6, -52.5],
  ...
  RNC_WORK2: P('RNC_WORK2', {
    ...
    A: {
      ...
      j: {
        ...
        neck: [36.8, 3, -0.7], head: [-17.3, 10, -0.7], clavL: [1.4, 1.6, 26.1],
    ...
    B: {
      ...
      j: {
        ...
        armL: [-136.1, 39.1, -42.2], foreL: [-101.9, -17.8, -1.4], clavR: [8.7, -4.9, 4],
        armR: [-118.7, -37.2, 38.5], foreR: [-105.9, -6.6, -0.7], thighL: [-82.2, 7.3, 9.6],
        shinL: [83, 12, -12], footL: [-10, 0.8, -2.2], thighR: [-78.4, 7.9, -9.4],
  ...
  HALF_GUARD_WORK2: P('HALF_GUARD_WORK2', {
    ...
    B: {
      ...
      j: {
        ...
        armR: [-13.4, 45.5, 14.3], foreR: [-32.3, 32.5, 16.8], thighL: [-93.5, 8.1, 18.1],
  ...
  SIDE_CONTROL_WORK2: P('SIDE_CONTROL_WORK2', {
    ...
    B: {
      ...
      j: {
        ...
        armR: [-74.4, -40.7, 7.8], foreR: [-81.1, 7.9, -30.2], thighL: [-41.2, 6.8, 6.8],
