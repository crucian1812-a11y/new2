...
export const POSES = {
  ...
  CLINCH: P('CLINCH', {
    ...
    points: 0, top: null, ground: false,
    A: {
      root: { p: [0.032, 0.979, -0.222], r: [0, 6, 0] },
      j: {
        hips: [-12.2, -9.7, 1.6], spine: [31.3, -6, 9.8], chest: [18.3, 14.3, -2.8], neck: [-13, -1.2, -1.5], head: [-2.5, 0.8, 0],
        clavL: [29.6, -4.1, 27.7], armL: [-36.5, -85, 149.2], foreL: [-103, 0, 0],
    ...
    B: {
      ...
      j: {
        hips: [-25.6, -8.8, -2.9], spine: [31.3, -0.6, 6.1], chest: [10.1, 10.6, 7.9], neck: [9.1, -1.2, -9.2], head: [-4.6, 0, 0.1],
        clavL: [17.2, -13.3, 24.9], armL: [-104.1, 33.9, 9.3], foreL: [-121.5, -32, -42.8],
  ...
  CLOSED_GUARD: P('CLOSED_GUARD', {
    ...
    A: {
      ...
      j: {
        hips: [16, -23.1, 23.4], spine: [42.3, 23.4, 13.6], chest: [12.9, -20.1, 6.3], neck: [7.9, -0.7, -2.2], head: [-11.7, -0.7, 1.5],
        clavL: [29.6, -3.5, -24.1], armL: [-39.9, -46, 105.4], foreL: [-102.4, 0, 0],
        clavR: [-7.6, 36.8, 6.4], armR: [24, 21.2, -71.2], foreR: [-75.3, -6, -3.8],
        thighL: [22.4, 11.3, 14], shinL: [93.5, 0, 0], footL: [24, 0, 0],
        thighR: [26.2, -17.1, -25.2], shinR: [91.3, 0.8, 1.6], footR: [27.1, 1.6, 0.9],
      },
    },
    B: {
      root: { p: [-0.015, 0.242, -0.055], r: [-90, 180, 0] },
      j: {
        hips: [8.1, 22.6, 8.5], spine: [20.7, 21.9, 30.2], chest: [7.1, 3.9, -32.7], neck: [-20.1, 1.6, -0.7], head: [16, -2.2, -0.7],
        clavL: [3.1, 3.1, -1.2], armL: [16.6, -45.3, 38.8], foreL: [-79.7, 0, 0],
        clavR: [-30.3, 25.6, -19.2], armR: [23.4, -2.2, 17.3], foreR: [-73.6, 0.8, -0.8],
        thighL: [-31.1, 6.5, 15.3], shinL: [151.1, 3.1, -15.9], footL: [-10, 1.5, 0.8],
        thighR: [-117.5, 13.5, 5.3], shinR: [153.5, -6.5, 16.2], footR: [-10, -0.7, 0],
      },
    },
    hold: [
  ...
  OPEN_GUARD: P('OPEN_GUARD', {
    ...
    points: 0, top: 'A', ground: true, guardOf: 'B',
    A: {
      root: { p: [-0.14, 0.63, -0.403], r: [0, 0, 0] },
      j: {
        hips: [17.8, -0.7, -18.6], spine: [9.9, -27.7, -0.7], chest: [14.1, 2.3, 1.5], neck: [6.5, 0, 0],
        clavL: [7.6, -5.9, 26], armL: [26.3, 7.3, 62.6], foreL: [-94.5, 0, 0],
        clavR: [-14.1, 37.7, -21.1], armR: [25.6, 52.2, -81.3], foreR: [-73.3, 3, 0],
        thighL: [-12.7, 6.6, 12.4], shinL: [100.3, -2.2, 2.3], footL: [19.8, 0, 0.8],
        thighR: [-31.4, -7.1, -13.2], shinR: [71.5, 6.8, -6], footR: [-20, -1.4, -0.7],
      },
    },
    B: {
      root: { p: [0.023, 0.269, 0.07], r: [-78, 180, 0] },
      j: {
        hips: [12.9, -6.7, 15.9], spine: [13.7, -8.8, -22.2], chest: [-0.2, 7.6, 2.4], neck: [-24.2, -0.6, 0], head: [18.1, -0.7, 0.1],
        clavL: [-14.8, -24.6, 8.4], armL: [50.7, -59, 68.7], foreL: [-50.2, 0, 0],
        clavR: [-16.3, 11.4, -9], armR: [18.8, 68.2, -58.8], foreR: [-39.4, 0, 0],
        thighL: [-104.6, 19.1, 15], shinL: [28, -4.2, 14.4], footL: [-20.1, -0.7, -0.7],
        thighR: [-118, -5.3, -9.6], shinR: [28, 14.5, -7.4], footR: [-18.4, 0, 0.8],
      },
    },
    hold: [
  ...
  HALF_GUARD: P('HALF_GUARD', {
    ...
    points: 0, top: 'A', ground: true, guardOf: 'B',
    A: {
      root: { p: [0.214, 0.54, -0.101], r: [0, 24, 0] },
      j: {
        hips: [16.9, -19.4, 30.8], spine: [11.3, -9.6, 15.8], chest: [-7.7, -20.9, 20.4], neck: [11, 0, -0.7], head: [-7, 0, 0],
        clavL: [-18.5, 9, 23], armL: [-40.2, -94.6, 40.9], foreL: [-72.5, 0, 0],
        clavR: [37, -11.8, 3.3], armR: [-33.8, 4.3, -12.7], foreR: [-65.5, 40.7, 30.4],
        thighL: [-29.8, 16.8, 20.1], shinL: [104.8, 0, 0], footL: [10, 3, 0],
        thighR: [12.9, 32.3, -1.6], shinR: [97.8, 5.5, 4.7], footR: [12.8, -2.9, 0],
      },
    },
    B: {
      root: { p: [-0.1, 0.256, 0.019], r: [-72, 156, -22] },
      j: {
        hips: [2.6, -14.1, -16.4], spine: [12.7, 25.7, 39.2], chest: [16.7, 3.9, -2.2], neck: [-14.7, 7.5, 0.8], head: [13.3, 0.8, 6.1],
        clavL: [15.4, 15.2, -23.6], armL: [-29.3, -31.4, 3.7], foreL: [-101.6, 0, 0],
        clavR: [11.7, 10.9, -39.7], armR: [40, -0.9, -144.7], foreR: [-131, 0, 0],
        thighL: [-82.8, 15.6, 22.6], shinL: [91, 0, 0.8], footL: [-14, 0, 0.8],
        thighR: [-62.7, -36.6, -21.6], shinR: [77.3, -3.6, 11.3], footR: [-14, 0.8, 0],
      },
    },
    hold: [
  ...
  SIDE_CONTROL: P('SIDE_CONTROL', {
    ...
    A: {
      root: { p: [0.293, 0.349, 0.336], r: [8, 100, 0] },
      j: {
        hips: [-71.7, -29.7, -31.5], spine: [18.5, -8, 8.9], chest: [28, 6.8, 23.5], neck: [7.4, 28.9, 35.6], head: [6.1, 15.9, 6.9],
        clavL: [-12.3, -26.8, -27.8], armL: [8.4, -17.6, -29.9], foreL: [-72.7, 0, 0],
        clavR: [34.1, -26.8, 7], armR: [131.2, 31.4, -5.8], foreR: [-145.7, 0, 0],
        thighL: [-35.7, -9.1, -13.3], shinL: [112.2, -17.8, 25.7], footL: [8.5, -9.7, -3.7],
        thighR: [-25.7, -5.2, -25.6], shinR: [82, 15.1, -13.5], footR: [17, 12.8, 0.8],
      },
    },
    B: {
      root: { p: [-0.169, 0.232, -0.03], r: [-90, 180, 0] },
      j: {
        hips: [10.8, 4.6, 6], spine: [6.5, -17.9, 3.8], chest: [19.5, -3.7, 14.3], neck: [-5.6, 56.6, 2.4], head: [3.5, 23.8, 11],
        clavL: [-18.5, -14.9, 36], armL: [15.1, -70, 107.4], foreL: [-73.1, 0, 0],
        clavR: [-15.1, -15.4, 38.5], armR: [-22.9, 25.2, -130.2], foreR: [-80.1, 0, 0],
        thighL: [-27.1, 8.4, 10.6], shinL: [40.8, -6, -0.7], footL: [-15.2, 0.1, 2.3],
        thighR: [-19.6, 4, -10.6], shinR: [35.6, 9.9, 0.9], footR: [-9.8, 4.7, 3.3],
      },
    },
    hold: [
      { of: 'A.chest', above: 'B.chest', by: 0.16 },
  ...
  KNEE_ON_BELLY: P('KNEE_ON_BELLY', {
    ...
    A: {
      root: { p: [0.105, 0.58, 0.09], r: [-6, 100, 0] },
      j: {
        hips: [-47.4, -35.2, 10.5], spine: [7.3, 1.7, 17.4], chest: [-38.6, -23.9, 30.8], neck: [3.8, -38.9, 10.6], head: [-16.7, -14.2, 0],
        clavL: [-10, 30.1, 29.9], armL: [-47.2, 19.4, -26.9], foreL: [-68.1, 0.8, -2.1],
        clavR: [-2.6, -33.6, 15.4], armR: [-36.5, -73.1, -53.8], foreR: [-72.1, -1.5, 0],
        thighL: [-134.4, -13.2, -18.4], shinL: [59.6, 6, 0], footL: [8, -0.7, 0],
        thighR: [-32.9, -25.2, -49.9], shinR: [11.2, 22, -23], footR: [-19.8, -4.8, 9.4],
      },
    },
    B: {
      root: { p: [-0.192, 0.235, 0.005], r: [-90, 180, 0] },
      j: {
        hips: [9.3, 71.3, -3.7], spine: [-19.8, -21.5, 14.3], chest: [17.3, 6.9, 30.1], neck: [-14.5, -0.7, -0.7], head: [12, -24.7, -0.7],
        clavL: [-4, 23.5, 36.8], armL: [-118.3, 46.2, -29.5], foreL: [-81.5, -5.2, -2.2],
        clavR: [-15.2, -1.9, -33.3], armR: [174.5, 31.7, 2.4], foreR: [-69.7, 0, 0],
        thighL: [-39.8, 8.3, 12.1], shinL: [52.1, 6, -3], footL: [-16, 0, 0.8],
  ...
  MOUNT: P('MOUNT', {
    ...
    A: {
      root: { p: [0.042, 0.476, 0.078], r: [0, 0, 0] },
      j: {
        hips: [42.3, 12.1, -10.5], spine: [-9.6, 16.2, -34.2], chest: [37.1, -34.9, -4.7], neck: [22.6, 2.3, 0.1], head: [-10.6, 5.4, 1.6],
        clavL: [28.2, -7, -31.8], armL: [-28.3, -68, 62.4], foreL: [-82, 0, 0],
        clavR: [23, 5.8, 39.2], armR: [31, -48.8, 106.6], foreR: [-92, 0, 0],
        thighL: [-45, -0.4, 80.1], shinL: [55.3, 39.1, -12], footL: [17.3, 1.5, 0],
        thighR: [-11.9, -42.7, 0.7], shinR: [75.5, -21.7, -0.7], footR: [17.3, 0, 0.8],
      },
    },
    B: {
      root: { p: [0.073, 0.258, 0.248], r: [-90, 180, 0] },
      j: {
        hips: [17.1, -27.4, -12.7], spine: [10, -9.5, -22.3], chest: [23, 12.1, 18.3], neck: [-2, 2.3, -3], head: [11.8, 1.6, 3.1],
        clavL: [-5.2, -38.1, 13.4], armL: [71.7, -62.2, 44.9], foreL: [-130.3, 1.5, -0.7],
        clavR: [-0.4, 10.2, -17.3], armR: [-172.7, 20.2, 30.9], foreR: [-73, -12.5, -5.1],
        thighL: [-28.2, -19.8, -16.7], shinL: [23.8, 9, 3], footL: [-5.6, 3.1, -5.1],
        thighR: [-27.5, -16.3, -4.6], shinR: [34.9, -1.5, 4.7], footR: [-13.9, 0.8, 2.3],
      },
    },
    hold: [
  ...
  BACK: P('BACK', {
    ...
    points: 4, top: 'A', ground: true,
    A: {
      root: { p: [-0.022, 0.292, -0.477], r: [-22, 8, 6] },
      j: {
        hips: [-14.1, 8.3, -19.3], spine: [22, -14.1, -9.7], chest: [13.3, -10.5, 31.7], neck: [25.1, 0.8, 3.8], head: [-11.2, 8.8, 0.8],
        clavL: [1.6, -0.6, 21], armL: [-15.3, 31, -79.3], foreL: [-79.9, -3, -0.7],
        clavR: [4.7, 28.8, -4.1], armR: [-19.4, 63.8, -86.8], foreR: [-82.4, 0, 0],
        thighL: [-92.3, 23.3, 17.7], shinL: [83.6, 9.9, -9.6], footL: [-16.1, 0, 0.1],
        thighR: [-68.3, -15.5, -39], shinR: [70.2, 0, 0.8], footR: [-10.9, 5.4, -2.8],
      },
    },
    B: {
      root: { p: [0.023, 0.292, -0.09], r: [-16, 4, 4] },
      j: {
        hips: [-38, -33.5, 1.5], spine: [21.1, -17, -5.2], chest: [-7.1, -1.3, -46.4], neck: [5.4, -20.9, -8.8], head: [19.5, -8.2, 3.8],
        clavL: [-20.7, 1.1, 26.9], armL: [33.9, -75.2, -173.8], foreL: [-109, -1.5, 0],
        clavR: [7.7, 15.8, -39.7], armR: [62.5, 55.6, 144.2], foreR: [-154.1, 0, 0],
  ...
  TURTLE: P('TURTLE', {
    ...
    A: {
      root: { p: [-0.028, 0.536, -0.463], r: [10, 14, 0] },
      j: {
        hips: [-12.7, 6.8, 38.4], spine: [36.6, 25.7, 17.3], chest: [27.1, -7.6, -19.9], neck: [21.4, -4.5, 5.3], head: [-14.1, 0, 2.3],
        clavL: [30, -26.1, 15.7], armL: [37.6, 0.8, -122.1], foreL: [-69.2, 0, 0],
        clavR: [-13.3, 27, -37], armR: [40.7, -84.9, -114.8], foreR: [-96.3, 0, 0],
        thighL: [-40, 4, 14], shinL: [104, 0, 0], footL: [8, 0, 0],
        thighR: [-5.6, -3.6, -3], shinR: [91.8, -0.7, 2.3], footR: [21.6, 5.3, 6.1],
      },
    },
    B: {
      root: { p: [-0.153, 0.334, 0.177], r: [64, 176, 0] },
      j: {
        hips: [-17.9, 22.6, 8.5], spine: [-4.5, 11.7, 17], chest: [-32.8, 29.5, -9], neck: [-12.4, 12, 21.8], head: [25.5, 3.8, 3],
        clavL: [5.5, 15.3, -41.3], armL: [4.8, 103.3, 129.5], foreL: [-71.8, 0, 0],
        clavR: [28.3, -35, 0.9], armR: [112.4, 50.3, 2.4], foreR: [-73.2, 0, 0],
        thighL: [77.2, 72.9, 53.4], shinL: [156.5, -7.2, 9.9], footL: [15.9, 2.3, 2.3],
        thighR: [58.3, 4.2, -69.3], shinR: [153.5, 33.9, -2.1], footR: [14.3, 2.3, 0.8],
      },
    },
    hold: [
      { of: 'A.chest', above: 'B.chest', by: 0.16 },
  ...
  RNC: P('RNC', {
    ...
    A: {
      root: { p: [0.063, 0.306, -0.452], r: [-26, 8, 8] },
      j: {
        hips: [-8.2, -3.6, -17.9], spine: [32.3, -17.6, -2.9], chest: [-16.8, -8.1, 16], neck: [18, 0, 0], head: [-14.7, 10, 0],
        clavL: [8.5, -0.6, 34.5], armL: [38.6, 47.2, -81.5], foreL: [-103.5, 0, 0],
        clavR: [5.4, -17.5, -32], armR: [46, 73.2, 163.8], foreR: [-91.5, 0, 0],
        thighL: [-84.4, 14.5, 27.8], shinL: [60.2, -1.3, 5.5], footL: [-13.9, -3, 3],
        thighR: [-83.6, -20.7, -33.6], shinR: [74.5, 7.7, -3.6], footR: [-14, 4, -8.9],
      },
    },
    B: {
      root: { p: [-0.075, 0.277, -0.052], r: [-10, 4, 4] },
      j: {
        hips: [-32.9, 2.3, -49.4], spine: [16.3, -6.6, 19.6], chest: [5.4, 18.2, 5.4], neck: [-16.1, -11.8, -26.4], head: [-11.6, 26.7, 2.5],
        clavL: [-16.2, 25, 29], armL: [-133.5, 37.4, -43.4], foreL: [-142, -0.7, 0],
        clavR: [6.3, -4.9, 1.5], armR: [-172.9, -53.6, 23.2], foreR: [-126.5, 0, 0],
        thighL: [-43.6, 17.1, 10.3], shinL: [93, 23.4, -19.5], footL: [-12.9, 9.9, 39.1],
  ...
  ARMBAR: P('ARMBAR', {
    ...
    A: {
      ...
      j: {
        hips: [4.1, -5.2, 3.1], spine: [34.3, 23.7, 29.4], chest: [23.1, -0.6, 13.6], neck: [-3.9, 0.8, -0.7], head: [21.3, 0.8, 2.3],
    ...
    B: {
      ...
      j: {
        hips: [6.9, 25.1, 0], spine: [13.9, 4.7, 0], chest: [6.1, 5.4, 14.4], neck: [-10.2, 3, 1.5], head: [13, 0, 3],
  ...
  TRIANGLE: P('TRIANGLE', {
    ...
    A: {
      root: { p: [0.106, 0.53, -0.32], r: [30, 0, 0] },
      j: {
        hips: [0.6, 7.5, 0.8], spine: [5, 4.5, 5.3], chest: [5.6, 22.5, 39.9], neck: [20.6, 7.6, -11.8], head: [-19.4, -3.6, -6],
        clavL: [0.8, -9.8, 43.9], armL: [-146.9, 6.1, -43], foreL: [-60.7, -5.1, -20.2],
        clavR: [-3.9, 26.4, -20.2], armR: [-9.6, -34.2, 21.9], foreR: [-72.5, 0, 0],
        thighL: [-7.8, 69.8, -10.1], shinL: [80.4, -3.7, 12.8], footL: [11.8, 3.1, -4.3],
        thighR: [-15.2, 24.5, 11.1], shinR: [69.8, -4.4, -1.4], footR: [-5.1, -23.7, 0.1],
      },
    },
    B: {
      root: { p: [-0.003, 0.292, 0.123], r: [-64, 180, 0] },
      j: {
        hips: [26.1, 5.3, -10.5], spine: [-1.7, -30.7, -29.9], chest: [-16.5, 14.4, 7.8], neck: [-31.5, 0, 0.8], head: [20, 0.8, 0.8],
        clavL: [18.1, -10.2, 37.9], armL: [-104.5, 33.2, -28.6], foreL: [-98.8, 22.1, 13.8],
        clavR: [-2.2, 16.6, -16.6], armR: [-95.7, -23.2, 34.8], foreR: [-84, 0, 3],
        thighL: [-144, 9.5, 5.4], shinL: [128.4, -16.4, 15.9], footL: [-10, 0.8, -0.7],
        thighR: [-52.3, -15.5, -16.6], shinR: [152.1, -10.4, 14.6], footR: [-10, 0, -1.5],
      },
    },
    hold: [
  ...
  KIMURA: P('KIMURA', {
    ...
    A: {
      root: { p: [0.34, 0.385, 0.241], r: [12, 116, 0] },
      j: {
        hips: [-47.5, -29, -22.4], spine: [40.2, -8.7, 2.3], chest: [42.2, -12.3, -11.2], neck: [39.1, -5.9, 5.3], head: [-21.2, -6, 0],
        clavL: [-0.5, 1.7, -44.7], armL: [58.4, 103.3, 12.5], foreL: [-83.1, -0.8, 0],
        clavR: [-39.1, 0.4, -11.9], armR: [62.2, 110.6, 67], foreR: [-107.7, 0, 0.7],
        thighL: [-76.9, -1, 5], shinL: [101.3, -0.7, 0.8], footL: [9.7, -0.7, 7.9],
    ...
    B: {
      ...
      j: {
        hips: [17.6, 9.1, 6], spine: [-10.9, 4.5, 12], chest: [3.9, 3.1, -1.3], neck: [-34.6, -0.7, 0.1], head: [1.5, -27.5, 5.3],
        clavL: [9.7, 18.9, 41.2], armL: [-158.5, 71.9, -59.8], foreL: [-86.3, -10.3, -5.2],
        clavR: [-15.2, -34.3, -20.5], armR: [-55.6, -27.8, 28.5], foreR: [-72, 1.6, 0.8],
  ...
  GUILLOTINE: P('GUILLOTINE', {
    ...
    points: 0, top: 'B', ground: true, submission: 'choke', from: 'CLOSED_GUARD', invert: true,
    A: {
      root: { p: [0.071, 0.349, -0.344], r: [50, 0, 0] },
      j: {
        hips: [-7.8, -14.9, -4.5], spine: [33.4, 2.3, -6], chest: [-0.2, -5.1, 6.8], neck: [-25.5, -11.1, -13.9], head: [-25.7, 4.1, -15.4],
        clavL: [-32.1, -20.7, -3.5], armL: [1.4, -55.6, 102.1], foreL: [-80.7, 0, 0],
        clavR: [34.8, 28, -2.7], armR: [-56.2, 74.5, -151.4], foreR: [-89.8, 0, 0],
        thighL: [22.4, 14.2, 22.7], shinL: [98.1, 0, 0], footL: [19.3, 0.8, 0],
        thighR: [6, -9.5, -12.7], shinR: [102.6, 0, -0.7], footR: [19.3, 0, -2.9],
      },
    },
    B: {
      root: { p: [-0.03, 0.303, 0.261], r: [-56, 180, 0] },
      j: {
        hips: [7.9, 28.6, 21.9], spine: [21.4, -22.9, -7.8], chest: [24.7, -8.9, -18.6], neck: [-15.1, -0.7, -0.7], head: [17.6, 0.8, 0.8],
        clavL: [20.8, 13.6, 29.4], armL: [58.3, -13.5, -141.4], foreL: [-79.9, 0.8, 0],
        clavR: [-15.2, 2.5, -37.4], armR: [76.7, 21.2, 115.1], foreR: [-74.9, 1.5, 0],
        thighL: [-141.9, -10.2, -8.6], shinL: [92.3, -15.6, 14.5], footL: [-8.5, 0, 0],
        thighR: [-131.1, -9.5, 16.8], shinR: [87.7, 16.5, -21.7], footR: [-10, 0, 0],
      },
    },
    hold: [
  ...
  ACROSS: P('ACROSS', {
    ...
    A: {
      root: { p: [0.198, 0.497, 0.173], r: [16, 62, 0] },
      j: {
        hips: [-30.7, 6.1, 17.9], spine: [36.2, -3, -5.1], chest: [15.7, -27.5, 7.4],
        neck: [35.6, 5.3, -5.2], head: [-24, 0, -0.7], clavL: [-18.3, -29.4, -24.3],
        armL: [-8.5, 8.9, -10], foreL: [-71.8, 0, 0], clavR: [25.7, -35.9, -12.6],
        armR: [23.8, 78.6, -53.1], foreR: [-73.9, 0, 0], thighL: [-63.9, 13.3, 17.3],
        shinL: [96.8, -4.4, 5.3], footL: [11.1, 0.8, -0.7], thighR: [9.7, -49, 17.2],
        shinR: [88, 15.1, -5.8], footR: [-16.1, -18.5, -0.4],
      },
    },
    B: {
      root: { p: [-0.13, 0.244, 0.085], r: [-90, 180, 0] },
      j: {
        hips: [16, 1.8, 9.8], spine: [4.8, -9.6, 8.3], chest: [11.9, -14.3, 25.6],
        neck: [17.9, 61.8, 25.1], head: [31.7, 25.7, 0.8], clavL: [-15.1, 9.9, 20.8],
        armL: [-130.1, 25.8, -40.2], foreL: [-112.3, 7.5, 2.5], clavR: [7.3, -20.2, 20.6],
  ...
  MOUNT_ENTRY: P('MOUNT_ENTRY', {
    ...
    points: 0, top: 'A', ground: true, waypoint: true,
    A: {
      root: { p: [0.07, 0.513, 0.05], r: [6, 46, 0] },
      j: {
        hips: [17.6, 16.3, 3], spine: [39.8, -16.9, -8], chest: [40.8, -16.2, -3.9],
        neck: [15.6, 0, 0], head: [-14, 0, 0], clavL: [1.3, -24.4, -37.9],
        armL: [50.8, 26.7, -109.5], foreL: [-89.4, 0, 0], clavR: [4, 10, 27.5],
    ...
    B: {
      ...
      j: {
        hips: [12.5, -2, -29.2], spine: [30, -5.9, 6.9], chest: [21.4, 27.1, 12.9],
  ...
  SIDE_ENTRY: P('SIDE_ENTRY', {
    ...
    points: 0, top: 'A', ground: true, waypoint: true,
    A: {
      root: { p: [0.281, 0.391, 0.287], r: [10, 104, 0] },
      j: {
        hips: [-50.2, -60.4, 6], spine: [43.9, -12.2, -8.4], chest: [41.2, -16.3, 1.5],
        neck: [30.5, 4.3, -2.2], head: [-19.2, -0.7, 2.3], clavL: [-16.1, -33.7, -20.6],
        armL: [19.1, 59, -49], foreL: [-72.3, 0, 0], clavR: [23.3, -31.7, -11.2],
        armR: [13.5, -49.6, 37.3], foreR: [-86.6, 0, 0], thighL: [-44.2, -1.7, 41.6],
    ...
    B: {
      ...
      j: {
        hips: [15.3, 0.1, 6], spine: [-2, 0.2, 6], chest: [13.3, -17.8, 16.6],
        neck: [1.6, 46.8, 7.5], head: [17.6, 31.3, -14.7], clavL: [-23.7, -2.8, 17],
  ...
  GUARD_ENTRY: P('GUARD_ENTRY', {
    ...
    A: {
      ...
      j: {
        ...
        handR: [-1.8, 0, 0.8], thighL: [-104.8, 18.4, 20.2], shinL: [31.1, -5.6, 4.2],
        footL: [-22.2, -1.2, 0.1], thighR: [-98.5, 15.9, -25.7], shinR: [29.6, 5.7, 1.8],
        footR: [-21.5, 1.4, 0.8],
      },
    },
    B: {
      ...
      j: {
        ...
        thighL: [-13.6, 6.3, -0.5], shinL: [82.7, 0.8, -5.2], footL: [16.5, 1.9, -2.4],
  ...
  GUARD_RECOVER: P('GUARD_RECOVER', {
    ...
    A: {
      ...
      j: {
        hips: [4.9, 16.3, 27.8], spine: [12.2, 23, 23.8], chest: [9.9, 6.3, -26.6],
        neck: [-14.9, 0.8, 0.8], head: [13, -0.5, -0.5], clavL: [7.3, -2.4, -1],
        armL: [-88.3, -4.1, 0], foreL: [-60.7, 1.1, 1], clavR: [-28.1, 18.8, -7.2],
        armR: [-104.4, -31.6, 16], foreR: [-82.3, 19.8, 17.5], thighL: [-46.9, 12.4, 26.4],
        shinL: [140.7, -3.1, -9.3], footL: [-5.1, 2.5, 1.5], thighR: [-117.4, 23.4, -8.1],
        shinR: [151.5, -9.7, 17.6], footR: [-6.7, -0.6, 0],
      },
    },
    B: {
  ...
  BACK_WORK: P('BACK_WORK', {
    ...
    variantOf: 'BACK',
    A: {
      root: { p: [0.016, 0.295, -0.325], r: [-22, 8, 6] },
      j: {
        hips: [-11.2, -0.7, -18.6], spine: [21, -9.7, 5.3], chest: [15.3, -8, 16.5],
        neck: [25.3, 1.5, 3.8], head: [-11.2, 11.8, -6], clavL: [3.1, 2.4, 29.2],
        armL: [-16.4, 17.1, -70.1], foreL: [-99.2, 2.3, 0], clavR: [25.7, 10.2, -21.3],
        armR: [-45.4, 79.6, -88], foreR: [-95.5, 0, 0], thighL: [-94.9, 19.7, 22.9],
        shinL: [38.5, -17.8, 2.4], footL: [-18.4, -2.9, 3.1], thighR: [-91.8, -21, -27.2],
        shinR: [79.5, 1.5, -2.2], footR: [-13.2, 0, 0],
      },
    },
    B: {
      root: { p: [0.019, 0.303, 0.018], r: [-16, 4, 4] },
      j: {
        hips: [-32, -40.4, -11.2], spine: [20.9, -19.4, -7.5], chest: [-2.7, -22.5, -38.9],
        neck: [17, -11.9, 0.1], head: [16, -2, 6], clavL: [-25.2, 0.3, 37.5],
        armL: [-26, -69.3, -43.4], foreL: [-115.4, 0, 0], clavR: [5.9, 10, -32.7],
        armR: [45.3, 16.8, 50], foreR: [-143.9, 0, 0], thighL: [-73.1, -2.5, 11.8],
        shinL: [85.3, -7.5, 14.3], footL: [-9.2, 0.8, 3], thighR: [-71.6, -3.3, -1.8],
        shinR: [69.7, -3.7, 3.1], footR: [-6.2, 9.2, -6.5],
      },
    },
  }),
  ...
  RNC_WORK: P('RNC_WORK', {
    ...
    variantOf: 'RNC',
    A: {
      root: { p: [-0.032, 0.385, -0.424], r: [-26, 8, 8] },
      j: {
        hips: [-5.2, -11.2, -12], spine: [29.3, 2.3, 12.2], chest: [-14.6, -11.2, -9.4],
        neck: [25, 0, 0], head: [-21, 10, 0], clavL: [1.5, -6.7, 18.8],
        armL: [43.1, -19.9, 127.3], foreL: [-100.3, -5.2, -0.7], clavR: [3.9, -13.1, -35.7],
        armR: [-122.6, -27.9, 56.4], foreR: [-136, 3.1, -0.7], thighL: [-80.5, 23.6, 28.6],
        shinL: [68.5, -22.2, 24.9], footL: [-18.4, -2.1, 0.1], thighR: [-78.4, -20.8, -33],
        shinR: [69.2, 27.1, -21.7], footR: [-16.2, -0.7, -2.9],
      },
    },
    B: {
      root: { p: [-0.026, 0.418, -0.057], r: [-10, 4, 4] },
      j: {
        hips: [-12.5, 17.3, -30.7], spine: [7, -10.3, 8.3], chest: [18.3, 22, -2.2],
        neck: [-18.3, -18.7, -29], head: [-10, 25.9, 1.6], clavL: [-17, 25.8, 21.4],
        armL: [-149.5, 41.5, -41.5], foreL: [-124.7, -18.8, -0.7], clavR: [1.8, -16.9, 2.3],
        armR: [-133.3, -45.5, 29.3], foreR: [-123.2, -4.3, -1.5], thighL: [-66.2, 2.8, -4],
        shinL: [106.4, 10.5, -12], footL: [-4.6, 7.7, 6.9], thighR: [-53.5, -2, -20],
  ...
  HALF_GUARD_WORK: P('HALF_GUARD_WORK', {
    ...
    A: {
      root: { p: [0.138, 0.505, -0.137], r: [0, 24, 0] },
      j: {
        hips: [8.7, 4, 20.3], spine: [12.1, -6.5, 19.8], chest: [-9.2, -24.4, 3.2],
        neck: [12.5, 0, 2.3], head: [-10, 0, 0], clavL: [-18.1, -14.6, 40.7],
        armL: [-17.6, -108.9, 74.6], foreL: [-76.2, 0, 0], clavR: [33.2, -27.2, -21.8],
        armR: [-7.4, -39.4, 108.2], foreR: [-119.8, 6, -0.7], thighL: [-11.1, 4.8, 31.4],
        shinL: [107, 0, 0], footL: [10, 0, 0.8], thighR: [-40.1, 61.9, -33.2],
        shinR: [126.2, 8.6, -0.6], footR: [-1.2, -26, 1],
      },
    },
    B: {
      root: { p: [-0.046, 0.291, 0.11], r: [-72, 156, -22] },
      j: {
        hips: [15.4, 6.9, 1.6], spine: [5.8, 4.8, 30.3], chest: [25.8, 1.3, -3.7],
        neck: [-24.5, 0, 0.8], head: [14, 3, 6.8], clavL: [10.3, 27.4, -32.1],
        armL: [-16.2, -12.4, -52.4], foreL: [-101.5, 0, 0], clavR: [1.5, -1.7, -39.9],
        armR: [6.6, -43.1, 46.4], foreR: [-122.5, 0, 0], thighL: [-82.7, 15.6, 21],
        shinL: [88, 0, 0], footL: [-14, 0, 0], thighR: [-73.8, -35.8, -18.7],
        shinR: [82.7, -10.3, 4.6], footR: [-14, 0, 0.8],
      },
    },
  }),
  ...
  MOUNT_WORK: P('MOUNT_WORK', {
    ...
    variantOf: 'MOUNT',
    A: {
      root: { p: [0.083, 0.486, 0.071], r: [0, 0, 0] },
      j: {
        hips: [36.9, 1.5, -24], spine: [-35.9, 29.1, -27.1], chest: [47.8, -5.6, -4.7],
        neck: [19.1, 5.7, -28.1], head: [-6.2, 0, -15.6], clavL: [10, -17.6, -17],
        armL: [-31.8, -71.1, 54.4], foreL: [-77, 0, 0], clavR: [24.5, -7.4, 30.7],
        armR: [-54.8, -5.3, 4.3], foreR: [-96.9, 0, 0], thighL: [-37.5, 9.3, 73.9],
        shinL: [75.5, 34.5, -27], footL: [25.9, 0.8, 1.6], thighR: [-12.6, -35.8, -11.2],
        shinR: [73.1, -20.9, 23.3], footR: [18, 0, 0],
      },
    },
    B: {
      root: { p: [0.068, 0.247, 0.242], r: [-90, 180, 0] },
      j: {
        hips: [21.1, -19.1, 6], spine: [4.3, 3.1, -21.6], chest: [20.6, 5.5, 23.3],
        neck: [2.6, 0, 6.6], head: [26.4, -1.5, 8], clavL: [-0.3, -39.7, 17.6],
        armL: [7.9, 34.8, -2.9], foreL: [-72.4, 0, 0], clavR: [10, 12.2, -25.6],
        armR: [-3.5, 25, -28.1], foreR: [-119.7, 0, 0], thighL: [-26.6, -19.1, -16.9],
        shinL: [28.9, -11.9, 8.5], footL: [-5.6, 6.2, -8.8], thighR: [-23.4, -9.7, 3.7],
        shinR: [19.2, -0.7, -4.5], footR: [-14, -6, -1.5],
      },
    },
  }),
  ...
  SIDE_CONTROL_WORK: P('SIDE_CONTROL_WORK', {
    ...
    A: {
      root: { p: [0.317, 0.296, 0.308], r: [8, 100, 0] },
      j: {
        hips: [-54, -34.3, -20.8], spine: [15.6, 2.9, 10.8], chest: [32.1, -19.7, 17.8],
        neck: [17.8, 21.3, 39.4], head: [-37.5, -1.5, -6.7], clavL: [-22.2, -24.5, -24],
        armL: [49.7, 51.5, -48.9], foreL: [-72.7, 0, 0], clavR: [35.4, -29.1, -9.6],
        armR: [49.1, -7.4, -16.3], foreR: [-138.6, 0, 0], thighL: [-66.7, -12.9, -5.2],
        shinL: [124.3, -21.7, 18.8], footL: [10.9, 0, -4.5], thighR: [-31.3, 5.3, -35.3],
        shinR: [89.4, 15.9, -11.1], footR: [9, -2.8, 11.5],
      },
    },
    B: {
      root: { p: [-0.09, 0.25, -0.086], r: [-90, 180, 0] },
      j: {
        hips: [10, 9, 12], spine: [-2, -32.9, -1.5], chest: [8.8, -0.7, 15],
        neck: [19.6, 72.4, 4.5], head: [21.4, 26.8, 6.2], clavL: [-11.6, -10.4, -11.5],
        armL: [34.7, 14.3, -139.4], foreL: [-71.2, -0.7, 0], clavR: [14.6, -36.5, 3.8],
        armR: [-51.3, 35.8, -66.8], foreR: [-98.8, 0, 0], thighL: [-40.7, 6.8, 12.8],
        shinL: [52, -1.5, 0], footL: [-16, 0, 0], thighR: [-15.1, -0.7, -14.5],
        shinR: [32, 0.8, -6.7], footR: [-7.6, 0.8, 0],
      },
    },
  }),
  ...
  CLINCH_WORK: P('CLINCH_WORK', {
    ...
    variantOf: 'CLINCH',
    A: {
      root: { p: [0.034, 0.902, -0.249], r: [0, 6, 0] },
      j: {
        hips: [-11.5, -14.5, 4.7], spine: [19.5, -0.9, -10.3], chest: [13.8, 6, 11.5],
        neck: [-19.6, 9.4, 12.8], head: [3.6, -0.7, 0.8], clavL: [15.4, -18.4, 26.8],
        armL: [-96.4, 43.7, 15.4], foreL: [-128.3, 15.3, 22.8], clavR: [22.2, 28.2, 28.8],
        armR: [-95.2, -34.5, 26.2], foreR: [-88, -0.7, 8.1], thighL: [-22.5, 12, 6.1],
        shinL: [42.1, -0.7, 2.4], footL: [-20.9, -7.2, 0.8], thighR: [16.3, -10.2, -19.4],
        shinR: [28.6, 4.6, 0], footR: [-36.2, 15, 2.3],
      },
    },
    B: {
      root: { p: [-0.141, 0.893, 0.281], r: [0, 186, 0] },
      j: {
        hips: [-4, -14.7, 6.8], spine: [15.9, -2.1, 2.3], chest: [9.6, 3.8, 5.5],
        neck: [10.9, -2, -3.9], head: [-10.6, 0.8, 0.9], clavL: [29.3, -10.4, 28.1],
        armL: [-86.6, 40.8, 11.6], foreL: [-106.7, -28.1, -35], clavR: [8.9, -8, 10.4],
  ...
  CLOSED_GUARD_WORK: P('CLOSED_GUARD_WORK', {
    ...
    A: {
      root: { p: [-0.041, 0.525, -0.352], r: [0, 0, 0] },
      j: {
        hips: [24.8, -14.2, 29.5], spine: [30.6, 25.7, 13.7], chest: [5, -14, 14.6],
        neck: [-0.4, 0, 0], head: [-1.9, 0, 0.8], clavL: [30.4, -4.3, -23.5],
        armL: [-47.7, -38, 74.2], foreL: [-92.6, 0, 0], clavR: [-11.5, 38.2, 14.8],
        armR: [-33.2, -14.5, -25.4], foreR: [-78, -3.8, 0], thighL: [20.9, 9.2, 18.7],
        shinL: [90.5, 1.5, 1.6], footL: [24.8, 0.8, 0.8], thighR: [34.4, -17.1, -25.8],
        shinR: [90.6, 0.8, 1.6], footR: [24.8, 1.5, 0.8],
      },
    },
    B: {
      root: { p: [-0.034, 0.24, -0.05], r: [-84, 168, 0] },
      j: {
        hips: [6.3, 23.4, -2.1], spine: [22.3, 16.2, 32.6], chest: [8.8, 3.9, -16],
        neck: [-16.4, -0.7, 0.8], head: [10, 0.8, 0.8], clavL: [1.5, 2.4, -7.9],
        armL: [-5.9, 26, -16.2], foreL: [-70.7, 0, 0], clavR: [-33.4, 27.9, -19.3],
        armR: [17.2, -14.8, 9.5], foreR: [-73.7, 0, 0], thighL: [-52.4, 17.7, 25],
        shinL: [143.3, -6.5, -8.4], footL: [-10.7, 4.6, 4.5], thighR: [-119, -0.1, 1.6],
        shinR: [155.5, 9.3, 5.7], footR: [5.1, 6.8, 2.3],
      },
    },
  }),
  ...
  OPEN_GUARD_WORK: P('OPEN_GUARD_WORK', {
    ...
    A: {
      root: { p: [-0.124, 0.581, -0.531], r: [0, 0, 0] },
      j: {
        hips: [3.6, 5.4, -20.2], spine: [29.6, -8.2, -0.7], chest: [22, 1.5, 3.8],
        neck: [19.3, 0, 1.5], clavL: [6.8, -4.5, 18.4], armL: [22.5, 74.9, -107.3],
        foreL: [-121.9, 0, 0.8], clavR: [-9.7, 36.8, -20.5], armR: [14.7, -3.5, -47.5],
        foreR: [-108.2, 3.8, 0.7], thighL: [-26.5, 26.3, 5], shinL: [94.5, 20.4, -14.9],
        footL: [20.2, -7.3, 1.7], thighR: [-8.7, -21.4, -17], shinR: [77.8, 1.5, -4.5],
        footR: [-20, 0, 0],
      },
    },
    B: {
      ...
      j: {
        hips: [32.8, -6, 0.8], spine: [12.8, -8.9, -17.9], chest: [12.8, 4.5, 11.4],
        neck: [-18.5, 0, 1.5], head: [13.5, 0, 0], clavL: [-1.4, -19.3, 3.1],
        armL: [40.3, -44, 86.7], foreL: [-55.7, 0, 0], clavR: [-4.3, 21, 2.3],
        armR: [2.2, -97.7, 59.1], foreR: [-41.2, 0.7, 0], thighL: [-95.7, 18.1, 14.3],
        shinL: [15.1, -8.9, 0.1], footL: [-24, 0, 0], thighR: [-107.5, -8.4, -10.4],
        shinR: [16, 8.4, 2.3], footR: [-20, 0, -3],
      },
    },
  }),
  ...
  KNEE_ON_BELLY_WORK: P('KNEE_ON_BELLY_WORK', {
    ...
    A: {
      root: { p: [0.092, 0.581, 0.118], r: [-6, 100, 0] },
      j: {
        hips: [-48.5, -32.2, 18.3], spine: [6.4, -15.3, 14.3], chest: [-27.7, -8.9, 31],
        neck: [0.3, -41.9, 6.9], head: [-20.5, -13.5, 0], clavL: [-1.8, 16.9, 41.3],
        armL: [-15.2, -67, -120.9], foreL: [-68, -0.7, 0], clavR: [3.1, -12.4, 34.3],
        armR: [-37.3, -73, -72.3], foreR: [-71.1, 3.7, 0.8], thighL: [-128.9, -31.2, -1.2],
        shinL: [45.8, 0, 0.8], footL: [8, 0, 0], thighR: [-40.8, -19.9, -60.1],
        shinR: [22.7, 24.4, -14.7], footR: [-18.6, 1.6, 6.2],
      },
    },
    B: {
      root: { p: [-0.183, 0.244, 0.024], r: [-90, 180, 0] },
      j: {
        hips: [2.4, 77.5, 4.6], spine: [-22.9, -36.3, 11.3], chest: [14.4, 30.8, 32.4],
        neck: [-19.7, -0.7, 0.8], head: [19.3, -23.2, -0.7], clavL: [-2.1, 28, 32.1],
        armL: [172.1, -56.7, -28.7], foreL: [-68.4, 0, 0], clavR: [-19.2, -8.6, -34.7],
        armR: [-172.9, 24.8, -10.6], foreR: [-72, 0, 0], thighL: [-54.2, 0.1, 12.9],
        shinL: [68, 3.1, -2.1], footL: [-17.4, -1.3, -8.9], thighR: [-20, -6.7, -10],
  ...
  TURTLE_WORK: P('TURTLE_WORK', {
    ...
    variantOf: 'TURTLE',
    A: {
      root: { p: [0.047, 0.554, -0.508], r: [10, 26, 0] },
      j: {
        hips: [9.1, 38, 20.6], spine: [42.8, 8.8, 8.3], chest: [43.7, -19.3, 9.9],
        neck: [35.1, 0, -15.6], head: [-7.3, -6.6, -7.3], clavL: [28.5, -21.7, 22.1],
        armL: [-124.7, -48.8, 17.7], foreL: [-71.7, 0, 0], clavR: [-7, 40, -18],
        armR: [12.7, -58.3, -92.6], foreR: [-92.1, 0, 0], thighL: [-21.3, 2, 17.9],
        shinL: [97.6, 4.6, 3.1], footL: [12.6, 0.1, 3.8], thighR: [-49.9, -16.6, -2.4],
        shinR: [90.8, -4.4, 2.3], footR: [-6.1, -17.8, -4.3],
      },
    },
    B: {
      root: { p: [0.021, 0.296, 0.161], r: [64, 176, 0] },
      j: {
        hips: [13.6, 1.7, 28.7], spine: [-4, 8.3, 20.6], chest: [-29.6, 30.9, -12.2],
        neck: [-36.9, -0.7, 3.1], head: [29.1, -2.2, 6.1], clavL: [-6.4, 42.4, 11.2],
        armL: [-9.7, 87, 47.9], foreL: [-72.9, 0, 0], clavR: [35.3, -25, 7.4],
        armR: [-35.8, -95.5, -12.6], foreR: [-72.3, 0, 0], thighL: [76.2, 54.3, 49],
        shinL: [155.6, 4.9, 10.2], footL: [33.2, 0.1, 0.1], thighR: [38.6, 2.7, -76.1],
        shinR: [154.7, 44.5, 2.3], footR: [12, 0, 0],
      },
    },
  }),
  ...
  ARMBAR_WORK: P('ARMBAR_WORK', {
    ...
    variantOf: 'ARMBAR',
    A: {
      root: { p: [-0.419, 0.193, 0.402], r: [-90, 90, 0] },
      j: {
        hips: [-3.6, -6, 8.5], spine: [18.3, 30.5, 24.5], chest: [29.1, 3.4, 17.8],
        neck: [-3.9, 0.8, -0.7], head: [23.5, -1.5, 0.1], clavL: [-14.9, -17.8, 34.4],
        armL: [30.9, -1.5, -151.4], foreL: [-78.9, 0, 0], clavR: [3.7, 6.4, -26.5],
        armR: [-106.4, -15.1, 39.4], foreR: [-115.1, -4.2, 5.6], thighL: [-37.7, -0.7, 53.6],
        shinL: [-0.3, -1.3, 0.1], footL: [-12.7, 0.1, -1.5], thighR: [-5.5, 8.5, -24.4],
        shinR: [35.8, 3.2, -2.9], footR: [-3.3, 3.9, -2.9],
      },
    },
    B: {
      root: { p: [-0.025, 0.297, -0.07], r: [-90, 180, 0] },
      j: {
        hips: [1.6, 10.2, 3.2], spine: [24.6, 24.9, 2.4], chest: [6.8, 12.1, 10],
        neck: [-5.5, 4.6, -2.1], head: [4.1, 0.8, -2.2], clavL: [11.2, 8.5, 43.7],
        armL: [-85, 50.6, -10.4], foreL: [-49.5, -17.7, 16.4], clavR: [23.6, 19.7, -23.1],
        armR: [-61.8, -19.9, 26.6], foreR: [-74, 8.5, 4.7], thighL: [-15.3, 34.9, -0.1],
        shinL: [60.7, 12.8, -8.9], footL: [-11.2, 0.8, 0.8], thighR: [-5.4, -4.3, -6.3],
        shinR: [35.9, -0.6, -2.9], footR: [-17, -0.7, 0.8],
      },
    },
  }),
  ...
  TRIANGLE_WORK: P('TRIANGLE_WORK', {
    ...
    variantOf: 'TRIANGLE',
    A: {
      root: { p: [-0.104, 0.367, -0.326], r: [30, 0, 0] },
      j: {
        hips: [-17.5, 31.5, -9.7], spine: [9.5, 13.6, 18.8], chest: [18, 14.4, 19.6],
        neck: [11.8, 0.8, -14.2], head: [-11.5, -3.7, 0], clavL: [-4.9, -15.9, 42.8],
        armL: [-147.4, 15.2, -49.2], foreL: [-70.4, -5.8, -19.4], clavR: [-21.3, 37.7, -10.3],
        armR: [-12.2, -45.7, 39.2], foreR: [-85.5, 0, 0], thighL: [-38.5, 95.9, 23.7],
        shinL: [85.5, -4.5, 6], footL: [14.8, -3.7, -5.2], thighR: [-36.3, -41.4, -39.7],
        shinR: [89.4, -13.5, 12.8], footR: [14.3, -1.4, 6.1],
      },
    },
    B: {
      root: { p: [0.064, 0.289, 0.115], r: [-58, 190, 0] },
      j: {
        hips: [18.3, 17.5, -15.2], spine: [-4.6, -33.5, -27.4], chest: [-4, 13.6, 2.4],
        neck: [-14.5, 0, 0], head: [14, 2.3, 0], clavL: [15.2, -0.5, 34.1],
        armL: [-36.9, 13.8, 6.7], foreL: [-79.5, 0, 0], clavR: [8.3, 19.6, -21.1],
        armR: [-110.7, -24, 28], foreR: [-104, 6, 6], thighL: [-142.5, 18.4, -0.8],
        shinL: [136, -22.4, 14.3], footL: [-10, 0, 0], thighR: [-46.5, -1.1, -18.9],
  ...
  KIMURA_WORK: P('KIMURA_WORK', {
    ...
    variantOf: 'KIMURA',
    A: {
      root: { p: [0.375, 0.4, 0.249], r: [12, 116, 0] },
      j: {
        hips: [-40.1, -14.8, -22.4], spine: [44.5, -8.8, -2.1], chest: [46.2, -7.4, 0.3],
        neck: [44.3, -0.7, 0], head: [-28, 0, 0], clavL: [7.9, 6.2, -43.5],
        armL: [4.1, -65.8, -8.6], foreL: [-82.8, 0.8, 0], clavR: [-33.6, 3.3, -5.2],
        armR: [80.5, 88.2, 36.9], foreR: [-125, 0, 0], thighL: [-81.7, 7.3, 9.6],
        shinL: [108.4, 4.6, 1.6], footL: [6.6, -4.4, 3.1], thighR: [-18.5, 14.1, -22.7],
        shinR: [106.3, 6.8, -6.7], footR: [19.6, 0, 0.8],
      },
    },
    B: {
      root: { p: [-0.101, 0.308, -0.007], r: [-90, 180, 8] },
      j: {
        hips: [5, 0, 6], spine: [-3.4, 6.2, 6.8], chest: [5.4, 2.9, 6],
        neck: [-26.7, -0.7, 0.8], head: [-6.5, -26, 7.5], clavL: [4.4, 16.7, 41.2],
        armL: [-137.4, 61.5, -44.4], foreL: [-80.2, -14.1, -3.6], clavR: [-21.8, -34.3, -13.3],
        armR: [69.9, 46.5, 60.1], foreR: [-72.3, 0, 0], thighL: [-42, 6, 12],
  ...
  GUILLOTINE_WORK: P('GUILLOTINE_WORK', {
    ...
    A: {
      root: { p: [0.041, 0.329, -0.409], r: [50, 0, 0] },
      j: {
        hips: [14.6, -2.2, -6], spine: [10.9, -11.8, -6], chest: [-11.4, -3.5, 2.3],
        neck: [-52.4, -19.1, -22.9], head: [-26, 1.1, -12.7], clavL: [-28.7, -34.1, -2.2],
        armL: [23.2, -66.1, 111.9], foreL: [-72.3, 0, 0], clavR: [30.5, 22.5, 31.5],
        armR: [-125.5, -60.8, 1.8], foreR: [-92.2, 0, 0], thighL: [13.8, 26.8, 28.6],
        shinL: [117.8, 9, 0], footL: [20, 0, 0], thighR: [14.8, -8.7, -10.4],
        shinR: [98.8, 0.8, -0.7], footR: [20, -2.2, -0.7],
      },
    },
    B: {
      root: { p: [-0.056, 0.292, 0.18], r: [-48, 180, 0] },
      j: {
        hips: [4.4, 14.3, 26.3], spine: [10.3, -23.8, -8.8], chest: [-9.1, -11.9, -35.8],
        neck: [-28.6, 0.8, 0.8], head: [27.3, 1.5, -0.7], clavL: [22, -17, 13.7],
        armL: [4.8, -101.4, 68], foreL: [-73.8, -0.7, 0.7], clavR: [-8.8, -27.3, -32.8],
        armR: [90.1, 20.4, 122.2], foreR: [-79, -1.5, 0], thighL: [-142.2, -24.4, 3.5],
        shinL: [97.4, -14.2, 16], footL: [-7.7, 2.3, 1.5], thighR: [-129.8, -5.9, 23.7],
        shinR: [84.7, 17.3, -5.2], footR: [-4, 6, 6],
      },
    },
  }),
  ...
  BACK_WORK2: P('BACK_WORK2', {
    ...
    variantOf: 'BACK',
    A: {
      root: { p: [0.02, 0.402, -0.398], r: [-22, 8, 6] },
      j: {
        hips: [-0.6, -3, 12.7], spine: [35.4, 1.5, 13.5], chest: [4.1, -3.7, 21.8],
        neck: [26.4, 0.1, 0], head: [-20, 13.3, 0], clavL: [24.2, -21.6, 6.9],
        armL: [31.9, -1.8, -147.4], foreL: [-94.1, 2.2, 1.5], clavR: [10.7, 30.2, -28.8],
        armR: [3.5, 48, -98.3], foreR: [-102.3, 0, 0], thighL: [-76.9, 28.6, 23.6],
        shinL: [90, 6.8, -0.7], footL: [-20.7, -13.5, -11.8], thighR: [-75.9, -41.1, -67.5],
        shinR: [90.4, 13.8, -13.9], footR: [-12.2, 4.6, 2.4],
      },
    },
    B: {
      root: { p: [0.06, 0.283, 0.079], r: [-16, 4, 4] },
      j: {
        hips: [-21.7, -40.4, 12.8], spine: [-4.8, 28.5, -11.2], chest: [-2.8, -3.9, -34.9],
        neck: [28.4, -3.4, -5.2], head: [26, -28.9, 0], clavL: [-18, -7.1, 33.7],
        armL: [-22.9, -24, -81.6], foreL: [-95.7, 0, 0], clavR: [0.5, 21.5, -34],
        armR: [-81.7, 19.9, -60.2], foreR: [-70.4, 0, 0], thighL: [-59.4, 7.4, 23.1],
        shinL: [79.3, -13.4, 7.6], footL: [-9.9, -1.5, 0.1], thighR: [-88.6, 9.4, -1.7],
        shinR: [110.4, -2.7, 5.5], footR: [9.8, -8.7, -16.9],
      },
    },
  }),
  ...
  RNC_WORK2: P('RNC_WORK2', {
    ...
    variantOf: 'RNC',
    A: {
      root: { p: [-0.093, 0.385, -0.354], r: [-26, 8, 8] },
      j: {
        hips: [-10.4, 5.3, 0], spine: [43.7, -22.4, -15.7], chest: [14.4, -12, 7],
        neck: [36.8, 3, -0.7], head: [-17.3, 10, -0.7], clavL: [3.7, 2.3, 30.6],
        armL: [20.7, 45.7, -122.9], foreL: [-115.3, 7.5, -1.5], clavR: [3.3, -24.4, -26.6],
        armR: [165.3, -85.7, 1.6], foreR: [-87.8, 0, 0], thighL: [-69.4, 26.5, 28.8],
        shinL: [63.2, 1.6, -10.4], footL: [-13.8, -5, 5.6], thighR: [-70.3, -11.7, -35.2],
        shinR: [67.9, 4, 14.4], footR: [-8.5, 21.3, -32],
      },
    },
    B: {
      root: { p: [-0.007, 0.293, -0.042], r: [-10, 4, 4] },
      j: {
        hips: [-22, -18.9, -21.6], spine: [30.3, 0.3, 15.2], chest: [9.1, 34.6, 7],
        neck: [-9, -22.6, -21.1], head: [-8.9, 30.4, 7.9], clavL: [-14.7, 29.5, 27.4],
        armL: [-159.8, 37.6, -43.7], foreL: [-143.1, 0, 0], clavR: [4.9, -4.8, 2.5],
        armR: [-120.2, -38.7, 35.5], foreR: [-105.9, -6.6, -0.7], thighL: [-85.2, 2.1, 5.9],
        shinL: [77.1, 5.3, -8.2], footL: [-10, -5.1, 5.3], thighR: [-79.1, 8, -8.6],
        shinR: [78.6, 8.3, -11.1], footR: [-10, 0, 0],
      },
    },
  }),
  ...
  HALF_GUARD_WORK2: P('HALF_GUARD_WORK2', {
    ...
    variantOf: 'HALF_GUARD',
    A: {
      root: { p: [0.143, 0.547, -0.118], r: [0, 24, 0] },
      j: {
        hips: [7.5, -25.5, -6], spine: [12.1, -17.9, 13.8], chest: [-10.8, -13.3, 23.9],
        neck: [13.6, 0, -0.7], head: [-17.4, 0, 0.8], clavL: [-20.8, 12, 35],
        armL: [-43.8, -56.9, -24.7], foreL: [-72.3, 0, 0], clavR: [32, -5.6, -3.4],
        armR: [-37.7, -11.4, 13.5], foreR: [-104.9, 0, 0], thighL: [-36, 15.5, 39],
        shinL: [123.3, -10.5, 9.1], footL: [10, 0, 0], thighR: [-8.6, 44.2, -11.9],
        shinR: [103.5, 11.4, -6.5], footR: [0.8, -8.2, 6.8],
      },
    },
    B: {
      root: { p: [-0.089, 0.406, 0.105], r: [-72, 156, -22] },
      j: {
        hips: [24.6, 25.3, 11.9], spine: [24.6, 20.5, 43], chest: [5.5, -11.1, -37.7],
        neck: [-7.1, 0, -0.7], head: [8, 0, 5.3], clavL: [7.8, 16.8, -27.8],
        armL: [-19.1, -71.8, 48.8], foreL: [-104.4, 0, 0], clavR: [5.1, 7.8, -24.3],
        armR: [15.2, -23, -18], foreR: [-144.1, 0, 0], thighL: [-97.9, 9.7, 20.4],
        shinL: [95.1, 1.5, 0], footL: [-14, 0, 0], thighR: [-51, -37, -36.4],
        shinR: [69.6, 1.1, -7.3], footR: [-16.8, -4.4, -5.2],
      },
    },
  }),
  ...
  SIDE_CONTROL_WORK2: P('SIDE_CONTROL_WORK2', {
    ...
    variantOf: 'SIDE_CONTROL',
    A: {
      root: { p: [0.352, 0.323, 0.294], r: [10, 128, 0] },
      j: {
        hips: [-52.2, -49.7, -42.7], spine: [13.8, -5.4, 20.1], chest: [46.7, 3.8, 8.6],
        neck: [16.8, -17.6, 17.1], head: [-25.5, 0, 6], clavL: [-2, -38.8, -22.4],
        armL: [19.7, 28.9, -47.4], foreL: [-77.7, 0, 0], clavR: [22.7, -36.5, 8.7],
        armR: [28.5, -68.6, -1.6], foreR: [-119.1, 0, 0], thighL: [-57.8, -17.1, -7.3],
        shinL: [119.6, -15.5, 12.1], footL: [22.8, 4.5, 3.8], thighR: [-31.8, -18.1, -18],
        shinR: [109.2, 9.1, 1.6], footR: [19.4, -0.7, 3.8],
      },
    },
    B: {
      root: { p: [-0.109, 0.245, -0.03], r: [-90, 180, 0] },
      j: {
        hips: [20, -15.7, 12], spine: [0, -4.9, 0.8], chest: [16, -1.9, 15.9],
        neck: [27.1, 60.6, -10.1], head: [-11.3, 39.6, -3.4], clavL: [5.5, -22.3, 30.9],
        armL: [-14, -69.6, 108.7], foreL: [-71.1, -0.7, 0], clavR: [8, -32.2, 28.6],
        armR: [2.1, 26.6, -155], foreR: [-93.7, 0, 0], thighL: [-41.2, 6.8, 6.8],
