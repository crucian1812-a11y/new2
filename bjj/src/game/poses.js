...
export const POSES = {
  ...
  HALF_GUARD_WORK: P('HALF_GUARD_WORK', {
    ...
    A: {
      ...
      j: {
        hips: [2.7, 12.1, 18], spine: [24.8, -25.3, 30.9], chest: [-8.5, -28.9, 3.9],
        ...
        shinL: [107, 0, 0], footL: [10, 0, 0.8], thighR: [-17.7, 67.8, -34.7],
        shinR: [110.4, 15.3, -14.9], footR: [-1.2, -26, 1],
      },
    },
    B: {
      root: { p: [-0.046, 0.287, 0.113], r: [-72, 156, -22] },
      j: {
        hips: [13.8, 6.9, 6.1], spine: [-4.7, 1.8, 36.3], chest: [25.7, -0.2, -0.7],
  ...
  TURTLE_WORK: P('TURTLE_WORK', {
    ...
    A: {
      ...
      j: {
        ...
        armR: [-114.8, -10, 79], foreR: [-39.6, -22, -18.5], thighL: [-27.5, 0.4, 18.6],
        shinL: [97.6, 4.6, 3.1], footL: [12.6, 0.1, 3.8], thighR: [-40.9, -19.7, -3.2],
        shinR: [96, -9, 3], footR: [-1.7, -10.4, -2.9],
      },
    },
    B: {
