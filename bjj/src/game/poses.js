...
export const POSES = {
  ...
  STANDING: P('STANDING', {
    ...
    A: {
      root: { p: [0, 0.825, -0.66], r: [0, 0, 0] },
      j: { ...STANCE_SPINE, ...STANCE_ARMS, ...STANCE_LEGS },
    },
    B: {
      root: { p: [0, 0.825, 0.66], r: [0, 180, 0] },
      j: { ...STANCE_SPINE, ...STANCE_ARMS, ...STANCE_LEGS },
    },
    grips: [],
  }),
  ...
  CLINCH: P('CLINCH', {
    ...
    points: 0, top: null, ground: false,
    A: {
      root: { p: [0.008, 0.806, -0.238], r: [0, 6, 0] },
      j: {
    ...
    B: {
      root: { p: [-0.086, 0.773, 0.317], r: [0, 186, 0] },
      j: {
  ...
  BACK: P('BACK', {
    ...
    points: 4, top: 'A', ground: true,
    A: {
      root: { p: [0.008, 0.321, -0.47], r: [-22, 8, 6] },
      j: {
    ...
    B: {
      root: { p: [0.03, 0.289, -0.06], r: [-16, 4, 4] },
      j: {
  ...
  RNC: P('RNC', {
    ...
    A: {
      root: { p: [0.008, 0.35, -0.408], r: [-26, 8, 8] },
      j: {
    ...
    B: {
      root: { p: [-0.026, 0.37, -0.06], r: [-10, 4, 4] },
      j: {
  ...
  BACK_WORK: P('BACK_WORK', {
    ...
    variantOf: 'BACK',
    A: {
      root: { p: [0.031, 0.314, -0.445], r: [-22, 8, 6] },
      j: {
        hips: [3, -6.7, -35.1], spine: [24, -22.5, 4.5], chest: [22, -11, 11.3],
        neck: [25.3, 0, 0.8], head: [-11.2, 11.8, 0], clavL: [-2.2, 2.4, 30.6],
        armL: [-128.4, 32.3, -50], foreL: [-86.9, -2.8, -9.7], clavR: [24.8, 21, -27.5],
        armR: [-91.7, -25.3, 3.2], foreR: [-123.6, -65.2, -52.4], thighL: [-83, 19.6, 24.3],
        shinL: [78.8, -2.2, 3], footL: [-14, 3, 0], thighR: [-77, -18, -25],
        shinR: [81, 0, -2.2], footR: [-13.2, 0, 0],
      },
    },
    B: {
      root: { p: [-0.004, 0.288, -0.05], r: [-16, 4, 4] },
      j: {
        hips: [-14, -25.5, -4.5], spine: [2.8, -15.7, -6], chest: [-5.7, -4.5, -48],
        neck: [3.3, -3.7, 0.8], head: [16, -2, 6], clavL: [-26.1, 4.6, 25.9],
        armL: [-149.9, 8.7, -37.9], foreL: [-58.4, 2.3, -12.6], clavR: [12.6, 18.1, -36.5],
        armR: [-91.8, -37.5, 31.4], foreR: [-80.2, 6.2, 7.7], thighL: [-56, 8, 14],
        shinL: [86, 0, 0], footL: [-10, 0, 0], thighR: [-62, -8, -12.5],
        shinR: [87.5, 1.5, 1.5], footR: [-8.5, 1.5, 1.5],
      },
    },
  }),
  ...
  RNC_WORK: P('RNC_WORK', {
    ...
    variantOf: 'RNC',
    A: {
      root: { p: [0.004, 0.379, -0.409], r: [-26, 8, 8] },
      j: {
    ...
    B: {
      root: { p: [-0.026, 0.371, -0.062], r: [-10, 4, 4] },
      j: {
  ...
  STANDING_WORK: P('STANDING_WORK', {
    ...
    B: {
      root: { p: [0.1, 0.791, 0.61], r: [0, 186, 0] },
      j: {
  ...
  CLINCH_WORK: P('CLINCH_WORK', {
    ...
    B: {
      root: { p: [-0.118, 0.765, 0.281], r: [0, 186, 0] },
      j: {
  ...
  TRIANGLE_WORK: P('TRIANGLE_WORK', {
    ...
    variantOf: 'TRIANGLE',
    A: {
      root: { p: [-0.007, 0.464, -0.304], r: [30, 0, 0] },
      j: {
    ...
    B: {
      root: { p: [0.064, 0.294, 0.115], r: [-58, 190, 0] },
      j: {
  ...
  RNC_WORK2: P('RNC_WORK2', {
    ...
    variantOf: 'RNC',
    A: {
      root: { p: [-0.026, 0.396, -0.388], r: [-26, 8, 8] },
      j: {
    ...
    B: {
      root: { p: [-0.026, 0.346, -0.06], r: [-10, 4, 4] },
      j: {
