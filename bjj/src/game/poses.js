...
export const POSES = {
  ...
  CLINCH: P('CLINCH', {
    ...
    points: 0, top: null, ground: false,
    A: {
      root: { p: [0.017, 0.979, -0.222], r: [0, 6, 0] },
      j: {
        hips: [-12.2, -6, 1.6], spine: [31.3, -4.5, 9.8], chest: [17.5, 12.8, -2.8], neck: [-13.8, -1.9, -2.2], head: [-2.5, 0.8, 0],
        clavL: [28.8, -4.9, 27.7], armL: [-108.2, 52.8, 15.5], foreL: [-147.2, 16.2, 25.3],
        clavR: [5.5, 13.4, 14.3], armR: [-73.1, -23.7, 18.2], foreR: [-64, 0, -4.9],
        thighL: [-5.3, 13.6, 2.4], shinL: [25.2, 1.5, 0.8], footL: [-21.6, -7.2, 3],
        thighR: [6.5, -11.7, -8.9], shinR: [23.3, 0.8, -2.2], footR: [-46, 13.5, 0.8],
      },
    },
    B: {
      root: { p: [-0.109, 0.931, 0.298], r: [0, 186, 0] },
      j: {
        hips: [-24.9, -8.8, -2.9], spine: [30.5, -0.6, 4.6], chest: [10.1, 10.6, 7.1], neck: [7.6, -2.7, -10], head: [-4.6, 0, 0.1],
        clavL: [18.6, -13.3, 24.1], armL: [-103.4, 33.9, 9.3], foreL: [-121.5, -32, -42.8],
        clavR: [0.9, -7.8, 8.1], armR: [-76.7, -24.5, 19.6], foreR: [-61.6, -2.2, 0.4],
        thighL: [-11.6, 13.6, 6.1], shinL: [44.6, 1.5, -2.2], footL: [-14.1, -8, -0.6],
        thighR: [1.1, -8.5, -15.6], shinR: [27.9, -2.1, 5.3], footR: [-3.8, 17.5, 16.6],
      },
    },
    grips: [
  ...
  CLOSED_GUARD: P('CLOSED_GUARD', {
    ...
    B: {
      ...
      j: {
        ...
        thighL: [-51.4, 12.5, 15.3], shinL: [145.1, -2.9, -9.9], footL: [-10, 1.5, 0.8],
  ...
  SIDE_CONTROL: P('SIDE_CONTROL', {
    ...
    A: {
      ...
      j: {
        ...
        clavL: [-10.9, -26.8, -29.3], armL: [-84.5, 41.5, -45.6], foreL: [-120.1, 31.8, 13],
        clavR: [34.1, -26.8, 7], armR: [-27.3, -8.9, 57.7], foreR: [-112.2, 9.2, -12.4],
        thighL: [-36.5, -9.1, -13.3], shinL: [112.2, -17.8, 25.7], footL: [8.5, -9.7, -3.7],
        thighR: [-26.5, -5.2, -25], shinR: [83.4, 14.3, -13.5], footR: [17, 12.8, 0.8],
      },
    },
    B: {
      ...
      j: {
        ...
        clavR: [-19.6, -21.4, 37.7], armR: [-89.1, -64.5, -10], foreR: [-87.6, 29.9, 0.4],
        thighL: [-26.4, 8.4, 10.6], shinL: [40.8, -4.5, -1.5], footL: [-15.2, 0.8, 2.3],
        thighR: [-18.2, 1.6, -9.1], shinR: [35.6, 7.6, 0.9], footR: [-10.6, 4.7, 2.5],
      },
    },
    hold: [
      { of: 'A.chest', above: 'B.chest', by: 0.16 },
  ...
  KNEE_ON_BELLY: P('KNEE_ON_BELLY', {
    ...
    A: {
      root: { p: [0.075, 0.61, 0.109], r: [-6, 100, 0] },
      j: {
        hips: [-44.4, -35.2, 10.5], spine: [4.3, -9.6, 28.6], chest: [-27.4, -29.9, 36.8], neck: [3.8, -24, 6.1], head: [-17.5, -8.2, 0],
        clavL: [-4.1, 22.6, 27.6], armL: [-51, 19.4, -28.4], foreL: [-68.9, 0.8, -2.1],
        clavR: [1.9, -11.9, 15.4], armR: [-32.2, 12.4, 38.6], foreR: [-32.3, 39.4, 30.4],
        thighL: [-134.4, -14, -24.4], shinL: [59.6, 0, 0], footL: [8, -0.7, 0],
        thighR: [-32.9, -25.2, -43.9], shinR: [14.2, 20.5, -23], footR: [-25.1, -7.1, 7.9],
      },
    },
    B: {
      root: { p: [-0.162, 0.254, 0.012], r: [-90, 180, 0] },
      j: {
        hips: [9.3, 72.8, -3.7], spine: [-7.8, -23, 14.3], chest: [12, 17.4, 30.1], neck: [-14.5, -0.7, -0.7], head: [12, -24.7, -0.7],
        clavL: [-3.3, 23.5, 36.8], armL: [-116.8, 46.2, -29.5], foreL: [-81.5, -5.2, -2.2],
        clavR: [-20.5, -7.2, -31.1], armR: [-70.2, -32, 25.5], foreR: [-74.8, 0.8, 0],
  ...
  MOUNT: P('MOUNT', {
    ...
    A: {
      ...
      j: {
        ...
        clavL: [16.1, -10.8, -28.1], armL: [-95.2, 13.9, -24.4], foreL: [-76.5, 2, -1.3],
        clavR: [23.7, 5.8, 39.2], armR: [-83.6, -2.1, 40.6], foreR: [-114.7, 16.7, 13.9],
        thighL: [-46.6, 11.6, 80.1], shinL: [56.8, 51.1, -24], footL: [17.3, 1.5, 0],
        thighR: [-15.6, -46.5, -5.3], shinR: [74, -23.2, 0.8], footR: [17.3, 0, 0.8],
      },
    },
    B: {
      root: { p: [0.013, 0.258, 0.248], r: [-90, 180, 0] },
      j: {
        hips: [17.1, -19.9, -18.7], spine: [14.4, -9.5, -16.3], chest: [23, 10.6, 21.3], neck: [-2, 2.3, -3], head: [11.8, 1.6, 3.1],
        clavL: [1.5, -38.9, 9.6], armL: [-152.6, 40.4, 12.4], foreL: [-119.6, 23.7, 13.9],
        clavR: [1.8, 10.2, -17.3], armR: [-173.5, 19.4, 28.6], foreR: [-74.5, -11.8, -5.1],
        thighL: [-34.2, -11.6, -10.7], shinL: [35.8, 0, 1.5], footL: [-4.9, 0.8, -5.9],
  ...
  BACK: P('BACK', {
    ...
    A: {
      ...
      j: {
        ...
        thighR: [-68.3, -17.9, -39], shinR: [70.2, -0.7, 1.5], footR: [-10.9, 4.6, -2.1],
      },
    },
    B: {
      root: { p: [0.038, 0.292, -0.09], r: [-16, 4, 4] },
      j: {
        hips: [-38, -29.8, 1.5], spine: [14.3, -11.1, -11.2], chest: [-12.4, 4.7, -46.4], neck: [5.4, -20.9, -8.8], head: [19.5, -8.2, 3.8],
  ...
  TURTLE: P('TURTLE', {
    ...
    A: {
      ...
      j: {
        ...
        clavR: [-14.9, 19.5, -40.8], armR: [-116.7, -7.1, 53.6], foreR: [5.3, 8.6, -32.2],
        thighL: [-40, 4, 14], shinL: [104, 0, 0], footL: [8, 0, 0],
        thighR: [-7.9, -2.9, -1.5], shinR: [91, 0, 1.5], footR: [20.8, 4.5, 6],
      },
    },
    B: {
      root: { p: [-0.176, 0.304, 0.12], r: [64, 176, 0] },
      j: {
        hips: [-1.4, 21.8, 12.9], spine: [-33, 20.7, 26.7], chest: [-32.8, 37.7, -24.8], neck: [-12.4, 12, 21.8], head: [25.5, 3.8, 3],
        clavL: [4, 14.5, -42.1], armL: [-63.2, 24.4, -24.9], foreL: [-116, -4.5, -0.7],
        clavR: [27.5, -34.3, 0.2], armR: [-24.8, -4, 27.3], foreR: [-105.5, 2.3, 6.8],
        thighL: [57.6, 53.4, 66.1], shinL: [149.7, -5, 10.6], footL: [15.1, 2.3, 2.3],
        thighR: [40.2, 7.1, -58.1], shinR: [151.2, 27.1, -6.6], footR: [14.3, 2.3, 0.8],
      },
    },
    hold: [
      { of: 'A.chest', above: 'B.chest', by: 0.16 },
  ...
  RNC: P('RNC', {
    ...
    A: {
      ...
      j: {
        hips: [-11.2, -1.4, -17.9], spine: [32.3, -21.5, -2.9], chest: [-13.8, -8.9, 15.2], neck: [18, 0, 0], head: [-14.7, 10, 0],
        clavL: [11.4, -0.6, 29.1], armL: [-162.7, 39.1, -47.1], foreL: [-144.2, 2.3, 2.3],
        clavR: [5.4, -17.5, -32], armR: [-122.6, -27.2, 57.1], foreR: [-128.5, 2.3, -0.7],
        thighL: [-84.4, 14.5, 27.8], shinL: [60.2, -1.3, 5.5], footL: [-14.7, -3, 3],
        thighR: [-83.6, -20.7, -33.6], shinR: [74.5, 6.9, -3.6], footR: [-14, 4, -8.9],
      },
    },
    B: {
      root: { p: [-0.075, 0.277, -0.041], r: [-10, 4, 4] },
      j: {
        hips: [-32.9, 3.8, -49.4], spine: [13.3, -3.6, 18.8], chest: [4.6, 16.6, 5.4], neck: [-16.1, -14.1, -23.5], head: [-11.6, 26.7, 2.5],
        clavL: [-17.7, 25.7, 28.2], armL: [-148.3, 40.6, -42.4], foreL: [-118.7, -25.9, -0.7],
        clavR: [6.3, -8.7, 0.7], armR: [-129.5, -40.3, 40.5], foreR: [-117.2, -5.9, -1.5],
        thighL: [-49.6, 29.1, 10.3], shinL: [89.2, 20.4, -18], footL: [-12.9, 6.9, 37.6],
  ...
  ARMBAR: P('ARMBAR', {
    ...
    B: {
      ...
      j: {
        ...
        thighR: [-13.8, -5.2, -5.7], shinR: [37.3, 2.3, 0], footR: [-12, 0.8, 0.8],
      },
    },
    hold: [
  ...
  TRIANGLE: P('TRIANGLE', {
    ...
    A: {
      ...
      j: {
        ...
        clavL: [0, -3.1, 43.9], armL: [-163.4, 0.8, -55], foreL: [-49.5, -11.1, -26.2],
        clavR: [-7.7, 19.6, -23.2], armR: [-91.9, -36.2, 33.8], foreR: [-56.3, 10.7, 12.1],
        thighL: [-7.1, 69.8, -15.4], shinL: [81.1, 0, 6.8], footL: [14.8, 2.3, -3.6],
        thighR: [-16.7, 26, -0.9], shinR: [69.8, -2.9, -0.7], footR: [1.5, -14.7, 0.8],
      },
    },
    B: {
  ...
  KIMURA: P('KIMURA', {
    ...
    A: {
      ...
      j: {
        hips: [-47.5, -29, -22.4], spine: [43.9, -18.5, 4.5], chest: [39.1, -21.3, -4.5], neck: [34.6, -4.4, 5.3], head: [-21.2, -6, 0],
        clavL: [1.6, 3.2, -44.7], armL: [-67.1, 34.2, -48.2], foreL: [-111.4, 1, 0.8],
        clavR: [-36.9, -5.7, -13.5], armR: [-78.5, -52.9, 33.4], foreR: [-118.4, 0, 0],
        thighL: [-76.9, -1, 5], shinL: [101.3, -0.7, 0.8], footL: [8.9, -0.7, 6.3],
    ...
    B: {
      ...
      j: {
        hips: [17.6, 8.3, 6], spine: [-11.7, -1.5, 12], chest: [5.4, 3.1, 4.7], neck: [-34.6, -0.7, 0.1], head: [1.5, -27.5, 5.3],
        clavL: [5.2, 18.1, 41.9], armL: [-161.6, 71.1, -55.3], foreL: [-93.8, -10.3, -3.7],
  ...
  GUARD_ENTRY: P('GUARD_ENTRY', {
    ...
    B: {
      ...
      j: {
        ...
        thighL: [-13.6, 6.3, -0.5], shinL: [82.7, 0.8, -5.2], footL: [8.9, 1.9, 0.5],
  ...
  BACK_WORK: P('BACK_WORK', {
    ...
    B: {
      ...
      j: {
        ...
        shinR: [70.4, -5.2, 4.6], footR: [-6.2, 7.6, -5.1],
      },
    },
  }),
  ...
  RNC_WORK: P('RNC_WORK', {
    ...
    variantOf: 'RNC',
    A: {
      root: { p: [-0.017, 0.377, -0.421], r: [-26, 8, 8] },
      j: {
        hips: [-6, -5.2, -12], spine: [29.3, 2.3, 13.7], chest: [-8.6, -8.2, -2.7],
        neck: [25, 0, 0], head: [-21, 10, 0], clavL: [-4.5, -0.7, 14.3],
        armL: [-159, 39.8, -25.5], foreL: [-136.7, 1.5, 1.5], clavR: [3.9, -15.4, -33.5],
    ...
    B: {
      root: { p: [-0.026, 0.395, -0.061], r: [-10, 4, 4] },
      j: {
        hips: [-14, 15.8, -32.2], spine: [7, -5.8, 6.8], chest: [7.8, 22, -3.7],
        neck: [-27.4, -21.7, -29], head: [-13, 29.6, 1.6], clavL: [-17, 25, 22.1],
  ...
  SIDE_CONTROL_WORK: P('SIDE_CONTROL_WORK', {
    ...
    A: {
      ...
      j: {
        hips: [-54, -30.6, -22.4], spine: [27.6, -3.1, 17.5], chest: [30.6, -19.7, 16.2],
        neck: [20.8, 14.5, 34.8], head: [-37.5, -1.5, -6.7], clavL: [-22.2, -24.5, -24],
    ...
    B: {
      ...
      j: {
        ...
        neck: [18.1, 70.9, 3], head: [21.4, 24.5, 5.4], clavL: [-11.6, -5.9, -10],
        armL: [-116.2, 22.5, -38.4], foreL: [-120.5, 5.4, 4.6], clavR: [14.6, -32.8, 5.3],
        armR: [-69.2, -43.7, 2.6], foreR: [-63.6, 3.3, -4.2], thighL: [-40.7, 6.8, 12.8],
        shinL: [52, -1.5, 0], footL: [-16, 0, 0], thighR: [-15.2, -0.7, -14.5],
        shinR: [31.9, 0.8, -6.7], footR: [-11.4, 0.8, 0],
      },
    },
  }),
  ...
  CLINCH_WORK: P('CLINCH_WORK', {
    ...
    A: {
      ...
      j: {
        hips: [-11.5, -16, 3.9], spine: [19.5, -1.7, -11.1], chest: [13.8, 6, 10.7],
        neck: [-19.6, 5.6, 12], head: [3.6, -0.7, 0.8], clavL: [16.8, -18.4, 25.3],
    ...
    B: {
      root: { p: [-0.141, 0.9, 0.281], r: [0, 186, 0] },
      j: {
        hips: [-10, -14.7, 5.3], spine: [18.1, -2.1, 0.8], chest: [7.3, 3.8, 4],
        neck: [9.4, -2, -4.7], head: [-10.6, 0.8, 0.9], clavL: [30, -10.4, 27.3],
        armL: [-86.6, 39.3, 10.1], foreL: [-106.7, -28.1, -35], clavR: [8.9, -8, 10.4],
  ...
  CLOSED_GUARD_WORK: P('CLOSED_GUARD_WORK', {
    ...
    B: {
      ...
      j: {
        ...
        armR: [-118.7, -34.7, 8.9], foreR: [-82.7, 21.4, 17.6], thighL: [-51.7, 18.4, 11.5],
  ...
  OPEN_GUARD_WORK: P('OPEN_GUARD_WORK', {
    ...
    A: {
      ...
      j: {
        ...
        foreR: [-40, -8.2, -3.6], thighL: [-28.1, 27, 8.7], shinL: [96.6, 19.6, -14.9],
        footL: [23.8, -11.1, 1.7], thighR: [-8.7, -21.4, -17], shinR: [77.8, 1.5, -4.5],
        footR: [-20, 0, 0],
      },
    },
    B: {
  ...
  KNEE_ON_BELLY_WORK: P('KNEE_ON_BELLY_WORK', {
    ...
    A: {
      ...
      j: {
        ...
        neck: [-1.1, -14.2, 3.1], head: [-22, -6, 0], clavL: [6.4, 7.8, 27],
        armL: [-60.1, 20.4, -27.5], foreL: [-59.5, 8.9, -2.7], clavR: [5.3, -5.7, 29],
    ...
    B: {
      ...
      j: {
        hips: [1.6, 55.7, 0.8], spine: [-13.9, -16.8, 21], chest: [12.8, 30.7, 36.9],
        neck: [-19.7, -0.7, 0.8], head: [19.3, -23.2, -0.7], clavL: [3.9, 11.4, 20.8],
        armL: [-100, 45.5, -25.2], foreL: [-94.1, -5.2, -5.1], clavR: [-23.7, -8.7, -26.5],
  ...
  TURTLE_WORK: P('TURTLE_WORK', {
    ...
    A: {
      ...
      j: {
        hips: [9.1, 39.5, 26.6], spine: [44.2, 8.8, 2.3], chest: [42.9, -17.9, 10.6],
        neck: [20.7, 0, -2.9], head: [-15.6, 0.1, 0.1], clavL: [30, -21, 21.3],
        armL: [-33.3, 28.7, -41.7], foreL: [-67, 42.2, 33.1], clavR: [-3.3, 30.2, -27],
        armR: [-114, -12.2, 78.3], foreR: [-40.3, -21.2, -17.7], thighL: [-24.4, 1.2, 18.6],
        shinL: [97.6, 4.6, 3.1], footL: [12.6, 0.1, 3.8], thighR: [-46.9, -21.9, -3.2],
        shinR: [94.5, -9, 3], footR: [-3.9, -14.1, -3.6],
      },
    },
    B: {
      root: { p: [0.017, 0.266, 0.119], r: [64, 176, 0] },
      j: {
        hips: [13.6, -11.9, 22.7], spine: [-16, 15.8, 26.6], chest: [-29.6, 36.1, -18.2],
        neck: [-25.7, -0.7, 1.6], head: [33.5, -0.7, 4.5], clavL: [-2.7, 41.6, 16.4],
        armL: [-103.7, 34.4, -6.7], foreL: [-125.2, -0.7, 4.6], clavR: [35.3, -25, 7.4],
        armR: [-18.3, -2.3, 27.4], foreR: [-110.9, 5.4, 6.9], thighL: [64.2, 55, 37.7],
        shinL: [155.6, 0.3, 11.6], footL: [33.2, 0.1, 0.1], thighR: [31.7, 2.7, -70.1],
  ...
  ARMBAR_WORK: P('ARMBAR_WORK', {
    ...
    A: {
      ...
      j: {
        hips: [3.8, -6, 7.6], spine: [13, 22.1, 34.2], chest: [21.5, -4.1, 24.5],
        neck: [-3.9, 0.8, -1.5], head: [23.5, -1.5, 0.1], clavL: [-14.9, -17.8, 34.4],
        armL: [-116.2, 15.3, -38.4], foreL: [-86.9, -6, -0.7], clavR: [-2.4, 4, -25.8],
        armR: [-110.2, -15.2, 39.3], foreR: [-115.1, -4.2, 5.6], thighL: [-43.1, 2.3, 52],
        shinL: [1.1, -1.3, -0.7], footL: [-12.7, 0.1, -1.5], thighR: [-13.1, 8.5, -24.4],
        shinR: [34.2, 3.2, -2.9], footR: [-4.9, 3.9, -2.9],
      },
    },
    B: {
      root: { p: [-0.025, 0.293, -0.059], r: [-90, 180, 0] },
      j: {
        hips: [0.8, 10.8, 3.9], spine: [25.3, 24.1, 2.4], chest: [6, 12.1, 8.4],
        neck: [-4.8, 4.6, -2.1], head: [4.1, 0.8, -2.2], clavL: [11.2, 9.2, 43.7],
        armL: [-83.5, 49.1, -10.4], foreL: [-51, -19.2, 10.4], clavR: [23.6, 19.7, -23.1],
        armR: [-61.8, -19.9, 26.6], foreR: [-74, 8.5, 4.7], thighL: [-13.9, 35.6, 3.6],
        shinL: [59.9, 12.8, -8.9], footL: [-11.2, 0.8, 0.8], thighR: [-5.4, -6.6, -5.6],
        shinR: [36.6, -1.5, -2.9], footR: [-14.8, 0, 0.8],
      },
    },
  }),
  ...
  TRIANGLE_WORK: P('TRIANGLE_WORK', {
    ...
    A: {
      ...
      j: {
        ...
        shinR: [94.6, -1.5, 0.8], footR: [18.7, 0.1, 4.6],
      },
    },
    B: {
  ...
  GUILLOTINE_WORK: P('GUILLOTINE_WORK', {
    ...
    A: {
      ...
      j: {
        ...
        neck: [-46.5, -30.4, -21.5], head: [-26, 1.1, -12.7], clavL: [-30.2, -25.1, -2.9],
    ...
    B: {
      ...
      j: {
        hips: [12.6, 20.3, 23.3], spine: [0.5, -26.9, -5.9], chest: [-8.4, -11.2, -19.3],
        neck: [-28.6, 0.8, 0.8], head: [27.3, 1.5, -0.7], clavL: [22.7, -4.4, 18.1],
        armL: [-139.6, 84.6, -8.3], foreL: [-122.9, 13.8, 56.2], clavR: [-5.8, -22.9, -32.9],
        armR: [-152.5, -14.7, 37.1], foreR: [-85.1, -6.6, -5.9], thighL: [-142.2, -27.4, -2.5],
  ...
  BACK_WORK2: P('BACK_WORK2', {
    ...
    A: {
      ...
      j: {
        hips: [-1.4, 3, -12.8], spine: [30.8, 1.5, 18], chest: [9.3, 0, 24.8],
        neck: [26.4, 0.1, 0], head: [-20, 13.3, 0], clavL: [13.6, -8.9, -10.5],
        armL: [-156.5, 27.3, -53.7], foreL: [-104.1, -1.3, 0.8], clavR: [16.7, 28.7, -21.3],
        armR: [-101.4, -45.3, 3.3], foreR: [-104.2, -55.3, -40.3], thighL: [-78.4, 24.1, 21.3],
        shinL: [100.5, 18.8, -12.7], footL: [-18.5, -9, -19.3], thighR: [-68.5, -42.6, -67.5],
        shinR: [85.8, 25.7, -22.2], footR: [-13.8, 2.3, -1.4],
      },
    },
    B: {
      ...
      j: {
        ...
        shinL: [79.3, -13.4, 7.6], footL: [-9.9, -1.5, 0.1], thighR: [-88.6, 8.6, -2.5],
        shinR: [107.3, -3.5, 6.2], footR: [6.7, -8, -14],
      },
    },
  }),
  ...
  HALF_GUARD_WORK2: P('HALF_GUARD_WORK2', {
    ...
    B: {
      ...
      j: {
        hips: [21.6, 24.5, 8.1], spine: [25.3, 20.5, 43], chest: [7, -11.2, -38.5],
  ...
  SIDE_CONTROL_WORK2: P('SIDE_CONTROL_WORK2', {
    ...
    variantOf: 'SIDE_CONTROL',
    A: {
      root: { p: [0.329, 0.356, 0.253], r: [10, 128, 0] },
      j: {
        hips: [-52.2, -49, -43.5], spine: [22.7, -11.4, 26.1], chest: [49.6, 4.5, 8.6],
        neck: [18.9, -12.5, -3.2], head: [-25.5, 0, 6], clavL: [-2, -38.8, -22.4],
        armL: [-78.7, 44.2, -47.9], foreL: [-130.8, 4, 1.7], clavR: [27.9, -36.5, -7.1],
        armR: [-11.3, -44, 26.1], foreR: [-104, 5.6, -6.3], thighL: [-57.8, -20.2, -8.1],
        shinL: [118.8, -16.3, 12.8], footL: [22.8, 4.5, 3.8], thighR: [-31.1, -16.6, -18],
        shinR: [109.2, 11.3, -0.7], footR: [19.4, -0.7, 3.8],
      },
    },
    B: {
      root: { p: [-0.105, 0.245, -0.038], r: [-90, 180, 0] },
      j: {
        hips: [20, -15, 12], spine: [0, -13.2, 4.5], chest: [14.5, 2.6, 12],
        neck: [21.8, 59.8, -5.6], head: [-6.1, 39.6, -5.7], clavL: [-2.8, -11.9, 31.6],
        armL: [-111.7, 30, -26.9], foreL: [-67.1, 34, 24.2], clavR: [8, -32.2, 28.6],
        armR: [-63.8, -31.7, 17.6], foreR: [-70.4, 12.5, -40.5], thighL: [-41.2, 6.8, 6.8],
        shinL: [59.3, 0, 0], footL: [-16, 0, 0], thighR: [-32.7, 4.5, -4],
        shinR: [42.5, 13.7, -4.4], footR: [-11.3, 7.6, 0.2],
      },
    },
  }),
