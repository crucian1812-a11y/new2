...
export const POSES = {
  ...
  CLOSED_GUARD: P('CLOSED_GUARD', {
    ...
    A: {
      ...
      j: {
        ...
        clavR: [-24.2, 34.5, 0.3], armR: [-76.9, -17.6, 29.1], foreR: [-48.8, 14.4, 25.6],
  ...
  HALF_GUARD: P('HALF_GUARD', {
    ...
    A: {
      ...
      j: {
        ...
        clavL: [-20.2, 11.2, 33.4], armL: [-108.6, 63.4, 7.4], foreL: [-41.3, 8.4, -7.3],
    ...
    B: {
      ...
      j: {
        ...
        clavR: [1.8, 13.0, -39.8], armR: [-29.3, 34.1, 18.4], foreR: [-36.1, 29.4, 7.7],
  ...
  SIDE_CONTROL: P('SIDE_CONTROL', {
    ...
    A: {
      ...
      j: {
        hips: [-42, -27, -7.5], spine: [39.4, -16.4, 15.4], chest: [39.1, -18.1, 14.1], neck: [17.8, 8.3, -6], head: [-30, 0, 0],
  ...
  MOUNT: P('MOUNT', {
    ...
    B: {
      ...
      j: {
        ...
        clavL: [-6.8, -41.2, 7.9], armL: [-151.3, 44.1, 11.6], foreL: [-122.1, 9.2, 7.6],
  ...
  BACK: P('BACK', {
    ...
    B: {
      ...
      j: {
        ...
        clavR: [1.5, 14.9, -39.2], armR: [-94.8, -29.3, 33.6], foreR: [-81.7, 5.4, 6.1],
  ...
  TURTLE: P('TURTLE', {
    ...
    A: {
      ...
      j: {
        hips: [-6, 24.8, 32.4], spine: [41.8, 12.8, 12], chest: [46.6, 6.6, 3.3], neck: [10.8, 0, 1.5], head: [-15.7, 2.3, 0.8],
        clavL: [30.0, -11.1, 24.7], armL: [-50.5, 36.1, -20.8], foreL: [-76.1, 16.6, 21],
    ...
    B: {
      ...
      j: {
        hips: [10.5, 16.5, 11.4], spine: [-30.8, 23.6, 21.4], chest: [-32.8, 31.7, -25.6], neck: [-32.7, 0, 0.8], head: [22.5, -0.7, 3],
        clavL: [16.6, 35.5, 12.6], armL: [-57.2, 19.8, -22], foreL: [-116, 0, 0],
        clavR: [32.0, -17.8, 16.6], armR: [-13.6, 2.8, 31.8], foreR: [-107, 2.3, 3.8],
  ...
  ARMBAR: P('ARMBAR', {
    ...
    A: {
      ...
      j: {
        hips: [16, -12, 2.3], spine: [7.2, 19.9, 43.5], chest: [20, -3.7, 24.8], neck: [-16, 0, 0], head: [22, 0, 0],
        clavL: [-17.8, -22.2, 35.0], armL: [-105.7, 22.8, -37.7], foreL: [-83.2, -6, -0.7],
    ...
    B: {
      ...
      j: {
        ...
        clavR: [24.3, 20.4, -23.9], armR: [-50.4, -19.2, 26.4], foreR: [-60.6, 8.4, 6.1],
  ...
  TRIANGLE: P('TRIANGLE', {
    ...
    A: {
      ...
      j: {
        ...
        clavL: [6.6, 1.3, 41.6], armL: [-170.9, -0.7, -55], foreL: [-45.9, -1.4, -3.7],
    ...
    B: {
      ...
      j: {
        ...
        thighL: [-141.0, 14.0, 5.4], shinL: [126, -3.7, -0.7], footL: [-10, 0, 0],
  ...
  KIMURA: P('KIMURA', {
    ...
    B: {
      ...
      j: {
        ...
        clavL: [-3.2, 15.0, 38.8], armL: [-148.4, 59.6, -53.9], foreL: [-101.4, -5.9, 1.5],
        clavR: [-20.6, -31.3, -14.6], armR: [-58.7, -19.7, 33], foreR: [-72, 0, 0],
  ...
  GUILLOTINE: P('GUILLOTINE', {
    ...
    A: {
      ...
      j: {
        ...
        clavL: [-39.1, -16.4, 2.3], armL: [-113.2, 97.2, 46.8], foreL: [-69.8, 24.3, 49.6],
        clavR: [39.9, 14.2, 3.2], armR: [-45.1, -29.3, 3.8], foreR: [-15, 12.2, -30.6],
    ...
    B: {
      ...
      j: {
        ...
        thighL: [-140.5, -13.4, -9.4], shinL: [94.4, -14.2, 13.7], footL: [-10, 0, 0],
        thighR: [-143.1, -17.0, 11.5], shinR: [92.1, 22.5, -23.2], footR: [-10, 0, 0],
      },
    },
    hold: [
  ...
  ACROSS: P('ACROSS', {
    ...
    A: {
      ...
      j: {
        hips: [-47.2, -9.7, 1.3], spine: [42.8, -14.3, 9.2], chest: [39.7, -17.0, 14.1],
  ...
  MOUNT_ENTRY: P('MOUNT_ENTRY', {
    ...
    B: {
      ...
      j: {
        ...
        neck: [-20, 0, 0], head: [14, 0, 0], clavL: [-6.8, -41.2, 7.9],
  ...
  SIDE_ENTRY: P('SIDE_ENTRY', {
    ...
    A: {
      ...
      j: {
        hips: [-36, -26, 0], spine: [39.2, -16.8, 15.4], chest: [38.8, -17.9, 14.9],
  ...
  HALF_GUARD_WORK: P('HALF_GUARD_WORK', {
    ...
    B: {
      ...
      j: {
        ...
        armL: [-91.7, 42.1, -18.3], foreL: [-87.7, -7.1, -4.3], clavR: [0.7, 12.4, -40.1],
  ...
  MOUNT_WORK: P('MOUNT_WORK', {
    ...
    A: {
      ...
      j: {
        hips: [62.4, 10.5, -12], spine: [-15.7, 35.7, -32.4], chest: [44.0, -18.4, -7.8],
        neck: [12, 0, 0], head: [-10, 0, 0], clavL: [7, -20, -23.1],
        armL: [-80.3, 4.1, -31.9], foreL: [-83.3, 6.4, 7.8], clavR: [20.7, 9.0, 37.3],
  ...
  SIDE_CONTROL_WORK: P('SIDE_CONTROL_WORK', {
    ...
    A: {
      ...
      j: {
        hips: [-42, -12, -13.5], spine: [36.5, -18.9, 18.1], chest: [40.3, -16.7, 13.1],
  ...
  CLOSED_GUARD_WORK: P('CLOSED_GUARD_WORK', {
    ...
    A: {
      ...
      j: {
        ...
        armL: [-26.2, 11.2, 31.2], foreL: [-57.6, -13.2, -27.5], clavR: [-22.1, 35.1, 3.3],
  ...
  KNEE_ON_BELLY_WORK: P('KNEE_ON_BELLY_WORK', {
    ...
    A: {
      ...
      j: {
        hips: [-26.2, -18, 4], spine: [-5.8, -12.3, 45.7], chest: [-17.2, -2.2, 35.3],
  ...
  TURTLE_WORK: P('TURTLE_WORK', {
    ...
    A: {
      ...
      j: {
        hips: [2.3, 28.1, 25.7], spine: [44.8, 14.8, 12.8], chest: [45.8, 11.9, 3.7],
        neck: [16.8, 0, 1.5], head: [-15.7, 2.3, 0.8], clavL: [29.2, -14.3, 23.5],
    ...
    B: {
      ...
      j: {
        hips: [16.5, 15, 11.4], spine: [-28.8, 23.2, 24.3], chest: [-33.4, 31.4, -25.0],
        neck: [-40.7, 0, 0.8], head: [30.5, -0.7, 3], clavL: [12.9, 34.8, 20.1],
        armL: [-68.2, 21.3, -20.5], foreL: [-126, 0, 0], clavR: [32.3, -17.6, 16.4],
        armR: [-23.6, 2.8, 31.8], foreR: [-117, 2.3, 3.8], thighL: [32.5, 63.1, 41.9],
        shinL: [163.1, -17.8, 10.8], footL: [12.8, 0, 0], thighR: [15.9, 4.7, -52.9],
  ...
  ARMBAR_WORK: P('ARMBAR_WORK', {
    ...
    A: {
      ...
      j: {
        hips: [20.8, -6, 8.3], spine: [3.0, 21.1, 42.7], chest: [14, -2.9, 21.8],
    ...
    B: {
      ...
      j: {
        ...
        neck: [-8, 0, 0], head: [4, 0, 0], clavL: [7.3, 4.5, 41.4],
        armL: [-78, 49.8, -12], foreL: [-48.4, 0.1, 15.5], clavR: [24.3, 20.4, -23.9],
  ...
  TRIANGLE_WORK: P('TRIANGLE_WORK', {
    ...
    A: {
      ...
      j: {
        ...
        armL: [-170.0, -1.4, -58.2], foreL: [-46.6, 0.1, -4.4], clavR: [-6.5, 34.6, -24.7],
    ...
    B: {
      ...
      j: {
        hips: [28.8, 16, -10], spine: [-14.4, -40.3, -15.4], chest: [-8.5, -0.7, 8.4],
        neck: [-22, 0, 0], head: [14, 0, 0], clavL: [21.8, -6.6, 24.3],
        armL: [-117.1, 34.7, -27.1], foreL: [-112.5, 11.4, 3.9], clavR: [0.8, 7.6, -15.1],
        armR: [-104.7, -24, 34], foreR: [-98, 0, 0], thighL: [-141.1, 13.6, 5.2],
  ...
  KIMURA_WORK: P('KIMURA_WORK', {
    ...
    A: {
      ...
      j: {
        ...
        neck: [30, 0, 0], head: [-34, 0, 0], clavL: [9.3, 6.9, -39.9],
    ...
    B: {
      ...
      j: {
        ...
        neck: [-26.7, -0.7, 0.8], head: [-6.5, -27.5, 6], clavL: [-5.5, 13.5, 38.9],
        armL: [-135.9, 53.9, -42.9], foreL: [-93.1, -7.4, 0], clavR: [-18.9, -31.4, -16.4],
  ...
  GUILLOTINE_WORK: P('GUILLOTINE_WORK', {
    ...
    A: {
      ...
      j: {
        ...
        neck: [-48.8, -26.9, -16.4], head: [-20, 2.6, -7.5], clavL: [-35.6, -23.7, 4.3],
        armL: [-122.7, 95, 45.3], foreL: [-79.8, 24.3, 49.6], clavR: [40.8, 11.1, 3.7],
    ...
    B: {
      ...
      j: {
        ...
        armR: [-154.9, -18.5, 37.1], foreR: [-99.4, -2.9, -8.9], thighL: [-139.2, -18.6, -12.3],
        shinL: [94.4, -15.7, 14.5], footL: [-10, 0, 0], thighR: [-143.4, -15.0, 16.1],
  ...
  BACK_WORK2: P('BACK_WORK2', {
    ...
    B: {
      ...
      j: {
        hips: [0, -15, -4.5], spine: [-3.4, 1.4, -6], chest: [-1.3, 0.5, -47.0],
        neck: [2, 10, 0], head: [14, -8, 0], clavL: [-26.8, 3.1, 27.5],
        armL: [-124.1, 10.2, -35.6], foreL: [-46.4, -2.2, -13.3], clavR: [2.7, 15.4, -38.7],
  ...
  HALF_GUARD_WORK2: P('HALF_GUARD_WORK2', {
    ...
    B: {
      ...
      j: {
        ...
        armL: [-102.8, 54.4, -16], foreL: [-85.7, -7.2, -4.3], clavR: [1.9, 11.3, -40.3],
  ...
  MOUNT_WORK2: P('MOUNT_WORK2', {
    ...
    A: {
      ...
      j: {
        hips: [23.1, 22.5, 9.5], spine: [10.2, 33.1, -34.6], chest: [44.5, -17.1, -6.5],
    ...
    B: {
      ...
      j: {
        ...
        neck: [-14, 0, 0], head: [6, 0, 0], clavL: [-9.0, -41.1, 6.9],
  ...
  SIDE_CONTROL_WORK2: P('SIDE_CONTROL_WORK2', {
    ...
    A: {
      ...
      j: {
        hips: [-38, -23.7, -19.5], spine: [40.7, -10.8, 17.8], chest: [42.0, -14.4, 11.4],
