...
export const POSES = {
  ...
  HALF_GUARD: P('HALF_GUARD', {
    ...
    A: {
      ...
      j: {
        hips: [15.4, -15.7, 23.3], spine: [24, -14.2, 27.8], chest: [-7.7, -17.2, 26.4], neck: [11, 0, -0.7], head: [-7, 0, 0],
  ...
  SIDE_CONTROL: P('SIDE_CONTROL', {
    ...
    A: {
      root: { p: [0.323, 0.341, 0.31], r: [8, 100, 0] },
      j: {
        hips: [-71, -31.3, -31.5], spine: [37.9, -18.5, 21.6], chest: [27.9, 4.5, 14.4], neck: [17.2, 25.1, 37], head: [6.1, 15.9, 6.9],
        clavL: [-10.1, -26.8, -30.1], armL: [-83.8, 42.2, -45.6], foreL: [-119.4, 31.8, 13],
        clavR: [34.1, -23.8, 7], armR: [-27.3, -8.9, 57.7], foreR: [-112.2, 9.2, -12.4],
        thighL: [-38, -9.1, -13.3], shinL: [112.2, -17.8, 25.7], footL: [8.5, -9.7, -3.7],
        thighR: [-27.3, -4.5, -25], shinR: [84.1, 14.3, -13.5], footR: [17, 12.8, 0.8],
      },
    },
    B: {
      root: { p: [-0.154, 0.232, -0.03], r: [-90, 180, 0] },
      j: {
        hips: [10, 5.3, 6], spine: [4.2, -20.9, 5.3], chest: [19.4, -3.7, 12], neck: [-5.7, 57.3, 0.9], head: [4.2, 23.7, 10.2],
        clavL: [-17.8, -11.9, 28.4], armL: [-122.4, 28.5, -38.4], foreL: [-108.5, 15.2, 3.8],
        clavR: [-21.9, -14.7, 37.7], armR: [-88.4, -64.5, -10], foreR: [-87.6, 29.1, 0.4],
  ...
  KNEE_ON_BELLY: P('KNEE_ON_BELLY', {
    ...
    A: {
      root: { p: [0.075, 0.61, 0.079], r: [-6, 100, 0] },
      j: {
        hips: [-32.4, -35.2, 10.5], spine: [2.8, -18.6, 45.1], chest: [-25.9, -19.4, 42.8], neck: [3.8, -12, 3.8], head: [-17.5, -6.7, 0],
        clavL: [1.9, 12.1, 14.8], armL: [-51, 19.4, -28.4], foreL: [-68.9, 0.8, -2.1],
        clavR: [1.9, -11.9, 15.4], armR: [-32.2, 12.4, 38.6], foreR: [-32.3, 39.4, 30.4],
        thighL: [-134.4, -14, -24.4], shinL: [59.6, 0, 0], footL: [8, -0.7, 0],
        thighR: [-32.9, -14, -44.7], shinR: [14.2, 16, -21.5], footR: [-24.4, -7.1, 7.9],
      },
    },
    B: {
      root: { p: [-0.162, 0.231, 0.042], r: [-90, 180, 0] },
      j: {
        hips: [9.3, 64.5, -3.7], spine: [-8.6, -17.8, 14.3], chest: [6.7, 26.4, 34.6], neck: [-14.5, -0.7, -0.7], head: [12, -24.7, -0.7],
        clavL: [-3.3, 22.7, 36.8], armL: [-116.8, 46.2, -29.5], foreL: [-81.5, -5.2, -2.2],
        clavR: [-22, -13.2, -25.9], armR: [-69.5, -34.3, 23.2], foreR: [-74.8, 0.8, 0],
  ...
  MOUNT: P('MOUNT', {
    ...
    A: {
      root: { p: [0.001, 0.543, 0.089], r: [0, 0, 0] },
      j: {
        hips: [48.3, 29.4, -4.5], spine: [2.3, 29.6, -39.5], chest: [45.3, -22.2, -14.5], neck: [22.6, 2.3, 0.1], head: [-10.6, 5.4, 1.6],
        clavL: [13.8, -16.8, -24.4], armL: [-96, 14.6, -24.4], foreL: [-82.5, 1.2, -1.3],
        clavR: [23.7, 8, 39.2], armR: [-82.1, -2.1, 40.6], foreR: [-114.7, 16.7, 13.9],
    ...
    B: {
      ...
      j: {
        ...
        clavL: [1.5, -43.4, 11.1], armL: [-154.1, 40.4, 12.4], foreL: [-119.6, 23.7, 13.9],
        clavR: [1.8, 10.2, -16.6], armR: [-173.5, 18.6, 27.1], foreR: [-75.3, -11.8, -5.1],
        thighL: [-33.5, -9.4, -7.7], shinL: [36.5, 0.8, 0], footL: [-4.9, 0.8, -5.9],
  ...
  BACK: P('BACK', {
    ...
    points: 4, top: 'A', ground: true,
    A: {
      root: { p: [-0.007, 0.292, -0.477], r: [-22, 8, 6] },
      j: {
        hips: [-14.9, 9, -24.6], spine: [22, -12.7, -12], chest: [17.8, -6, 21.1], neck: [25.1, 0.8, 3.8], head: [-11.2, 8.8, 0.8],
    ...
    B: {
      ...
      j: {
        hips: [-38, -28.3, 1.5], spine: [14.3, -8.1, -11.2], chest: [-15.4, 4.7, -47.9], neck: [5.4, -20.9, -8.8], head: [19.5, -8.2, 3.8],
  ...
  ARMBAR: P('ARMBAR', {
    ...
    A: {
      ...
      j: {
        hips: [4.1, -1.5, -2.9], spine: [29, 2.7, 41.4], chest: [19.3, -1.4, 13.6], neck: [-3.9, 0.8, -0.7], head: [21.3, 0.8, 2.3],
  ...
  ACROSS: P('ACROSS', {
    ...
    A: {
      ...
      j: {
        ...
        shinL: [96.8, -4.4, 5.3], footL: [11.1, 0.8, -0.7], thighR: [10.4, -49.8, 14.9],
        shinR: [88, 15.1, -5.8], footR: [-13.2, -18.5, 1],
      },
    },
    B: {
  ...
  BACK_WORK: P('BACK_WORK', {
    ...
    variantOf: 'BACK',
    A: {
      root: { p: [0.016, 0.291, -0.355], r: [-22, 8, 6] },
      j: {
        hips: [-9.7, -6.7, -24.6], spine: [27, -16.5, -6.7], chest: [22, -5, 3],
    ...
    B: {
      root: { p: [-0.015, 0.295, 0.01], r: [-16, 4, 4] },
      j: {
        hips: [-32, -35.9, -11.2], spine: [14.1, -6.7, -13.5], chest: [6.3, -16.5, -48],
  ...
  HALF_GUARD_WORK: P('HALF_GUARD_WORK', {
    ...
    A: {
      root: { p: [0.176, 0.509, -0.115], r: [0, 24, 0] },
      j: {
        hips: [8.7, 12.1, 18], spine: [24.8, -25.3, 25.7], chest: [-8.5, -28.9, 3.9],
        ...
        shinL: [107, 0, 0], footL: [10, 0, 0.8], thighR: [-21.4, 79.8, -34.7],
        shinR: [112.7, 18.3, -17.9], footR: [-1.2, -26, 1],
      },
    },
    B: {
      root: { p: [-0.046, 0.287, 0.113], r: [-72, 156, -22] },
      j: {
        hips: [10.8, 6.9, 6.1], spine: [-4.7, 1.8, 36.3], chest: [25.7, -0.2, -0.7],
  ...
  SIDE_CONTROL_WORK: P('SIDE_CONTROL_WORK', {
    ...
    A: {
      ...
      j: {
        ...
        neck: [17.8, 8.5, 29.5], head: [-37.5, -1.5, -6.7], clavL: [-22.2, -24.5, -24],
        armL: [-98, 49.5, -48], foreL: [-122.6, 13.6, 13.6], clavR: [39.1, -23.9, -10.4],
        armR: [-44.7, -5.2, 40.2], foreR: [-143.7, -6.5, -17.7], thighL: [-66.7, -12.9, -5.2],
        shinL: [125, -21.7, 18.8], footL: [11.6, 0, -4.5], thighR: [-31.3, 5.3, -35.3],
    ...
    B: {
      ...
      j: {
        ...
        neck: [18.1, 70.9, 1.5], head: [22.1, 24.5, 5.4], clavL: [-15.4, -5.9, -10],
        armL: [-121.5, 22.5, -38.4], foreL: [-120.5, 3.1, 3.8], clavR: [14.6, -32.8, 5.3],
        armR: [-69.2, -43.7, 2.6], foreR: [-63.6, 3.3, -4.2], thighL: [-40.7, 6.8, 12.8],
        shinL: [52, -1.5, 0], footL: [-16, 0, 0], thighR: [-16, -0.7, -14.5],
        shinR: [31.1, 0.8, -6.7], footR: [-12.2, 0.8, 0],
      },
    },
  }),
  ...
  CLOSED_GUARD_WORK: P('CLOSED_GUARD_WORK', {
    ...
    A: {
      ...
      j: {
        hips: [24.8, -24.7, 34.7], spine: [30.6, 14.4, 13.7], chest: [10.2, -14.8, 22.1],
    ...
    B: {
      ...
      j: {
        hips: [6.3, 19.6, -0.7], spine: [14.7, 28.2, 19.1], chest: [8, 15.1, -24.3],
        ...
        shinR: [150.2, -2, 11.7], footR: [-9.2, 0.8, 0.8],
      },
    },
  }),
  ...
  KNEE_ON_BELLY_WORK: P('KNEE_ON_BELLY_WORK', {
    ...
    A: {
      ...
      j: {
        hips: [-35, -32.2, 18.3], spine: [-2.6, -22.8, 44.3], chest: [-2.2, -9.7, 49],
        neck: [-1.1, -9.7, 3.1], head: [-22, -6, 0], clavL: [2.6, 7.8, 18.7],
        armL: [-63.9, 22.6, -26], foreL: [-60.3, 8.1, -2.7], clavR: [0.8, -10.2, 20],
        armR: [-33.9, -14.9, 26.7], foreR: [-68.2, 8.6, 25], thighL: [-128.9, -31.2, -1.2],
    ...
    B: {
      ...
      j: {
        ...
        armR: [-60.5, -26.7, 17.3], foreR: [-89.9, 0, -0.7], thighL: [-41.6, 12.8, 17.3],
  ...
  TURTLE_WORK: P('TURTLE_WORK', {
    ...
    variantOf: 'TURTLE',
    A: {
      root: { p: [0.114, 0.588, -0.511], r: [10, 26, 0] },
      j: {
        hips: [8.3, 36.5, 29.6], spine: [44.9, 14.8, 6.8], chest: [36.9, -16.4, 7.6],
        neck: [18.4, 0, -2.2], head: [-16.4, 0.1, 0.1], clavL: [30, -21, 21.3],
        armL: [-33.3, 28.7, -41.7], foreL: [-67, 42.2, 33.1], clavR: [-4.1, 33.9, -27.8],
        armR: [-114.8, -10, 79.8], foreR: [-40.3, -21.2, -17.7], thighL: [-26.7, 0.4, 18.6],
        shinL: [97.6, 4.6, 3.1], footL: [12.6, 0.1, 3.8], thighR: [-40.9, -18.9, -3.2],
        shinR: [96, -9, 3], footR: [-3.2, -11.9, -3.6],
      },
    },
    B: {
      root: { p: [-0.009, 0.251, 0.074], r: [64, 176, 0] },
      j: {
        hips: [15.1, 0.8, 22.7], spine: [-34, 9.8, 30.3], chest: [-40.1, 31.6, -18.2],
        neck: [-25.7, -0.7, 1.6], head: [33.5, -0.7, 4.5], clavL: [-2, 39.3, 21.6],
        armL: [-103.7, 34.4, -6.7], foreL: [-125.2, -0.7, 4.6], clavR: [35.3, -25, 7.4],
        armR: [-18.3, -2.3, 27.4], foreR: [-110.9, 5.4, 6.9], thighL: [46.2, 52, 36.9],
        shinL: [154.1, -2, 22.8], footL: [33.2, 0.1, 0.1], thighR: [24.9, 1.9, -53.6],
  ...
  ARMBAR_WORK: P('ARMBAR_WORK', {
    ...
    A: {
      ...
      j: {
        hips: [9.8, -6, 13.6], spine: [9.2, 22.1, 40.2], chest: [20, -4.1, 24.5],
        neck: [-3.9, 0.8, -2.2], head: [23.5, -1.5, -0.7], clavL: [-14.9, -17.8, 34.4],
        armL: [-116.2, 15.3, -38.4], foreL: [-86.9, -6, -0.7], clavR: [-2.4, 4.7, -25.8],
        armR: [-110.2, -14.5, 40], foreR: [-115.1, -4.2, 5.6], thighL: [-41.6, 2.3, 46],
        shinL: [0.3, -1.3, -0.7], footL: [-12.7, 0.1, -1.5], thighR: [-19.1, 8.5, -24.4],
        shinR: [34.2, 3.2, -2.9], footR: [-5.7, 3.9, -2.9],
      },
    },
    B: {
      root: { p: [-0.025, 0.289, -0.059], r: [-90, 180, 0] },
      j: {
        hips: [0.8, 10.8, 3.9], spine: [25.3, 23.3, 2.4], chest: [7.5, 11.3, 8.4],
        neck: [-4.1, 4.6, -2.9], head: [4.1, 0.8, -2.2], clavL: [11.2, 9.2, 43.7],
        armL: [-82.8, 49.1, -10.4], foreL: [-50.3, -19.2, 10.4], clavR: [23.6, 19.7, -23.1],
        armR: [-61.8, -19.9, 26.6], foreR: [-74, 8.5, 4.7], thighL: [-15.4, 36.3, 7.3],
        shinL: [59.1, 12.8, -8.2], footL: [-11.2, 0.8, 0.8], thighR: [-6.2, -5.9, -6.4],
        shinR: [38.1, -0.7, -4.4], footR: [-14.8, 0, 0.8],
      },
    },
  }),
  ...
  BACK_WORK2: P('BACK_WORK2', {
    ...
    variantOf: 'BACK',
    A: {
      root: { p: [0.008, 0.402, -0.406], r: [-22, 8, 6] },
      j: {
        ...
        armR: [-101.4, -45.3, 3.3], foreR: [-104.2, -55.3, -40.3], thighL: [-79.2, 24.1, 21.3],
        shinL: [100.5, 18.8, -12.7], footL: [-18.5, -9, -19.3], thighR: [-67.8, -30.6, -52.5],
        shinR: [79.8, 24.9, -23], footR: [-14.6, 1.5, -2.9],
      },
    },
    B: {
      root: { p: [0.03, 0.286, 0.053], r: [-16, 4, 4] },
      j: {
        ...
        armR: [-84.6, -28.5, 32.1], foreR: [-70.3, -0.6, 6.9], thighL: [-65.4, 3.6, 20.1],
        shinL: [77, -12.7, 6.8], footL: [-9.9, -1.5, 0.1], thighR: [-88.6, 8.6, -2.5],
        shinR: [105.8, -4.3, 6.9], footR: [5.2, -7.3, -13.3],
      },
    },
  }),
  ...
  HALF_GUARD_WORK2: P('HALF_GUARD_WORK2', {
    ...
    variantOf: 'HALF_GUARD',
    A: {
      root: { p: [0.165, 0.547, -0.106], r: [0, 24, 0] },
      j: {
        hips: [6, -22.5, -6], spine: [28.6, -17.9, 31.8], chest: [-7.8, -11.8, 35.9],
        ...
        shinL: [123.3, -10.5, 9.1], footL: [10, 0, 0], thighR: [-7.9, 43.4, -11.9],
        shinR: [101.2, 11.4, -6.5], footR: [0.8, -8.2, 6.8],
      },
    },
    B: {
      root: { p: [-0.104, 0.361, 0.105], r: [-72, 156, -22] },
      j: {
        hips: [20.1, 24.5, 2.1], spine: [25.3, 20.5, 43], chest: [7.7, -10.5, -38.5],
        neck: [-7.1, 0, -0.7], head: [8, 0, 5.3], clavL: [7.8, 16.8, -27.8],
        armL: [-99, 57.5, -14.5], foreL: [-101.8, -4.8, -4.3], clavR: [5.1, 7.8, -24.3],
        armR: [-12.6, 45.5, 17.3], foreR: [-32.3, 32.5, 16.8], thighL: [-96.5, 8.9, 19.6],
  ...
  SIDE_CONTROL_WORK2: P('SIDE_CONTROL_WORK2', {
    ...
    variantOf: 'SIDE_CONTROL',
    A: {
      root: { p: [0.348, 0.356, 0.245], r: [10, 128, 0] },
      j: {
        hips: [-50, -50.5, -43.5], spine: [30.2, -17.4, 32.1], chest: [48.8, -0.8, 9.3],
        neck: [12.1, -5, -10], head: [-25.5, 0, 6], clavL: [-1.3, -38.8, -22.4],
        armL: [-76.5, 45.7, -47.2], foreL: [-133.1, 7, 5.4], clavR: [27.1, -36.5, -16.9],
        armR: [-13.6, -44.8, 26.8], foreR: [-104, 5.6, -6.3], thighL: [-57.8, -20.2, -8.1],
        shinL: [118, -16.3, 12.8], footL: [22.8, 4.5, 3.8], thighR: [-27.4, -13.6, -16.5],
    ...
    B: {
      ...
      j: {
        ...
        neck: [12, 54.5, -7.9], head: [1.4, 36.6, -1.2], clavL: [-2.8, -5.9, 26.3],
        armL: [-123.7, 28.5, -28.4], foreL: [-66.4, 34.7, 24.9], clavR: [6.5, -30.7, 28.6],
        armR: [-66.8, -40.7, 7.8], foreR: [-69.7, 12.5, -41.3], thighL: [-41.2, 6.8, 6.8],
        shinL: [59.3, 0, 0], footL: [-16, 0, 0], thighR: [-32.7, 4.5, -4],
        shinR: [42.5, 14.4, -3.7], footR: [-12.1, 7.6, 0.2],
      },
    },
  }),
