...
export const POSES = {
  ...
  CLINCH: P('CLINCH', {
    ...
    points: 0, top: null, ground: false,
    A: {
      root: { p: [0.017, 0.98, -0.222], r: [0, 6, 0] },
      j: {
        hips: [-12.2, -9, 1.6], spine: [30.5, -4.5, 9.8], chest: [16, 12.8, -3.6], neck: [-15.4, -5.7, -3], head: [-2.5, 0.8, 0],
        clavL: [29.5, -5.7, 26.1], armL: [-108.2, 50.5, 15.5], foreL: [-148, 16.9, 23.7],
        clavR: [4.7, 13.4, 14.3], armR: [-73.1, -23.7, 18.2], foreR: [-64, 0, -4.9],
        thighL: [-5.3, 13.6, 2.4], shinL: [25.2, 1.5, 0.8], footL: [-21.6, -7.2, 3],
        thighR: [6.5, -11.7, -8.2], shinR: [23.3, 0.8, -1.5], footR: [-46, 13.5, 0.8],
      },
    },
    B: {
      root: { p: [-0.109, 0.936, 0.313], r: [0, 186, 0] },
      j: {
        hips: [-24.9, -9.6, -2.9], spine: [30.5, -0.6, 4.6], chest: [8.5, 10.6, 4], neck: [5.3, -6.5, -12.3], head: [-4.6, 0, 0.1],
        clavL: [20, -13.3, 22.6], armL: [-102.7, 33.1, 8.5], foreL: [-121.5, -32, -42.8],
        clavR: [0.1, -6.4, 8.1], armR: [-76.7, -24.5, 19.6], foreR: [-61.6, -2.2, 0.4],
        thighL: [-11.6, 13.6, 6.1], shinL: [44.6, 1.5, -2.2], footL: [-14.1, -8, -0.6],
        thighR: [5.6, -9.3, -14.2], shinR: [30.1, -0.7, 5.3], footR: [-14.3, 15.9, 12.8],
      },
    },
    grips: [
  ...
  CLOSED_GUARD: P('CLOSED_GUARD', {
    ...
    B: {
      ...
      j: {
        ...
        thighL: [-52.2, 13.2, 15.3], shinL: [145.1, -2.9, -9.9], footL: [-10, 1.5, 0.8],
  ...
  SIDE_CONTROL: P('SIDE_CONTROL', {
    ...
    A: {
      root: { p: [0.319, 0.322, 0.31], r: [8, 100, 0] },
      j: {
        hips: [-69.5, -31.3, -31.5], spine: [37.9, -18.5, 21.6], chest: [27.9, 4.5, 15.1], neck: [17.9, 18.3, 31.7], head: [6.1, 15.9, 6.9],
        clavL: [-10.1, -26.8, -30.1], armL: [-83.8, 42.2, -45.6], foreL: [-119.4, 31.8, 13],
        clavR: [34.8, -23.8, -0.5], armR: [-26.6, -8.9, 57.7], foreR: [-112.2, 9.2, -12.4],
        thighL: [-42.6, -9.1, -13.3], shinL: [112.2, -17.8, 25.7], footL: [8.5, -9.7, -3.7],
        thighR: [-28.9, -4.5, -25], shinR: [84.1, 13.5, -13.5], footR: [17, 12.8, 0.8],
      },
    },
    B: {
      root: { p: [-0.154, 0.232, -0.03], r: [-90, 180, 0] },
      j: {
        hips: [10, 5.3, 6], spine: [4.2, -23.2, 6], chest: [16.3, -3.7, 12], neck: [-5, 58.7, 0.9], head: [4.2, 23.7, 10.2],
        clavL: [-17.8, -11.9, 29.1], armL: [-123.2, 28.5, -38.4], foreL: [-107, 14.4, 3.8],
        clavR: [-26.5, -12.5, 36.9], armR: [-88.4, -64.5, -10], foreR: [-87.6, 29.1, 0.4],
  ...
  KNEE_ON_BELLY: P('KNEE_ON_BELLY', {
    ...
    A: {
      ...
      j: {
        ...
        thighR: [-32.9, -14, -44.7], shinR: [14.2, 16, -21.5], footR: [-21.4, -5.7, 9.3],
      },
    },
    B: {
      root: { p: [-0.162, 0.231, 0.042], r: [-90, 180, 0] },
      j: {
        hips: [9.3, 64.5, -3.7], spine: [-8.6, -17.8, 14.3], chest: [7.4, 26.4, 34.6], neck: [-14.5, -0.7, -0.7], head: [12, -24.7, -0.7],
  ...
  BACK: P('BACK', {
    ...
    A: {
      ...
      j: {
        ...
        thighL: [-91.6, 23.3, 17.7], shinL: [83.6, 9.9, -9.6], footL: [-16.1, 0, 0.1],
        thighR: [-67.6, -19.4, -39], shinR: [70.2, -0.7, 1.5], footR: [-10.9, 4.6, -2.1],
      },
    },
    B: {
  ...
  RNC: P('RNC', {
    ...
    A: {
      ...
      j: {
        hips: [-11.2, -1.4, -17.9], spine: [32.3, -21.5, -2.9], chest: [-13.8, -8.9, 14.4], neck: [18, 0, 0], head: [-14.7, 10, 0],
        clavL: [11.4, -0.6, 28.3], armL: [-162, 39.1, -43.4], foreL: [-145, 2.3, 2.3],
        clavR: [5.4, -17.5, -32], armR: [-122.6, -27.2, 57.1], foreR: [-128.5, 2.3, -0.7],
        thighL: [-84.4, 14.5, 27.8], shinL: [60.2, -1.3, 5.5], footL: [-14.7, -3, 3],
        thighR: [-83.6, -20.7, -33.6], shinR: [75.2, 6.1, -3.6], footR: [-14, 4, -8.9],
      },
    },
    B: {
      root: { p: [-0.075, 0.277, -0.041], r: [-10, 4, 4] },
      j: {
        hips: [-32.9, 3.8, -49.4], spine: [13.3, -3.6, 18.8], chest: [4.6, 16.6, 5.4], neck: [-17.6, -15.6, -24.3], head: [-11.6, 26.7, 2.5],
        clavL: [-17.7, 25.7, 28.9], armL: [-148.3, 40.6, -42.4], foreL: [-118.7, -25.9, -0.7],
        clavR: [6.3, -8.7, 0.7], armR: [-129.5, -40.3, 40.5], foreR: [-117.2, -5.9, -1.5],
        thighL: [-49.6, 29.1, 10.3], shinL: [88.4, 19.6, -18], footL: [-12.2, 3.1, 33.1],
  ...
  ARMBAR: P('ARMBAR', {
    ...
    A: {
      root: { p: [-0.405, 0.229, 0.398], r: [-90, 90, 0] },
      j: {
        hips: [4.8, -1.5, -2.9], spine: [28.2, 2.7, 41.4], chest: [19.3, -1.4, 13.6], neck: [-3.9, 0.8, -0.7], head: [21.3, 0.8, 2.3],
        clavL: [-22.2, -12.4, 39.6], armL: [-118.3, 22.8, -36.9], foreL: [-70.2, -9.7, -2.9],
        clavR: [0.8, 18.8, -27.3], armR: [-113.8, -26.5, 33.3], foreR: [-110, -2.1, 3.2],
        thighL: [-54.5, 1.5, 52.9], shinL: [5.7, 13, -2.9], footL: [-14.2, 2.3, 1.5],
        thighR: [-32.1, -31.2, -23.9], shinR: [37, -28.3, -4.3], footR: [-5.9, -20, -45.5],
      },
    },
    B: {
      root: { p: [-0.011, 0.235, 0.012], r: [-90, 180, 0] },
      j: {
        hips: [6.9, 18.3, 0], spine: [14.6, 11.4, 0], chest: [6.1, 6.9, 13.6], neck: [-10.2, 3, 1.5], head: [13, 0, 3],
        ...
        clavL: [12.1, -1.3, 43.3], armL: [-96, 44.9, -14.9], foreL: [-34.8, 20.5, 4.7],
        clavR: [29.6, 24.2, -18.6], armR: [-50.3, -16.1, 25.7], foreR: [-61.3, 9.2, 8.4],
        thighL: [-24.1, 6.9, 8.5], shinL: [39.1, -5.2, -3], footL: [-11.2, -4.5, 0.1],
        thighR: [-13.8, -6, -5.7], shinR: [37.3, 2.3, 0], footR: [-12, 0.8, 0.8],
      },
    },
    hold: [
  ...
  KIMURA: P('KIMURA', {
    ...
    A: {
      ...
      j: {
        hips: [-47.5, -29, -22.4], spine: [45.4, -18.5, 4.5], chest: [39.8, -21.3, -4.5], neck: [34.6, -4.4, 5.3], head: [-21.2, -6, 0],
        clavL: [1.6, 3.2, -44.7], armL: [-67.1, 34.2, -46.8], foreL: [-111.4, 1, 0.8],
        clavR: [-35.5, -6.5, -15], armR: [-79.3, -52.2, 33.4], foreR: [-119.2, 0, 0],
        thighL: [-76.9, -1, 5], shinL: [101.3, -0.7, 0.8], footL: [8.9, -0.7, 4.7],
    ...
    B: {
      ...
      j: {
        ...
        clavL: [5.2, 18.1, 41.9], armL: [-158.7, 69.5, -56.1], foreL: [-93.8, -10.3, -3.7],
  ...
  GUILLOTINE: P('GUILLOTINE', {
    ...
    A: {
      ...
      j: {
        hips: [-7.1, -11.2, -6], spine: [26.6, 0, -6], chest: [1.4, -10.4, 3], neck: [-33.9, -14.1, -10.2], head: [-25.7, 4.1, -15.4],
    ...
    B: {
      ...
      j: {
        hips: [16.1, 28.6, 19.6], spine: [2.6, -22.3, -14.7], chest: [14.1, -13.5, -19.4], neck: [-15.1, -0.7, -0.7], head: [17.6, 0.8, 0.8],
        clavL: [18.4, 13.5, 24.1], armL: [-143.2, 61.2, -15.8], foreL: [-124.4, 15.2, 54.3],
        clavR: [-17.6, -4.3, -34.5], armR: [-143.1, 1.9, 51.9], foreR: [-77.8, -13.3, -17.1],
  ...
  ACROSS: P('ACROSS', {
    ...
    A: {
      ...
      j: {
        ...
        shinR: [88, 15.1, -5.8], footR: [-12.5, -18.5, 1.7],
      },
    },
    B: {
  ...
  BACK_WORK: P('BACK_WORK', {
    ...
    variantOf: 'BACK',
    A: {
      root: { p: [0.001, 0.291, -0.355], r: [-22, 8, 6] },
      j: {
    ...
    B: {
      ...
      j: {
        ...
        armR: [-89.5, -31.5, 31.4], foreR: [-82.4, 6.3, 12.2], thighL: [-72.4, -2.5, 11.8],
        shinL: [85.3, -7.5, 14.3], footL: [-9.2, 0.8, 3], thighR: [-70.9, -5.6, -2.6],
  ...
  RNC_WORK: P('RNC_WORK', {
    ...
    variantOf: 'RNC',
    A: {
      root: { p: [-0.017, 0.384, -0.421], r: [-26, 8, 8] },
      j: {
    ...
    B: {
      root: { p: [-0.026, 0.402, -0.061], r: [-10, 4, 4] },
      j: {
  ...
  HALF_GUARD_WORK: P('HALF_GUARD_WORK', {
    ...
    A: {
      root: { p: [0.176, 0.518, -0.115], r: [0, 24, 0] },
      j: {
    ...
    B: {
      root: { p: [-0.046, 0.296, 0.113], r: [-72, 156, -22] },
      j: {
  ...
  HALF_GUARD_WORK2: P('HALF_GUARD_WORK2', {
    ...
    B: {
      ...
      j: {
        ...
        armR: [-12.6, 45.5, 17.3], foreR: [-32.3, 32.5, 16.8], thighL: [-93.5, 8.1, 18.1],
        shinL: [95.1, 1.5, 0], footL: [-14, 0, 0], thighR: [-54.8, -36.3, -36.4],
