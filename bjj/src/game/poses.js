...
export const POSES = {
  ...
  CLINCH: P('CLINCH', {
    ...
    A: {
      ...
      j: {
        ...
        clavL: [29.6, -4.1, 27.7], armL: [-107.4, 52.1, 14.8], foreL: [-144.2, 15.5, 25.3],
        clavR: [5.5, 13.4, 14.3], armR: [-73.1, -23.7, 18.2], foreR: [-64, 0, -4.9],
        thighL: [-5.3, 13.6, 2.4], shinL: [25.2, 1.5, 0.8], footL: [-21.6, -7.2, 3],
        thighR: [6.5, -12.4, -8.9], shinR: [23.3, 0.1, -2.2], footR: [-46, 13.5, 0.1],
      },
    },
    B: {
      ...
      j: {
        ...
        clavL: [17.9, -13.3, 24.9], armL: [-104.1, 33.9, 9.3], foreL: [-121.5, -32, -42.8],
        clavR: [0.9, -7.8, 8.1], armR: [-76.7, -24.5, 19.6], foreR: [-61.6, -2.2, 0.4],
        thighL: [-11.6, 13.6, 6.1], shinL: [44.6, 1.5, -2.2], footL: [-14.1, -8, -0.6],
        thighR: [0.4, -6.2, -15.6], shinR: [25.7, -2.8, 6.1], footR: [3.7, 18.3, 18.9],
      },
    },
    grips: [
  ...
  CLOSED_GUARD: P('CLOSED_GUARD', {
    ...
    B: {
      ...
      j: {
        hips: [8.1, 22.6, 8.5], spine: [14.7, 23.4, 30.2], chest: [6.3, 9.9, -32.7], neck: [-20.1, 1.6, -0.7], head: [16, -2.2, -0.7],
  ...
  HALF_GUARD: P('HALF_GUARD', {
    ...
    points: 0, top: 'A', ground: true, guardOf: 'B',
    A: {
      root: { p: [0.199, 0.54, -0.105], r: [0, 24, 0] },
      j: {
        hips: [16.9, -17.2, 24.8], spine: [17.3, -14.9, 21.8], chest: [-7.7, -17.9, 26.4], neck: [11, 0, -0.7], head: [-7, 0, 0],
        clavL: [-18.5, 12.7, 26.7], armL: [-121.3, 80.8, 10.5], foreL: [-75, -5, -4.2],
        clavR: [36.2, -11.1, 0.3], armR: [-33.8, 1.3, -12.7], foreR: [-65.5, 40.7, 30.4],
    ...
    B: {
      ...
      j: {
        hips: [2.6, -15.6, -16.4], spine: [11.2, 21.9, 39.2], chest: [22.7, 2.4, -0.7], neck: [-14.7, 7.5, 0.8], head: [13.3, 0.8, 6.1],
  ...
  SIDE_CONTROL: P('SIDE_CONTROL', {
    ...
    A: {
      root: { p: [0.323, 0.345, 0.336], r: [8, 100, 0] },
      j: {
        hips: [-71.7, -30.5, -31.5], spine: [24.4, -12.5, 14.9], chest: [30.2, 4.5, 19.7], neck: [8.2, 23.6, 36.3], head: [6.1, 15.9, 6.9],
        clavL: [-11.6, -26.8, -29.3], armL: [-84.5, 41.5, -45.6], foreL: [-120.1, 31.8, 13],
        clavR: [34.1, -26.8, 7], armR: [-27.3, -8.9, 57.7], foreR: [-112.2, 9.2, -12.4],
        thighL: [-36.5, -9.1, -13.3], shinL: [112.2, -17.8, 25.7], footL: [8.5, -9.7, -3.7],
        thighR: [-26.5, -5.2, -24.2], shinR: [82.7, 15.1, -13.5], footR: [17, 12.8, 0.8],
      },
    },
    B: {
      root: { p: [-0.154, 0.232, -0.03], r: [-90, 180, 0] },
      j: {
        hips: [10, 5.3, 6], spine: [5.7, -14.9, 5.3], chest: [18.7, -3.7, 12], neck: [-6.4, 55.8, 0.9], head: [3.5, 22.2, 9.5],
        clavL: [-17.8, -17.9, 30.7], armL: [-124.6, 28.5, -38.4], foreL: [-108.5, 18.2, 3.8],
        clavR: [-19.6, -21.4, 37.7], armR: [-89.1, -64.5, -10], foreR: [-88.3, 31.4, 0.4],
        thighL: [-26.4, 8.4, 10.6], shinL: [40.8, -4.5, -1.5], footL: [-15.2, 0.1, 2.3],
        thighR: [-18.9, 2.4, -9.1], shinR: [35.6, 10.6, 0.9], footR: [-9.8, 4.7, 3.3],
      },
    },
    hold: [
      { of: 'A.chest', above: 'B.chest', by: 0.16 },
  ...
  KNEE_ON_BELLY: P('KNEE_ON_BELLY', {
    ...
    A: {
      root: { p: [0.075, 0.61, 0.105], r: [-6, 100, 0] },
      j: {
        hips: [-44.4, -35.2, 10.5], spine: [4.3, -9.6, 28.6], chest: [-26.6, -29.9, 36.8], neck: [3.8, -24.7, 6.1], head: [-17.5, -8.2, 0],
        clavL: [-4.8, 24.1, 29.9], armL: [-51, 19.4, -28.4], foreL: [-68.9, 0.8, -2.1],
        clavR: [1.9, -11.9, 15.4], armR: [-32.2, 12.4, 38.6], foreR: [-32.3, 39.4, 30.4],
        thighL: [-134.4, -14, -24.4], shinL: [59.6, 0, 0], footL: [8, -0.7, 0],
        thighR: [-32.9, -25.2, -43.9], shinR: [14.2, 20.5, -23], footR: [-25.1, -6.3, 7.9],
      },
    },
    B: {
      root: { p: [-0.162, 0.25, 0.005], r: [-90, 180, 0] },
      j: {
        hips: [9.3, 72.8, -3.7], spine: [-7.8, -23, 14.3], chest: [11.3, 17.4, 30.1], neck: [-14.5, -0.7, -0.7], head: [12, -24.7, -0.7],
        clavL: [-4, 23.5, 36.8], armL: [-116.8, 46.2, -29.5], foreL: [-81.5, -5.2, -2.2],
        clavR: [-20.5, -6.4, -32.6], armR: [-70.2, -31.2, 26.3], foreR: [-74.8, 0.8, 0],
  ...
  MOUNT: P('MOUNT', {
    ...
    A: {
      ...
      j: {
        hips: [48.3, 32.4, -4.5], spine: [-2.2, 22.1, -36.5], chest: [42.3, -29.7, -11.5], neck: [22.6, 2.3, 0.1], head: [-10.6, 5.4, 1.6],
        clavL: [15.4, -10.8, -27.3], armL: [-95.2, 14.7, -24.4], foreL: [-76.5, 2, -1.3],
    ...
    B: {
      ...
      j: {
        ...
        clavL: [1.5, -38.1, 9.6], armL: [-151.8, 41.2, 12.4], foreL: [-118.8, 23.7, 13.9],
        clavR: [0.3, 10.2, -17.3], armR: [-172.7, 20.2, 30.9], foreR: [-73, -12.5, -5.1],
  ...
  BACK: P('BACK', {
    ...
    points: 4, top: 'A', ground: true,
    A: {
      root: { p: [-0.011, 0.292, -0.477], r: [-22, 8, 6] },
      j: {
        hips: [-14.9, 9, -24.6], spine: [22, -13.4, -14.2], chest: [17.8, -6, 21.1], neck: [25.1, 0.8, 3.8], head: [-11.2, 8.8, 0.8],
        ...
        thighR: [-68.3, -17.1, -39], shinR: [70.2, -0.7, 1.5], footR: [-10.9, 4.6, -2.1],
      },
    },
    B: {
      root: { p: [0.038, 0.292, -0.09], r: [-16, 4, 4] },
      j: {
        hips: [-38, -29.8, 1.5], spine: [14.3, -11.8, -11.2], chest: [-12.4, 4.7, -46.4], neck: [5.4, -20.9, -8.8], head: [19.5, -8.2, 3.8],
  ...
  RNC: P('RNC', {
    ...
    A: {
      root: { p: [0.055, 0.302, -0.433], r: [-26, 8, 8] },
      j: {
        hips: [-11.2, -1.4, -17.9], spine: [32.3, -22.2, -2.9], chest: [-13.8, -9.6, 17.5], neck: [18, 0, 0], head: [-14.7, 10, 0],
        clavL: [12.2, -2.1, 31.4], armL: [-164.9, 39.1, -49.3], foreL: [-144.2, 2.3, 2.3],
    ...
    B: {
      root: { p: [-0.075, 0.277, -0.041], r: [-10, 4, 4] },
      j: {
        hips: [-32.9, 3.8, -49.4], spine: [13.3, -3.6, 18.8], chest: [4.6, 16.6, 5.4], neck: [-14.6, -11.1, -26.5], head: [-11.6, 26.7, 2.5],
        clavL: [-17.7, 25.7, 28.2], armL: [-148.3, 40.6, -42.4], foreL: [-118.7, -25.9, -0.7],
        clavR: [6.3, -8.7, 0.7], armR: [-129.5, -40.3, 40.5], foreR: [-117.2, -5.9, -1.5],
  ...
  ARMBAR: P('ARMBAR', {
    ...
    A: {
      ...
      j: {
        hips: [4.1, -1.5, -2.9], spine: [33.5, 8.7, 35.4], chest: [23.8, 0.1, 13.6], neck: [-3.9, 0.8, -0.7], head: [21.3, 0.8, 2.3],
  ...
  TRIANGLE: P('TRIANGLE', {
    ...
    A: {
      ...
      j: {
        ...
        thighR: [-16.7, 26, -0.9], shinR: [69.8, -2.9, -0.7], footR: [-0.7, -17.7, 0.8],
      },
    },
    B: {
  ...
  KIMURA: P('KIMURA', {
    ...
    A: {
      ...
      j: {
        hips: [-47.5, -29, -22.4], spine: [43.9, -18.5, 4.5], chest: [38.4, -21.3, -4.5], neck: [34.6, -4.4, 5.3], head: [-21.2, -6, 0],
        clavL: [0.9, 3.2, -44.7], armL: [-67.8, 33.5, -48.9], foreL: [-111.4, 1, 0.8],
        clavR: [-37.6, -4.9, -12.7], armR: [-77.7, -52.9, 33.4], foreR: [-117.6, -0.7, 0],
        thighL: [-76.9, -1, 5], shinL: [101.3, -0.7, 0.8], footL: [9.7, -0.7, 7.1],
    ...
    B: {
      ...
      j: {
        hips: [17.6, 9.1, 6], spine: [-11.7, -1.5, 12], chest: [5.4, 3.1, 4.7], neck: [-34.6, -0.7, 0.1], head: [1.5, -27.5, 5.3],
        clavL: [5.2, 18.1, 41.2], armL: [-160.8, 71.9, -55.3], foreL: [-93.8, -10.3, -5.2],
  ...
  GUILLOTINE: P('GUILLOTINE', {
    ...
    A: {
      ...
      j: {
        hips: [-7.1, -9.7, -6], spine: [26.6, 0, -6], chest: [0.6, -8.1, 3], neck: [-32.3, -9.6, -10.2], head: [-25.7, 4.1, -15.4],
        clavL: [-31.4, -14.7, -6.5], armL: [-120.5, 100.4, 43.9], foreL: [-69.6, 24.4, 49.6],
        clavR: [36.3, 18.2, 0.3], armR: [-43.5, -59.8, -26], foreR: [-25.4, 1.9, -22.9],
        thighL: [22.4, 17.2, 22.7], shinL: [98.1, 0, 0], footL: [19.3, 0.8, 0],
        thighR: [12, -9.5, -13.5], shinR: [102.6, 0, -0.7], footR: [19.3, 0, -2.9],
      },
    },
    B: {
      root: { p: [0, 0.303, 0.201], r: [-56, 180, 0] },
      j: {
        hips: [16.9, 28.6, 20.4], spine: [5.6, -25.2, -13.9], chest: [16.4, -14.2, -17.9], neck: [-15.1, -0.7, -0.7], head: [17.6, 0.8, 0.8],
        clavL: [20, 12.8, 29.4], armL: [-143.9, 62.7, -15.8], foreL: [-122.9, 13.7, 55.1],
        clavR: [-17.5, -0.5, -35.2], armR: [-144.6, 7.2, 54.2], foreR: [-77, -14, -17.8],
  ...
  ACROSS: P('ACROSS', {
    ...
    A: {
      root: { p: [0.213, 0.497, 0.162], r: [16, 62, 0] },
      j: {
        hips: [-29.2, 7.6, 17.1], spine: [42.9, -9, -2.8], chest: [21.7, -27.5, 8.9],
        neck: [23.5, 6, -6], head: [-24, 0, -0.7], clavL: [-19.1, -29.4, -20.6],
        armL: [-81.6, 45.3, -44.5], foreL: [-98.7, 8, 6], clavR: [19.7, -30.7, -18.6],
        armR: [-48.2, -22.6, 28.3], foreR: [-117.9, 1.7, -2.5], thighL: [-63.9, 13.3, 17.3],
        shinL: [96.8, -4.4, 5.3], footL: [11.1, 0.8, -0.7], thighR: [11.2, -49.8, 17.2],
    ...
    B: {
      ...
      j: {
        hips: [16, -2, 15.8], spine: [4, -10.4, 9], chest: [10.4, -15.1, 24.8],
        neck: [16.4, 59.5, 16.1], head: [31.7, 21.2, -1.5], clavL: [-15.1, 8.4, 14.8],
  ...
  MOUNT_ENTRY: P('MOUNT_ENTRY', {
    ...
    A: {
      ...
      j: {
        hips: [17.6, 17, 3], spine: [39.8, -17.7, -8], chest: [40.8, -16.2, -3.9],
  ...
  SIDE_ENTRY: P('SIDE_ENTRY', {
    ...
    A: {
      ...
      j: {
        hips: [-50.2, -60.4, 6], spine: [46.9, -18.2, -8.4], chest: [44.2, -16.3, 4.5],
        neck: [26, 4.3, -2.2], head: [-19.2, -0.7, 2.3], clavL: [-15.4, -33.7, -20.6],
  ...
  GUARD_ENTRY: P('GUARD_ENTRY', {
    ...
    B: {
      ...
      j: {
        ...
        thighL: [-13.6, 6.3, -0.5], shinL: [82.7, 0.8, -5.2], footL: [14.2, 1.9, -1.7],
  ...
  BACK_WORK: P('BACK_WORK', {
    ...
    A: {
      ...
      j: {
        hips: [-11.2, -6.7, -24.6], spine: [27, -17.2, -6.7], chest: [22, -5, 3],
        neck: [25.3, 1.5, 3.8], head: [-11.2, 11.8, -6], clavL: [-2.2, -3.6, 21.7],
        armL: [-128.4, 32.3, -50], foreL: [-105.6, -2.8, -9.7], clavR: [24.9, 10.1, -19.8],
        armR: [-87.1, -17.7, 5.5], foreR: [-116, -59.1, -55.2], thighL: [-94.2, 21.2, 21.4],
        shinL: [40.7, -11.1, 0.9], footL: [-18.4, -2.2, 3.1], thighR: [-91.1, -21, -27.2],
        shinR: [79.5, 1.5, -2.2], footR: [-13.2, 0, 0],
      },
    },
    B: {
      root: { p: [-0.011, 0.295, 0.01], r: [-16, 4, 4] },
      j: {
        hips: [-32, -35.9, -11.2], spine: [14.9, -6.7, -13.5], chest: [6.3, -16.5, -47.2],
        neck: [14.7, -11.2, 0.8], head: [16, -2, 6], clavL: [-23.7, 1.1, 38.2],
        armL: [-149.9, 10.2, -37.9], foreL: [-59, 0.8, -13.3], clavR: [3.6, 16.7, -26.7],
        armR: [-89.5, -30, 32.9], foreR: [-82.4, 6.3, 12.2], thighL: [-73.1, -2.5, 11.8],
        shinL: [85.3, -7.5, 14.3], footL: [-9.2, 0.8, 3], thighR: [-70.9, -4.1, -2.6],
        shinR: [70.4, -5.2, 4.6], footR: [-6.2, 8.4, -5.8],
      },
    },
  }),
  ...
  RNC_WORK: P('RNC_WORK', {
    ...
    B: {
      ...
      j: {
        ...
        neck: [-25.1, -21.7, -29], head: [-13, 29.6, 1.6], clavL: [-17, 25.8, 21.4],
  ...
  HALF_GUARD_WORK: P('HALF_GUARD_WORK', {
    ...
    A: {
      root: { p: [0.172, 0.505, -0.107], r: [0, 24, 0] },
      j: {
        hips: [8.7, 11.4, 18], spine: [18.8, -19.3, 22.7], chest: [-2.5, -21.4, 0.9],
        neck: [12.5, 0, 2.3], head: [-10, 0, 0], clavL: [-16.6, -6.4, 40.7],
        armL: [-122.6, 57.4, 2.9], foreL: [-89.1, 1.7, -5.7], clavR: [32.4, -22, -21.8],
        armR: [-37.4, -3.1, 3.8], foreR: [-64.8, 42.7, 24.8], thighL: [-11.1, 4.8, 31.4],
        shinL: [107, 0, 0], footL: [10, 0, 0.8], thighR: [-19.9, 79.1, -33.2],
        shinR: [112.7, 18.3, -17.9], footR: [-1.2, -26, 1],
      },
    },
    B: {
      root: { p: [-0.046, 0.287, 0.106], r: [-72, 156, -22] },
      j: {
        hips: [10.8, 6.9, 7.6], spine: [-4.7, 1.8, 36.3], chest: [25.7, -0.9, -0.7],
        neck: [-24.5, 0, 0.8], head: [14, 3, 6.8], clavL: [10.3, 25.9, -31.4],
        armL: [-85.6, 48.2, -16.7], foreL: [-103.9, 9.8, 10.1], clavR: [3, 9.5, -40.7],
        armR: [-24.1, 28.1, -5.1], foreR: [-29.2, 43, 20.6], thighL: [-81.2, 9.6, 18],
        shinL: [88, 0, 0], footL: [-14, 0, 0], thighR: [-75.4, -47.8, -30.7],
  ...
  MOUNT_WORK: P('MOUNT_WORK', {
    ...
    B: {
      ...
      j: {
        ...
        neck: [1.1, 0, 6.5], head: [24.8, -1.5, 8], clavL: [-3.3, -38.2, 16.8],
        armL: [-155.7, 66.7, 1.1], foreL: [-113.1, 9.2, 6.1], clavR: [10, 12.9, -26.4],
        armR: [-212.8, 13.3, 20.1], foreR: [-83, 19.6, 5.3], thighL: [-32.6, -12.4, -16.9],
        shinL: [32.6, 0.1, 2.5], footL: [-5.6, 6.2, -8.8], thighR: [-28.7, -8.2, -2.3],
        shinR: [31.1, -0.7, -6], footR: [-14, -6, -1.5],
      },
    },
  }),
  ...
  SIDE_CONTROL_WORK: P('SIDE_CONTROL_WORK', {
    ...
    A: {
      root: { p: [0.309, 0.303, 0.277], r: [8, 100, 0] },
      j: {
        hips: [-54, -31.3, -21.6], spine: [27.6, -3.1, 17.5], chest: [30.6, -19.7, 15.5],
        neck: [20.8, 19, 35.6], head: [-37.5, -1.5, -6.7], clavL: [-22.2, -24.5, -24],
        armL: [-98, 49.5, -48], foreL: [-122.6, 13.6, 13.6], clavR: [38.4, -25.4, -8.9],
    ...
    B: {
      ...
      j: {
        ...
        neck: [18.1, 70.9, 3], head: [21.4, 24.5, 5.4], clavL: [-8.6, -8.9, -10],
        armL: [-116.2, 22.5, -38.4], foreL: [-120.5, 6.2, 5.4], clavR: [14.6, -32.8, 5.3],
        armR: [-69.2, -43.7, 2.6], foreR: [-63.6, 3.3, -4.2], thighL: [-40.7, 6.8, 12.8],
        shinL: [52, -1.5, 0], footL: [-16, 0, 0], thighR: [-14.4, -0.7, -14.5],
        shinR: [32.7, 0.8, -6.7], footR: [-9.9, 0.8, 0],
      },
    },
  }),
  ...
  CLOSED_GUARD_WORK: P('CLOSED_GUARD_WORK', {
    ...
    B: {
      ...
      j: {
        hips: [6.3, 19.6, -1.4], spine: [13.2, 28.2, 20.6], chest: [8, 15.1, -18.3],
  ...
  OPEN_GUARD_WORK: P('OPEN_GUARD_WORK', {
    ...
    A: {
      ...
      j: {
        hips: [3.6, 6.1, -20.2], spine: [29.6, -8.2, -0.7], chest: [22, 1.5, 3.8],
        neck: [19.3, 0, 1.5], clavL: [0.8, -4.5, 18.4], armL: [-96.3, 35.9, -20.9],
        foreL: [-27.2, -7.4, 7.7], clavR: [-12.7, 35.3, -20.5], armR: [-87.3, -21.4, 25.6],
        foreR: [-40, -8.2, -3.6], thighL: [-27.3, 26.3, 7.2], shinL: [95.9, 20.4, -14.9],
        footL: [21.6, -9.6, 1.7], thighR: [-8.7, -21.4, -17], shinR: [77.8, 1.5, -4.5],
        footR: [-20, 0, 0],
      },
    },
    B: {
  ...
  KNEE_ON_BELLY_WORK: P('KNEE_ON_BELLY_WORK', {
    ...
    A: {
      root: { p: [0.062, 0.588, 0.031], r: [-6, 100, 0] },
      j: {
        hips: [-48.5, -32.2, 18.3], spine: [6.4, -22.8, 26.3], chest: [-17.2, -15.7, 37],
        neck: [-1.1, -14.2, 3.1], head: [-22, -6, 0], clavL: [8.7, 7.8, 29.3],
        armL: [-57.8, 19.7, -28.2], foreL: [-59.5, 8.9, -2.7], clavR: [5.3, -5.7, 30.5],
        armR: [-25.6, -11.9, 26.7], foreR: [-68.9, 7.9, 25], thighL: [-128.9, -31.2, -1.2],
        shinL: [45.8, 0, 0.8], footL: [8, 0, 0], thighR: [-40.8, -19.9, -48.1],
        shinR: [24.2, 18.3, -15.5], footR: [-18.6, 1.6, 6.2],
      },
    },
    B: {
      root: { p: [-0.187, 0.236, 0.05], r: [-90, 180, 0] },
      j: {
        hips: [1.6, 55.7, 0.8], spine: [-13.9, -18.3, 21], chest: [12.8, 32.2, 36.9],
        neck: [-19.7, -0.7, 0.8], head: [19.3, -23.2, -0.7], clavL: [3.9, 12.2, 20.8],
        armL: [-100, 45.5, -25.2], foreL: [-94.1, -5.2, -5.1], clavR: [-23.7, -7.9, -26.5],
        armR: [-60.5, -25.9, 18.1], foreR: [-89.9, 0, -0.7], thighL: [-39.3, 14.3, 17.3],
  ...
  TURTLE_WORK: P('TURTLE_WORK', {
    ...
    variantOf: 'TURTLE',
    A: {
      root: { p: [0.088, 0.584, -0.534], r: [10, 26, 0] },
      j: {
        hips: [9.1, 39.5, 26.6], spine: [43.5, 8.8, 2.3], chest: [42.9, -18.6, 10.6],
        neck: [22.2, 0, -2.9], head: [-15.6, 0.1, 0.1], clavL: [30, -21, 21.3],
        armL: [-33.3, 28.7, -41.7], foreL: [-67, 42.2, 33.1], clavR: [-3.3, 30.2, -27],
        armR: [-114, -12.2, 78.3], foreR: [-40.3, -21.2, -17.7], thighL: [-23.6, 1.2, 18.6],
        shinL: [97.6, 4.6, 3.1], footL: [12.6, 0.1, 3.8], thighR: [-46.9, -21.9, -3.2],
        shinR: [93.8, -8.2, 2.3], footR: [-6.1, -17.8, -4.3],
      },
    },
    B: {
      root: { p: [0.017, 0.266, 0.123], r: [64, 176, 0] },
      j: {
        hips: [13.6, -12.6, 22.7], spine: [-16, 15.8, 26.6], chest: [-29.6, 36.1, -18.2],
        neck: [-25.7, -0.7, 1.6], head: [33.5, -0.7, 4.5], clavL: [-2.7, 41.6, 15.7],
        armL: [-103.7, 34.4, -6.7], foreL: [-125.2, -0.7, 4.6], clavR: [35.3, -25, 7.4],
        armR: [-18.3, -2.3, 27.4], foreR: [-110.9, 5.4, 6.9], thighL: [64.2, 55, 38.5],
        shinL: [155.6, 0.3, 11.6], footL: [33.2, 0.1, 0.1], thighR: [32.5, 2.7, -70.1],
  ...
  ARMBAR_WORK: P('ARMBAR_WORK', {
    ...
    variantOf: 'ARMBAR',
    A: {
      root: { p: [-0.415, 0.223, 0.379], r: [-90, 90, 0] },
      j: {
        hips: [3.8, -6, 7.6], spine: [15.3, 21.4, 34.2], chest: [23, -5.6, 24.5],
        neck: [-3.9, 0.8, -0.7], head: [23.5, -1.5, 0.1], clavL: [-14.9, -17.8, 34.4],
        armL: [-116.2, 15.3, -38.4], foreL: [-86.9, -6, -0.7], clavR: [-2.4, 3.3, -25.8],
        armR: [-110.2, -15.9, 38.6], foreR: [-115.1, -4.2, 5.6], thighL: [-43.1, 2.3, 52],
        shinL: [0.4, -1.3, 0.1], footL: [-12.7, 0.1, -1.5], thighR: [-13.1, 8.5, -24.4],
        shinR: [35, 3.2, -2.9], footR: [-4.1, 3.9, -2.9],
      },
    },
    B: {
      root: { p: [-0.025, 0.293, -0.059], r: [-90, 180, 0] },
      j: {
        hips: [0.8, 10.1, 3.9], spine: [25.3, 24.9, 2.4], chest: [6, 12.1, 8.4],
        neck: [-5.5, 4.6, -2.1], head: [4.1, 0.8, -2.2], clavL: [11.2, 9.2, 43.7],
        armL: [-83.5, 49.1, -10.4], foreL: [-51, -19.2, 10.4], clavR: [23.6, 19.7, -23.1],
        armR: [-61.8, -19.9, 26.6], foreR: [-74, 8.5, 4.7], thighL: [-13.9, 34.9, 0.6],
        shinL: [60.7, 12.8, -8.9], footL: [-11.2, 0.8, 0.8], thighR: [-5.4, -4.3, -5.6],
        shinR: [36.6, 0, -2.9], footR: [-16.3, -0.7, 0.8],
      },
    },
  }),
  ...
  TRIANGLE_WORK: P('TRIANGLE_WORK', {
    ...
    variantOf: 'TRIANGLE',
    A: {
      root: { p: [-0.033, 0.412, -0.304], r: [30, 0, 0] },
      j: {
        hips: [2, 18, -21.7], spine: [-6.2, 11.3, 24.8], chest: [0, 19.6, 19.6],
    ...
    B: {
      ...
      j: {
        hips: [22.8, 16, -19], spine: [-2.4, -40.3, -27.4], chest: [-2.5, 13.6, 2.4],
  ...
  GUILLOTINE_WORK: P('GUILLOTINE_WORK', {
    ...
    A: {
      ...
      j: {
        hips: [14.6, -0.7, -6], spine: [10.9, -8.1, -6], chest: [-8.4, -5, -3],
        neck: [-47.2, -28.9, -22.2], head: [-26, 1.1, -12.7], clavL: [-30.2, -25.1, -2.9],
        armL: [-123.3, 90.6, 47.1], foreL: [-83.3, 20.7, 48.2], clavR: [34.2, 19.5, 29.2],
    ...
    B: {
      ...
      j: {
        hips: [12.6, 20.3, 23.3], spine: [6.5, -26.9, -11.1], chest: [-6.1, -11.2, -22.3],
        neck: [-28.6, 0.8, 0.8], head: [27.3, 1.5, -0.7], clavL: [24.2, -5.1, 16.6],
        armL: [-136.6, 84.6, -8.3], foreL: [-122.9, 13.1, 57], clavR: [-7.3, -22.1, -33.6],
        armR: [-154.7, -12.4, 37.9], foreR: [-85.1, -6.6, -5.9], thighL: [-142.2, -27.4, -2.5],
  ...
  RNC_WORK2: P('RNC_WORK2', {
    ...
    variantOf: 'RNC',
    A: {
      root: { p: [-0.093, 0.385, -0.35], r: [-26, 8, 8] },
      j: {
        hips: [-10.4, 5.3, 0], spine: [43.7, -20.9, -14.2], chest: [14.4, -10.5, 7],
        neck: [36.8, 3, -0.7], head: [-17.3, 10, -0.7], clavL: [1.4, 1.6, 24.6],
        armL: [-157.7, 48.6, -21.7], foreL: [-120.1, 5.3, 6], clavR: [0.3, -22.9, -25.1],
        armR: [-134.8, -28.6, 57], foreR: [-122.9, 0.8, 1.6], thighL: [-69.4, 26.5, 28.8],
        shinL: [63.2, 1.6, -10.4], footL: [-13.8, -4.3, 3.3], thighR: [-72.6, -19.3, -35.2],
        shinR: [67.9, -4.3, 15.1], footR: [-8.6, 12.2, -23.8],
      },
    },
    B: {
      root: { p: [-0.007, 0.293, -0.042], r: [-10, 4, 4] },
      j: {
        hips: [-22, -18.9, -21.6], spine: [27.3, 6.3, 12.9], chest: [6.8, 36.1, -3.5],
        neck: [-15.8, -15.9, -27.2], head: [-8.9, 33.3, 7.9], clavL: [-14.7, 29.5, 27.4],
        armL: [-136.1, 39.1, -42.2], foreL: [-101.9, -18.5, -1.4], clavR: [8.7, -5.6, 4],
        armR: [-118.7, -37.2, 38.5], foreR: [-105.9, -6.6, -0.7], thighL: [-85.2, 2.8, 6.6],
        shinL: [77.8, 6, -9], footL: [-10, -4.4, 3.8], thighR: [-78.4, 8.7, -8.6],
        shinR: [79.3, 9, -11.9], footR: [-10, 0, 0],
      },
    },
  }),
  ...
  HALF_GUARD_WORK2: P('HALF_GUARD_WORK2', {
    ...
    variantOf: 'HALF_GUARD',
    A: {
      root: { p: [0.143, 0.547, -0.114], r: [0, 24, 0] },
      j: {
        hips: [7.5, -24, -6], spine: [16.6, -17.9, 19.8], chest: [-7.8, -14.8, 29.9],
    ...
    B: {
      root: { p: [-0.104, 0.376, 0.105], r: [-72, 156, -22] },
      j: {
        hips: [21.6, 24.5, 8.1], spine: [25.3, 20.5, 43], chest: [7, -11.9, -38.5],
        neck: [-7.1, 0, -0.7], head: [8, 0, 5.3], clavL: [7.8, 16.8, -27.8],
        armL: [-99, 57.5, -14.5], foreL: [-101.8, -4.8, -4.3], clavR: [5.1, 7.8, -24.3],
        armR: [-12.6, 45.5, 17.3], foreR: [-32.3, 32.5, 16.8], thighL: [-97.2, 9.7, 20.4],
  ...
  SIDE_CONTROL_WORK2: P('SIDE_CONTROL_WORK2', {
    ...
    variantOf: 'SIDE_CONTROL',
    A: {
      root: { p: [0.333, 0.36, 0.253], r: [10, 128, 0] },
      j: {
        hips: [-52.2, -49, -43.5], spine: [22.7, -11.4, 26.1], chest: [49.6, 4.5, 8.6],
        neck: [19.7, -13.2, 0.5], head: [-25.5, 0, 6], clavL: [-2, -38.8, -22.4],
        armL: [-80.2, 43.5, -47.9], foreL: [-129.3, 3.3, 1], clavR: [27.9, -36.5, -5.6],
        armR: [-11.3, -44, 26.1], foreR: [-104, 5.6, -6.3], thighL: [-57.8, -18.7, -8.1],
        shinL: [118.8, -16.3, 12.8], footL: [22.8, 4.5, 3.8], thighR: [-31.1, -16.6, -18],
        shinR: [109.2, 9.8, 0.8], footR: [19.4, -0.7, 3.8],
      },
    },
    B: {
      root: { p: [-0.105, 0.245, -0.038], r: [-90, 180, 0] },
      j: {
        hips: [20, -15, 12], spine: [0, -13.2, 4.5], chest: [14.5, 2.6, 12.8],
        neck: [22.6, 60.6, -5.6], head: [-6.1, 39.6, -4.9], clavL: [-2.8, -11.9, 31.6],
        armL: [-111.7, 30, -27.6], foreL: [-66.3, 34, 24.2], clavR: [8, -32.2, 28.6],
        armR: [-63, -28.7, 20.6], foreR: [-70.4, 12.5, -40.5], thighL: [-41.2, 6.8, 6.8],
