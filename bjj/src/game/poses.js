...
export const POSES = {
  ...
  TURTLE_WORK: P('TURTLE_WORK', {
    ...
    A: {
      ...
      j: {
        ...
        neck: [29.8, 1.5, -9.6], head: [-10.3, -1.4, -2.1], clavL: [30, -21, 21.3],
    ...
    B: {
      ...
      j: {
        ...
        armR: [-18.3, -2.3, 27.4], foreR: [-110.9, 5.4, 6.9], thighL: [76.2, 55.8, 43],
        shinL: [155.6, 1.1, 10.9], footL: [33.2, 0.1, 0.1], thighR: [38.6, 2.7, -76.1],
  ...
  ARMBAR_WORK: P('ARMBAR_WORK', {
    ...
    variantOf: 'ARMBAR',
    A: {
      root: { p: [-0.415, 0.212, 0.379], r: [-90, 90, 0] },
      j: {
        hips: [-3.6, -6, 9.2], spine: [18.3, 30.5, 24.5], chest: [29.1, 3.4, 17.8],
        neck: [-3.9, 0.8, -0.7], head: [23.5, -1.5, 0.1], clavL: [-14.9, -17.8, 34.4],
        armL: [-116.2, 15.3, -38.4], foreL: [-86.9, -6, -0.7], clavR: [3.7, 6.4, -26.5],
        armR: [-106.4, -15.1, 39.4], foreR: [-115.1, -4.2, 5.6], thighL: [-37, 1.5, 51.3],
    ...
    B: {
      ...
      j: {
        ...
        shinR: [35.9, -1.4, -2.9], footR: [-17, -0.7, 0.8],
      },
    },
  }),
